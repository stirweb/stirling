!function(){function o(){const t=new IntersectionObserver(function(e,t){e.forEach(e=>{var t,r,a,i;e.isIntersecting?(t=Number(e.target.dataset.value),r=e.target.dataset.unit,a=Number(e.target.dataset.max),i=e.target.dataset.colour||"energy-turq",a=t/a*100,i=stir.createDOMFragment(`<div class="barchart-value u-bg-${i} u-absolute" style="right:${100-a}%"></div>
          ...
          `},g=({moduleTitle:e,moduleCode:t,moduleLevel:r,moduleCredits:a})=>`<div class="grid-container">
            ...
            </div>`,h=({moduleCredits:e,ectsModuleCredits:t,colourPack:r},a)=>`<div class="cell u-mt-2">
        ...
        </div>`},b=()=>'<div class="grid-container"><div class="grid-x grid-padding-x">',f=()=>"</div></div>",$=()=>b()+'<div class="cell u-padding-y"><h1>Page not found</h1></div>'+f(),x=stir.curry((e,t)=>(stir.setHTML(e,t),!0)),w=e=>e&&e.toLowerCase().includes("p")?"pg":"ug",y=(t,e)=>(e.filter(e=>e.level===t).length?e.filter(e=>e.level===t):e)[0];const d=e=>{return{sum:e.tabAssessments.map(e=>Number(e.percent)).reduce((e,t)=>e+t,0),assessment:e}},k=(e,t)=>{e=e.map(d);const r=a(t,e.length);return e.map(e=>100!==e.sum?"":r(e.assessment))};var e=stir.moduleTexts||{},t=new URLSearchParams(document.location.search);!async function(e,t,r){var a,i,s,d,l,n,e=await fetch(e);try{var u=await e.json();a=u,i=t,s=r,(n=stir.node("#content")).classList.add("u-padding-bottom"),a.error?x(n,$()):(l=w(a.moduleLevelDescription),i=y(l,i),d={...a,colourPack:i,boilerplates:s},a=k(a.assessments,i),l=g(d)+b()+c(l,s)+p(d)+v("",a,i,s)+h(d,s)+m(d,s)+f(),x(n,l)),o()}catch(e){x(stir.node("#content"),$()),console.log(e.message)}}("https://www.stir.ac.uk/data/courses/akari/module/index.php?module="+[t.get("code"),t.get("session"),t.get("semester")].join("/"),[{level:"ug",first:"heritage-green",second:"energy-turq",third:"energy-purple"},{level:"pg",first:"heritage-purple",second:"heritage-purple",third:"heritage-green"}],e)}();