!function(){function o(){const t=new IntersectionObserver(function(e,t){e.forEach(e=>{var t,r,a,s;e.isIntersecting?(t=Number(e.target.dataset.value),r=e.target.dataset.unit,a=Number(e.target.dataset.max),s=e.target.dataset.colour||"energy-turq",a=t/a*100,s=stir.createDOMFragment(`<div class="barchart-value u-bg-${s} u-absolute" style="right:${100-a}%"></div>
      ...
      <p>${e}</p>`:""}
        ...
        </div>`});const s=stir.curry((e,{label:t,category:r,percent:a,mode:s})=>"Formative"===s?"":`
        <div>
        ...
        </div>`),a=stir.curry((e,t,{tab:r,tabAssessments:a})=>{e=s(e);return(1<t?`<h4 class="u-mt-0">${r}</h4>`:"")+`<p>${a.map(e).join("")}</p>`}),i=stir.curry((e,t)=>t?`<div class="cell large-${e} u-mb-1">${t}</div>`:""),v=(e,t,r,a)=>{var s=e.length?(s="12",(e=e)?`<div class="cell large-${s} u-mb-1">${e}</div>`:""):a.deliveriesFallback,e=t.length<2?"12":"6",e=i(e),e=t.length?t.map(e).join(""):`<div class="cell">${a.assessmentFallback}</div>`;return`<div class="cell">
        ...
        </div>`},b=()=>'<div class="grid-container"><div class="grid-x grid-padding-x">',$=()=>"</div></div>",f=()=>b()+'<div class="cell u-padding-y"><h1>Page not found</h1></div>'+$(),w=stir.curry((e,t)=>(stir.setHTML(e,t),!0)),x=e=>e&&e.toLowerCase().includes("p")?"pg":"ug",y=(t,e)=>(e.filter(e=>e.level===t).length?e.filter(e=>e.level===t):e)[0],d=e=>{return{sum:e.tabAssessments.map(e=>Number(e.percent)).reduce((e,t)=>e+t,0),assessment:e}},k=(e,t)=>{e=e.map(d);const r=a(t,e.length);return e.map(e=>100!==e.sum?"":r(e.assessment))};var e=stir.moduleTexts||{},t=new URLSearchParams(document.location.search);!async function(e,t,r){var a,s,i,d,l,n,e=await fetch(e);try{var u=await e.json();a=u,s=t,i=r,(n=stir.node("#content")).classList.add("u-padding-bottom"),a.error?w(n,f()):(d=x(a.moduleLevelDescription),s=y(d,s),l={...a,colourPack:s,boilerplates:i},a=a.assessments||[],a=k(a,s),a=g(l)+b()+c(d,i)+p(l)+v("",a,s,i)+h(l,i,d)+m(l,i)+$(),w(n,a)),o()}catch(e){w(stir.node("#content"),f()),console.log(e.message)}}("https://www.stir.ac.uk/data/courses/akari/module/index.php?module="+[t.get("code"),t.get("session"),t.get("semester")].join("/"),[{level:"ug",first:"heritage-green",second:"energy-turq",third:"energy-purple"},{level:"pg",first:"heritage-purple",second:"heritage-purple",third:"heritage-green"}],e)}();