const getObject=(e,t,n)=>{return{and:[{"custom_fields.tag":n},{range:{"custom_fields.e":{gt:e,lt:t}}}]}},getNow=()=>(new Date).toISOString(),getFilterString=(e,t)=>"upcoming"===t?`&limit=190&order=asc&filter=${encodeURIComponent(JSON.stringify(getObject(getNow(),"2099-12-31",e)))}&sort=custom_fields.sort&`:`&limit=190&order=asc&filter=${encodeURIComponent(JSON.stringify(getObject("2015-01-01",getNow(),e)))}&sort=custom_fields.sort&`;function getEvery7Days(e,t){for(var n=[],r=new Date(e),s=new Date;r<=new Date(t);)s<r&&n.push(new Date(r)),r.setDate(r.getDate()+7);return n}function combineDateAndTime(e,t){e=new Date(e);return e.setFullYear(t.getFullYear()),e.setMonth(t.getMonth()),e.setDate(t.getDate()),e}const getEventDateTimes=(e,t)=>{var n={day:"numeric",month:"long",year:"numeric"},e=new Date(e),t=new Date(t);return{start:e.toLocaleDateString("en-GB",n),end:t.toLocaleDateString("en-GB",n)}},renderAudience=e=>{e=e.filter(e=>"Public"===e||"StaffStudent"===e).map(e=>"StaffStudent"===e?"Staff, Students":e).join(",");return e.trim?"<strong>Audience</strong><br />"+e.replaceAll(",","<br/>"):""},renderEndDate=e=>e.start===e.end?"":"- "+e.end,renderMoreEvent=e=>{var t=e.custom_fields,t=getEventDateTimes(t.d,t.e);return`<a href="${e.url}" class="u-border u-p-1 u-mb-1 flex-container flex-dir-column large-flex-dir-row   u-gap">
            ...
            </div>`};async function doPast(e,t,n){n=getFilterString(n,"past");fetch(e+n+"page=1").then(e=>e.json()).then(e=>{e=e.hits.map(e=>{var t=e.custom_fields,n=t.d.split("T")[1].split(":")[0]+":"+t.d.split("T")[1].split(":")[1],r=t.e.split("T")[1].split(":")[0]+":"+t.e.split("T")[1].split(":")[1],n={start:t.d,end:t.e,startTime:n,endTime:r,sort:t.sort,repeater:null};return{...e,...n}}).map(renderEvent).join("");t.innerHTML=e})}async function doUpcoming(e,n,t,r){t=getFilterString(t,"upcoming");fetch(e+t+"page=1").then(e=>e.json()).then(e=>{const o=[];var e=e.hits.map(s=>{const r=s.custom_fields,i=r.d.split("T")[1].split(":")[0]+":"+r.d.split("T")[1].split(":")[1],a=r.e.split("T")[1].split(":")[0]+":"+r.e.split("T")[1].split(":")[1];let e=!1;r.data&&Array.isArray(r.data)&&(r.data.filter(e=>{e=JSON.parse(decodeURIComponent(e));if(e.type&&"perf"===e.type)return e}).map(e=>JSON.parse(decodeURIComponent(e))).forEach(e=>{var t=e.start.split("T")[1].split(":")[0]+":"+e.start.split("T")[1].split(":")[1],n=e.end.split("T")[1].split(":")[0]+":"+e.end.split("T")[1].split(":")[1],r=Number(String(e.pin).substring(0,10)),e={...s,...e,startTime:t,endTime:n,sort:r,repeater:!0};o.push(e)}),0<r.data.filter(e=>{e=JSON.parse(decodeURIComponent(e));if(e.repeat)return e}).map(e=>JSON.parse(decodeURIComponent(e))).length)&&(e=!0,getEvery7Days(r.d,r.e).slice(0,5).forEach(e=>{var t=combineDateAndTime(r.d,e),e=combineDateAndTime(r.e,e),n=Number(t.toISOString().replace(/\D/g,"").slice(0,10)),t={...s,start:t.toISOString(),startTime:i,end:e.toISOString(),endTime:a,sort:n,repeater:!1};o.push(t)}),s.hide=!0);var t={start:r.d,end:r.e,startTime:i,endTime:a,sort:r.sort,repeater:e};return{...s,...t}}).concat(o).sort((e,t)=>e.sort-t.sort).filter(e=>!e.hide),t=r.map(e=>{var t={sort:Number(String(e.pin).slice(0,10))};return{...e,...t}}),e=e.concat(t).sort((e,t)=>e.sort-t.sort).map(renderEvent).join("");n.innerHTML=e})}async function doMoreEvents(e,t,n){n={and:[{not:{"custom_fields.sid":n}},{range:{"custom_fields.e":{gt:getNow(),lt:"2090-12-31"}}}]},n=`&limit=3&order=asc&filter=${encodeURIComponent(JSON.stringify(n))}&sort=custom_fields.sort&`;fetch(e+n).then(e=>e.json()).then(e=>{t.innerHTML=e.hits.map(renderMoreEvent).join("")})}(async()=>{var e=window.miniEvents&&window.miniEvents.length?window.miniEvents.map(e=>JSON.parse(e)):[],e=stir.flatten(e).filter(e=>e.id),t=document.getElementById("seriesevents"),n=document.getElementById("serieseventspast"),r=document.getElementById("moreevents"),s="SeriesChildof"+t.getAttribute("data-seriesid"),i="https://api.addsearch.com/v1/search/dbe6bc5995c4296d93d74b99ab0ad7de?term=*&customField=type%3Devent&customField=series%3D";t&&await doUpcoming(i,t,s,stir.flatten(e)),n&&await doPast(i,n,s),r&&await doMoreEvents(i,r,r.getAttribute("data-currentid"))})(),function(e){e&&gallery&&galleryId&&stir.curry((e,t)=>(stir.setHTML(e,t),!0))(e,gallery.map(e=>{return`<img alt="${e.title.length?e.title:"Flickr image "+e.id}" class="u-object-cover"  src="https://farm${e.farm}.staticflickr.com/${e.server}/${e.id}_${e.secret}_c.jpg" width="${e.o_width}" height="${e.o_height}"></img>`}).join("")+`<div>
