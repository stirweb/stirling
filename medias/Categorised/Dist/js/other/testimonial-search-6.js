!function(){const l=(e,t,r)=>{var a,s,i=e.custom_fields,n=i.image&&(n=i.image).length?Array.isArray(n)?1===n.length?n[0]:n[n.length-1]:n:"",l=i.data?JSON.parse(decodeURIComponent(i.data)):{};return`
