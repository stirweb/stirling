        ...
        ${s=e,i=e.title.split(" | ")[0].trim(),r.urlBase,e.clickTrackingUrl,t=s.custom_fields,`
          <!-- Start testimonial result -->
            <div class="u-mb-2 u-bg-grey ">
              ${o(i,t.profileMedia)?o(i,t.profileMedia):((e,t)=>{if(!e)return``;const r=`https://www.stir.ac.uk${e}`;return`<img src="${r}" alt="${t}" class="u-object-cover u-aspect-ratio-1-1" loading="lazy" width=500 height=500  />`})(t.profileImage,i)}
                <div class="u-p-2">
          ...
          <!-- End testimonial result -->`} `},o=(e,t)=>(console.log("media:",t),t&&t.includes("a_vid")?`
        <div class="u-bg-grey">
