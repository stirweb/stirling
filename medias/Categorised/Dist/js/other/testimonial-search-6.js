!function(){const l=(e,t,r,a)=>{l=a,s=r.mediaquery;var s,i,n,l=(i=t)/c(l,s)%1==0||0===i;return`
        ${l&&0!==t?"</div>":""}
        ${l||1===a?'<div class="cell small-12 medium-6 large-4 u-padding-bottom">':""}
        ${s=e,i=e.title.split(" | ")[0].trim(),r.urlBase,e.clickTrackingUrl,t=s.custom_fields,n=t.image&&(n=t.image).length?1===n.length?n[0]:n[n.length-1]:"",l=t.data?JSON.parse(decodeURIComponent(t.data)):{},`
          <!-- Start testimonial result -->
            <div class="u-mb-2 u-bg-grey ">
              ${u(i,n)?u(i,n):((e,t)=>{if(!e)return``;const r=`https://www.stir.ac.uk${e}`;return`<img src="${r}" alt="${t}" class="u-object-cover u-aspect-ratio-1-1" loading="lazy" width=500 height=500  />`})(n,i)}
                <div class="u-p-2">
                  <p class="u-font-bold ">${i}</p>
                  ${t.country||l.degree?"<cite>":""}
                  ${t.country?`<span class="info">${t.country} </span><br />`:""}
                  ${l.degree?`<span class="info">${l.degree}</span>`:""}
                  ${t.country||l.degree?"</cite>":""}
                  ${t.snippet?`<blockquote class="u-border-none u-my-2 u-black u-p-0 u-quote u-text-regular">${t.snippet}</blockquote>`:""}
                  <a href="${s.url}" class="c-link">View ${l=i.trim(),"s"===l.slice(-1)?l+"’":l+"’s"} story</a>
                </div> 
            </div> 
        ...
        <div class="u-bg-grey">
        ...
        </div>`:"",o=(t,e)=>e.map(e=>`customField=${t}%3D`+e).join("&"),c=(e,t)=>Math.round(e/(e=>{switch(e){case"medium":return 2;case"small":return 1;case"large":return 3;default:return 3}})(t)),t=(e,t)=>{var r;return e&&(e=e.replaceAll("|[","").replaceAll("]","")).includes(":")&&([e,r]=e.split(":"),e===t)?r:""},d=e=>t(e,"subject"),m=e=>{e=t(e,"faculty");return e?"Business"===e?"Stirling Business School":"Faculty of "+e:""},g=(e,t)=>{e=e||"";return"United Kingdom"===e?t.macroUK:e},p=stir.curry((e,t,r)=>1!==t?e.resultsArea.insertAdjacentHTML("beforeend",r):(stir.setHTML(e.resultsArea,r),stir.scrollToElement(e.searchForm,-50),!0)),v=(e,t,r)=>{var a,s,i,n;return e.error?p(t,1,stir.getprocessDatatenanceMsg()):0<e.total_hits?({start:n,end:i}=(n=e.page,i=r.postsPerPage,isNaN(n)||isNaN(i)?{start:1,end:9}:{start:n=1===Number(n)?1:(Number(n)-1)*Number(i)+1,end:n+Number(i)-1}),n={...{page:e.page,currStart:n,currEnd:i,total:e.total_hits},...r},p(t,e.page,(a=n,s=e.hits,`
          ...
          <div class="cell">
            <div class="grid-x grid-padding-x">
              ${stir.map((e,t)=>l(e,t,a,s.length),s).join("")}
              </div>
          </div>
          <div class="cell">
