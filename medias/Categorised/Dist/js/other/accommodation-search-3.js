!function(t){if(t){const o={cookieType:"accom",urlToFavs:t.dataset.favsurl||"",activity:t.dataset.activity||""},l=t;t=stir.node("#search-form");const d=stir.node("#search-price"),c=stir.node("#search-location"),n=stir.node("#search-student-type"),u=stir.node("#search-bathroom"),v=stir.node("#search-price-value"),m=(t,e,r)=>e.length?stir.favourites.renderRemoveBtn(r,e[0].date,t):stir.favourites.renderAddBtn(r,t),p=stir.curry((t,e)=>{var r,a,s;return e?(r=stir.favourites.getFav(e.id,t.cookieType),`<div class="cell" id="fav-${e.id}">
            ...
            </div>`):""}),g=stir.curry((e,t)=>{var r;return""!==e&&t.rooms?(r=stir.filter(t=>t.bathroom===e,t.rooms)).length?(t.rooms=r,t):{}:t}),y=stir.curry((t,e)=>""===t||!e.location||t===e.location?e:void 0),h=stir.curry((e,t)=>{var r;return""!==e&&t.rooms?(r=stir.filter(t=>t.studType.includes(e),t.rooms)).length?(t.rooms=r,t):{}:t}),f=stir.curry((e,t)=>{var r;return""!==e&&t.rooms?(r=stir.filter(t=>parseFloat(e)>parseFloat(t.cost),t.rooms)).length?(t.rooms=r,t):{}:t}),b=stir.filter(t=>{if(t&&t.title)return t}),T=stir.join(""),F=stir.curry((t,e)=>e?t.filter(t=>Number(t.id)===Number(e.id))[0]:[]),$=stir.curry((t,e)=>(stir.setHTML(t,e),!0));var e,r,a,s,i;const P=(t,e,r)=>{var t=stir.map(p(t)),a=stir.map(f(e.price)),s=stir.map(h(e.studentType)),i=stir.map(g(e.bathroom)),e=stir.filter(y(e.location)),i=stir.compose(b,i,e,s,a,stir.clone)(r),e=stir.compose(T,t)(i);return $(l,`<div class="cell u-mb-3">Results based on filters - <strong>${s=i.length} ${1===s?"property":"properties"}</strong></div>`+e)},Q=accommodationData.filter(t=>t.id&&t.id.length);Q.length&&("managefavs"===o.activity&&(e=o,r=Q,s=stir.favourites.getFavsList(e.cookieType),r=stir.map(F(r)),e=stir.map(p(e)),a=$(l),r=stir.compose(b,r)(s),s=stir.compose(T,e)(r),a(s||stir.templates.renderNoFavs)),"search"===o.activity&&(e=stir.flatten(Q.map(t=>t.rooms)).map(t=>Number(t.cost)).sort((t,e)=>t-e),r=Math.ceil(e[0]),a=10*Math.ceil(r/10),s=Math.ceil(e[e.length-1]),i=10*Math.ceil(s/10),d.min=a,d.max=i,d.value=QueryParams.get("price")?QueryParams.get("price"):i,c.value=QueryParams.get("location")?QueryParams.get("location"):"",n.value=QueryParams.get("student")?QueryParams.get("student"):"",u.value=QueryParams.get("bathroom")?QueryParams.get("bathroom"):"",$(v,d.value),i={price:d.value,location:c.value,studentType:n.value,bathroom:u.value},P(o,i,Q),t&&t.addEventListener("input",t=>{var e={price:d.value};$(v,e.price)}),t)&&t.addEventListener("change",t=>{QueryParams.set("price",d.value),QueryParams.set("location",c.value),QueryParams.set("student",n.value),QueryParams.set("bathroom",u.value);var e={price:d.value,location:c.value,studentType:n.value,bathroom:u.value};P(o,e,Q)}),l.addEventListener("click",t=>{var e,r,t="BUTTON"===t.target.nodeName?t.target:t.target.closest("button");t&&t.dataset&&t.dataset.action&&("addtofavs"===t.dataset.action&&(stir.favourites.addToFavs(t.dataset.id,o.cookieType),r=stir.favourites.getFav(t.dataset.id,o.cookieType),e=stir.node("#favbtns"+t.dataset.id))&&$(e,m(o.urlToFavs,r,t.dataset.id)),"removefav"===t.dataset.action)&&(stir.favourites.removeFromFavs(t.dataset.id),e=stir.favourites.getFav(t.dataset.id,o.cookieType),"searchfavs"===o.activity&&(r=stir.node("#favbtns"+t.dataset.id))&&$(r,m(o.urlToFavs,e,t.dataset.id)),"managefavs"===o.activity)&&(r=stir.node("#fav-"+t.dataset.id))&&$(r,"")}))}}(stir.node("#search-results"));