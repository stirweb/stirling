!function(t){if(t){const a={cookieType:"accom",urlToFavs:t.dataset.favsurl||"",activity:t.dataset.activity||""},o=t;t=stir.node("#search-form");const d=stir.node("#search-price"),l=stir.node("#search-location"),c=stir.node("#search-student-type"),n=stir.node("#search-bathroom"),v=stir.node("#search-price-value"),p=(t,e,r)=>e.length?stir.favourites.renderRemoveBtn(r,e[0].date,t):stir.favourites.renderAddBtn(r,t),u=stir.curry((t,e)=>{var r,s,i;return e?(r=stir.favourites.getFav(e.id,t.cookieType),`<div class="cell" id="fav-${e.id}">
            ...
            <ul>${s.map(t=>`<li>${t}</li>`).join("")}</ul>`):""}
                    ...
                    <div class="cell large-4 text-sm">
                        ...
                        <p>${i=e.rooms,i?(i=i.map(t=>t.studType).join(",").split(",").map(t=>t.trim()),stir.removeDuplicates(i).sort().join("<br />")):""}</p>
                    </div>
