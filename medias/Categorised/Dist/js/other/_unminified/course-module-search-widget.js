...
// 	var query        = '';
// 	var level		 = (defaultLevel ? defaultLevel.value : null);
// 	
...
// 	results.hide();
// 	
// 	// TODO: refactor this legacy CSS stuff
...
// 	*/
// 	var parseSuggest = function (data) {
// 		spinner.hide();
// 		if(data.length > 0){
// 			doSearch(data[0]);
// 			return true;
...
// 			cachedResults = data.response.resultPacket.results.slice(0, POOL_LIMIT);
// 
// 			// Filter then display the results
...
// 			// The following query selector will return a NodeList, that will be
...
// 			// were radio buttons.
// 			widget.querySelectorAll('.filters input[name^="filter__"]:not([value="'+level+'"])'),
// 			// then we'll foreach round the array calling this function on each element
// 			function(filter) {
...
// 		var filterSet = {query: parameters.query};
...
// 	*/
// widget.onclick = function(e){ e.stopPropagation(); };
// 	
// 	/*
// 	* Event: On load
// 	*/
