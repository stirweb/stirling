...
// 	* @author: Ryan Kaye
// 	* @version: 2
//	* NO LONGER IN USE 2026-04-16 
// 	*/
// 	
// 	(function () {
// 	const filterPanel = stir.node("#filters_panel__startdate");
// 	
...
// 	
// 	const constants = {
// 	yearStartMonth: "08", // First month of the academic year
// 	yearEndMonth: "07", // Last month of the academic year
...
// 	* ------------------------------------------------ */
// 	const getAcadYear = (year, yearStartMonth, yearEndMonth) => {
// 	return { year: year, start: parseInt(year + yearStartMonth), end: parseInt(year + 1 + yearEndMonth) };
// 	};
// 	
// 	/* ------------------------------------------------
// 	* Returns a list of dates that fit with an academic year
// 	* ------------------------------------------------ */
// 	const filterDatesByAcadYear = (year, data) => {
// 	return stir.filter((item) => parseInt(item.num) >= year.start && parseInt(item.num) < year.end, data);
// 	};
// 	
// 	/* ------------------------------------------------
// 	* Returns current date in the format we use for comparing (eg int 202008)
// 	* ------------------------------------------------ */
// 	const getDateAsInt = (year, month) => {
// 	const currentMonth = String(month).length < 2 ? "0" + String(month) : String(month);
// 	
...
// 	* ------------------------------------------------ */
// 	const getStartYear = (year, month, acadStartMonth, switchMonth) => {
...
// 	* ------------------------------------------------*/
// 	const renderYear = (dates, meta) => {
// 	return `
// 		<fieldset>
// 			<legend>${String(meta.start).slice(0, 4)}/${String(meta.end).slice(2, 4)} </legend>
// 			${stir.join("", stir.map(renderFilter, dates))}
// 		</fieldset>`;
// 	};
// 	
// 	/* ------------------------------------------------
...
// 	* ------------------------------------------------*/
// 	const renderFilter = (date) => {
// 	return `    
// 		<div class=" c-search-filters-panel__filter">
// 		<label><input type="checkbox" name="startdate" value="${date.name}">
// 		${date.name}
// 		</label>
// 		</div>`;
// 	};
...
// 	const initialStartYear = parseInt(stir.T4Globals.startyear); // T4
// 	const initialDates = stir.T4Globals.startdates.startdates || {}; // T4 list data
// 	
...
// 	const panels = [
// 	{ year: startYear, node: filterPanel.children[0] },
// 	{ year: startYear + 1, node: filterPanel.children[1] },
// 	];
// 	
...
// 	*/
// 	const results = stir.map((item) => {
// 	if (!item.node) return;
// 	
// 	const yearMeta = getAcadYear(item.year, constants.yearStartMonth, constants.yearEndMonth);
// 	const yearDates = filterDatesByAcadYear(yearMeta, dates);
// 	
...
// 	
// 		// show filters now we have results outputted
...
// 	if (!a || !b) return false;
// 	
// 	//first, replace 'comma-space' with just a comma, using split/join trick:
// 	a = a.split(", ").join(",");
// 	b = b.split(", ").join(",");
// 	
// 	var array = a.split(",");
...
// 	*/
// 	var formResultHTML = function (data) {
// 	var html = [];
...
// 	const awards = /BSc |BAcc |BA |\(Hons\) ?\/? ?/g;
// 	
// 	index.reset();
// 	
// 	// Best Bets (a.k.a Curators)
...
// 	*/
// 	var doCheckBoxFilterChange = function (e) {
// 	var filter = {
// 		level: [],
// 		method: [],
// 		faculty: [],
...
// 	*/
// 	var updateCheckboxFilters = function () {
...
// 	*/
// 	subjClearBtn &&
// 	subjClearBtn.addEventListener("click", function (e) {
// 		subjectSelect.value = "";
// 		subject = "";
// 		reset();
// 		doSearch();
...
// 	resultFooter.appendChild(altSearch);
// 	
// 	//getHiddenInputs
...
// 	hideFilters();
// 	
// 	// add a delegate to listen for any checkbox changes
// 	filterBox && filterBox.addEventListener("change", doCheckBoxFilterChange);
// 	
...
// 	
// 	if (QueryParams.get("filter__startdate")) startdate = QueryParams.get("filter__startdate");
// 	
...
// 		subject = this.value;
// 		resultsArea.innerHTML = formResultHTML(cachedResults);
// 		if (subject !== "") resultSummary.innerHTML = '<p>Showing results for subject "' + subject + '"</p>';
// 		else resultSummary.innerHTML = "<p>Showing results for all subjects </p>";
// 		searchInput.value = "";
