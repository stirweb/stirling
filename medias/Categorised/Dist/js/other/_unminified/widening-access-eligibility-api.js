        ...
        if (data) {
          ...
          if (data.result === true) {
            if (data.postcode) {
              ...
              output.innerHTML = success ? success.value : data.message;
            }
          } else if (data.result === false) {
            if (data.postcode) {
              output.innerHTML = failure ? failure.value.replace(regex, data.postcode) : data.message.replace(regex, data.postcode);
            } else {
              output.innerHTML = failure ? failure.value : data.message;
            }
          } else {
