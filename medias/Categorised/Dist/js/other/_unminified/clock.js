...
var UoS_Clock = function () {
  var StirClock = function StirClock(timezone, locale) {
...
var UoS_ClearingClock = function () {
  ...
  var proto = Object.create(UoS_Clock.prototype); // extend the prototype by adding a new member function:
  ...
  proto.clearingHotlineOpen = function clearingHotlineOpen(date, early) {
    ...
    var weekday = dayOfWeek > 0 && dayOfWeek < 6 ? true : false; // Clearing is 8–24 August 2022
    ...
    if (weekday && hour >= 8 && hour < 16) return true; // Extended hours (August only)
  ...
  var ClearingClock = function ClearingClock(timezone, locale) {
