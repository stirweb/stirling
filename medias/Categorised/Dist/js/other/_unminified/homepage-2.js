...
(function (scope) {
  ...
  */
  ...
  var getNews = function getNews(noOfNews, data) {
    ...
    var cellClasses = noOfNews === 3 ? "large-4 medium-6" : "large-6 medium-12"; // Curry set ups
...
(function () {
  ...
  if (placeholder) {
    ...
    placeholder.setAttribute("data-placeholder", placeholder.placeholder); // function to handle toggling the value
    ...
    placeholderchanger(); // listen for MediaQueryChange events so we can check again
