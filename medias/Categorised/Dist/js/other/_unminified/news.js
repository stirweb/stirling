(function estimateReadingTime(newstextEls) {
  var words = 0,
      images = 0,
      time = 0,
      elem; // count masthead image(s)

  if (elem = document.querySelectorAll('.c-masthead__image')) images += elem.length; //count words and in-article images
  ...
  time = Math.round(words / 275 + images * 0.2); // display reading time on the page
