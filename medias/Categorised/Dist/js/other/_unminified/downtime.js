...
(function () {
  ...
  var linksAddModal = [document.getElementById('coursebodyenquiry'), document.getElementById('coursestickyenquiry'), document.getElementById('header-portal__button'), document.querySelector('.courseapply_pg'), document.querySelectorAll('.courseapply_pg')[1]];
