 ...
 */
 ...
 (function() {
    ...
    var portalDowntimeErrorMessageRenderer = function(data) {
...
(function() {
    ...
    var linksAddModal = [
        document.getElementById('coursebodyenquiry'),
        document.getElementById('coursestickyenquiry'),
        document.getElementById('header-portal__button'),  
        document.querySelector('.courseapply_pg'),
        document.querySelectorAll('.courseapply_pg')[1]
    ];

    // These 2 already open in a modal so we can use it but overwrite the content 
    var linksAmendModal = [
        document.querySelectorAll('[data-modalopen]')[0],
        document.querySelectorAll('[data-modalopen]')[1]
    ];  
                  
    /*
     * Function: Determine if downtime is active
     */
    var isDowntime = function(){
        if(downtime){
            if(now > start){
