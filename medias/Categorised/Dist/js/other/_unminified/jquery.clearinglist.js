    ...
    $.fn.clearinglist = function(options) {        
        ...
        var extraDataRegionOne =[
            ...
            },
            {
                ...
                metaData: {"B": "BAcc", "U": "NR44"},
                liveUrl: ""
            },
            {
                title: 'Accounting',
                metaData: {"B": "BA (Hons)", "U": "N401"},
                liveUrl: ""
            },
            {
        ...
        switch(settings.region){
            ...
            default:
                fallback.call(this);
                return this; //if region is invalid, we just fire the callback and return early.
        }
                ...
                var tAppend = ""; // extra note about a course, appended after the title 
                 ...
                 for (var i = 0; i < results.length; i++) {
                    ...
                    if(!skip){
                        ...
                        html.push('<tr>');
                        if(results[i]["liveUrl"])
							html.push('<td><a href="'+ results[i]["liveUrl"]+'">' + prefix + ' ' + results[i].title + '</a>' + tAppend + '</td>');
                        else
                        	html.push('<td>' + prefix + ' ' + results[i].title + '' + tAppend + '</td>');
