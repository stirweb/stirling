(function () {
  ...
  (function (path) {
    ...
    if (0 === path.indexOf("/international/international-students/") || 0 === path.indexOf("/international/international-summer-school/") || 0 === path.indexOf("/international/study-abroad-exchange/")) return initialiseUniBuddyPopCard(); // UNDERGRAD
