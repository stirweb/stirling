function initialize() {
  ...
  var bounds = new google.maps.LatLngBounds(); // this will contain markers so we can show/hide them when checkboxes
  // are clicked

  var markers = []; // this is to set the url of where to fetch partner xml
  ...
  $(".c-full-width-map__legend input[type='checkbox']").on("change", function (e) {
    ...
    var type = $(this).data("type"); // loop though each marker and check it's type and decide whether to show/hide
