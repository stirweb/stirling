(function () {
  ...
  function delorean() {
    var value = Number(fluxCapacitor.value); //REALTIME
  ...
  if (fluxCapacitor) {
    ...
    try {
      ...
      debugOutputElement.querySelector('[data-value="current-time-local"]').textContent = new Date().toLocaleString("en-GB"); // won't work in IE:
