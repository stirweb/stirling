...
(function () {
  ...
  var renderItem = function renderItem(item) {
    var fs = item.feeStatus ? item.feeStatus : "";
  ...
  if (searchForm && resultsArea) {
    ...
    var loadData = function loadData(setFilters, page) {
      var setDOMResults = setDOMContent(resultsArea);
      ...
      var data = stir.compose(sortDataFn, filterDataCurry, stir.clone)(initialData);
      ...
      var renderer = renderFormResults(meta);
