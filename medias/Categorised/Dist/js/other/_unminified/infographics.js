 ...
 */
  ...
  */
(function() {
    var circles, donut = document.querySelector('.progress');
                ...
                (function(values) {
                    ...
                    for(var i=0; i<max; i++){
                        (function(item) {
                            ...
                            stats.push({
                                el: item,                   //DOM element to animate
                                val: value,                 //total value we animate up to
                                current: 0,                 //current value during the animation runtime
