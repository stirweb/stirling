!function(e){if(e){const n=e;var e=stir.node("#open_mobile_menu"),t=stir.node("#close_mobile_menu");const l=stir.node("ul.sitemenu-2"),a=["main","footer","#layout-header",".breadcrumbs-container"],i={default:l.innerHTML},s=()=>'<li><a class="button button--left-align expanded button--back secondary u-m-0 text-left" href="/">Home</a>',r=e=>e?`<li class="u-bg-heritage-green">
        ...
        </li>`:""},d=e=>{var t;return t="p",[...new Map(e.map(e=>[e[t],e])).values()].map(o).join("")},u=e=>{var t=e.slice(0,-1).lastIndexOf("/"),t=-1==t?e.length:t+1;return e.substring(0,t)},p=(e,t,n)=>{const a=t.split("/").length+1;var i=e.filter(e=>{if(e.p&&e.p.split("/").length===a&&e.p.includes(t))return e});if(!i.length&&"click"===n)return"";n=e.filter(e=>{if(e.p===t)return e});const o=u(t);e=e.filter(e=>{if(e.p===o)return e});return s()+r(e[0])+c(n[0])+d(i)},g=(t,n,a)=>{const i=t.split("/")[1];o=i;var e,o="dev"===UoS_env.name||"qa"===UoS_env.name?"/pages/data/awd/mobilenavs/"+o+"/index.json":"/developer-components/includes/template-external/mobile-nav-json/"+o+"/index.json";return console.log(t),t.includes("https://")?(window.location=t,{action:"go "}):""===i?(l.innerHTML=n.default,{action:"navigate"}):n[i]?(e=p(n[i],t,a))?(stir.setHTML(l,e),{action:"navigate"}):(window.location=t,{action:"go "}):(stir.setHTML(l,'<li><span class="button expanded no-arrow">Loading...</span></li>'),stir.getJSON(o,e=>{if(e.error)return window.location=t,{action:"go"};n[i]=e;e=p(e,t,a);return e?(stir.setHTML(l,e),{action:"navigate"}):(window.location=t,{action:"go"})}),{action:"null"})};e&&e.addEventListener("click",e=>{a.forEach(e=>{stir.node(e)&&stir.node(e).classList.add("hide")}),n.classList.add("c-mobile-menu-visible"),g("dev"===UoS_env.name||"qa"===UoS_env.name?"/about/professional-services/":window.location.pathname,i,"open"),e.preventDefault()}),t&&t.addEventListener("click",e=>{a.forEach(e=>{stir.node(e)&&stir.node(e).classList.remove("hide")}),n.classList.remove("c-mobile-menu-visible"),e.preventDefault()}),l&&l.addEventListener("click",e=>{var t=e.target.closest("a");"go"===t.getAttribute("data-action")?window.location=t.getAttribute("href"):(t=g(t.getAttribute("href"),i,"click").action,t&&"navigate"===t&&l.scrollIntoView(),e.preventDefault())})}}(document.getElementById("mobile-menu-2"));