!function(){const s=e=>{return"string"==typeof e&&e.trim().length?`${(e=e.split(" "))[0]} ${e[1].slice(0,3)} `+e[2]:""},l=(e,s)=>` <div class="cell small-12 medium-${e}">
                <div class="grid-x">
                    <div class="cell"><h2 class="header-stripped u-header--margin-stripped">News</h2></div>
                    ${s}
                </div>
            </div>`,n=e=>e?` <div class="cell small-12 medium-4">
                <div class="grid-x">
                    <div class="cell"><h2 class="header-stripped u-header--margin-stripped">Events</h2></div>
                    ${e}
                </div>
            </div>`:"",d=e=>`<div class="cell small-12 ">
            ...
            </div>`),m=()=>Number((new Date).toISOString().split(".")[0].replaceAll(/[-:T]/g,"").slice(0,-2)),o=(e,s)=>parseInt(e.startInt)-parseInt(s.startInt),u=i=>e=>{return{...e,isupcoming:(s=i,(e=>Number(e.endInt)>s)(e))};var s},p=e=>e.id,h=e=>e.isupcoming,g=s=>e=>e.tags.includes(s),v=e=>e.filter((e,s)=>0===s);var e,i;{const $=stir.node("#newsEventListing"),f=$.dataset.tags;$&&f&&(e=UoS_env.name,i={dev:"../index.json",preview:'<t4 type="navigation" id="5214" />',default:'<t4 type="navigation" id="5214" />index.json'},fetch(i[e]||i.default).then(e=>e.ok?e.json():Promise.reject("Network response was not ok")).catch(e=>(console.error("There was a problem fetching the data:",e),[])).then(e=>{var s,i,t,r,a;e=e,s=newsList,i=f,t=$,r=m(),i=stir.compose(stir.map(d),v,stir.sort(o),stir.filter(g(i)),stir.filter(h),stir.map(u(r)),stir.filter(p))(e),r=1===i.length?2:3,e=2==r?6:4,a=2==r?8:12,e=c(e),e=stir.map(e,s).slice(0,r),t.innerHTML=l(a,e.join(""))+n(i.join(""))}))}}();