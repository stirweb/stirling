!function(){const n=Object.freeze({items:Object.freeze({small:3,large:10}),sizes:Object.freeze({third:4,half:6,twoThirds:8,full:12}),months:Object.freeze(["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"])}),r=e=>{var t=new Date(e);return isNaN(t.getTime())?(console.error("Invalid date provided: "+e),""):t.getDate()+` ${n.months[t.getMonth()]} `+t.getFullYear()},a=(e,t)=>e?` <div class="u-aspect-ratio-3-2 ">
              ...
              <div class="u-border-width-5 u-heritage-line-left u-p-2 ">
               <p class="header-stripped u-mb-1 u-font-normal u-compress-line-height">
                ...
                <p class="text-sm">${e.meta_description||e.highlight}</p>
              </div>
               ${a(s.thumbnail,t.h1_custom)}
            </div>`}),o=stir.curry((e,t)=>{var s=t.custom_fields,i=l(s.data);return`<div class="cell small-12 medium-${e}">
                ${a(i.thumbnail,s.h1_custom)}
                <time class="u-block u-my-1 u-grey--dark">${r(s.d)}</time>
                <p class="header-stripped u-mb-1 u-font-normal u-compress-line-height">
                    <a href="${t.url}" class=" u-inline text-sm">${s.h1_custom}</a>
                </p>
                <p class="text-sm">${t.meta_description||t.highlight}</p>
            </div>`}),c=stir.curry(e=>{var t=e.custom_fields,s=r(t.d.split("T")[0]),i=r(t.e.split("T")[0]);return`<div class="cell small-12 u-grid-medium-up u-gap-24 u-grid-cols-2_1 u-mb-2 u-bg-white">
              <div class="u-border-width-5 u-heritage-line-left u-p-2">  
                <p class="header-stripped u-mb-1 u-font-normal u-compress-line-height">
                  <a href="${e.url}" class=" u-inline text-sm">${t.name}</a>
                </p>
                 <time class="u-block u-my-1 u-grey--dark">${s} ${i===s?"":"-"+i}</time>
                <p class="text-sm">${t.snippet}</p>
              </div>
             ${a(t.image,t.name)}
            </div>`}),m=stir.curry(e=>{var t=e.custom_fields,s=r(t.d.split("T")[0]),i=r(t.e.split("T")[0]);return`<div class="cell small-12" data-type="compactevent">
              ${a(t.image,t.name)}
                <time class="u-block u-my-1 u-grey--dark">${s} ${i===s?"":"-"+i}</time>
                <p class="header-stripped u-mb-1 u-font-normal u-compress-line-height">
                    <a href="${e.url}" class=" u-inline text-sm">${t.name}</a>
