!function(){var e=s=>e=>"string"==typeof e&&e.trim().length?s(e.split(" ")):"";const t=e(([,e,s,t])=>`${e} ${s.slice(0,3)} `+t),s=e(([e,s,t])=>`${e} ${s.slice(0,3)} `+t),a=(e,s)=>` <div class="cell small-12 medium-${e}">
                <div class="grid-x">
