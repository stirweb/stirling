!function(){const s=e=>{e=new Date(e);return e.getDate()+` ${["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"][e.getMonth()]} `+e.getFullYear()},r=e=>e?` <div class="cell small-12 medium-4">
                <div class="grid-x">
            ...
            </div>`),a=e=>e.toISOString().split(".")[0].replaceAll(/[-:T]/g,"").slice(0,-2),o=()=>Number(a(new Date)),m=s=>e=>{return{...e,isupcoming:(t=s,(e=>Number(a(new Date(e.metaData.d)))>t)(e))};var t},d=e=>e.isupcoming,u=e=>e.slice(0,1),p=stir.curry((e,t)=>t.slice(0,e)),e=e=>fetch(e).then(e=>e.ok?e.json():Promise.reject("Network response was not ok")).catch(e=>(console.error("There was a problem fetching the data:",e),[]));{var t="https://"+UoS_env.search;const v=stir.node("#newsEventListing");var l=v?.dataset.eventtag,g=v?.dataset.newstag;v&&(l=t+"/s/search.json?collection=stir-events&SF=[d,startDate,type,tags,page,image]&query=!null&sort=date&fmo=true&meta_tags="+l,t=t+"/s/search.json?collection=stir-main&SF=[d,type,tags,facult,thumbnail]&query=&sort=date&fmo=true&meta_type=news&meta_tags="+g,Promise.all([e(l),e(t)]).then(([e,t])=>{var s,a,l,e=e.response.resultPacket.results,t=t.response.resultPacket.results,e=(console.log("Events:",e),console.log("News:",t),e=e,t=t,s=o(),s=stir.pipe(stir.map(m(s)),stir.filter(d),u,stir.map(i))(e),e=1===s.length?2:3,a=2==e?6:4,l=2==e?8:12,a=stir.pipe(stir.map(c(a)),p(e))(t),{newsContent:n(l,a.join("")),eventsContent:r(s.join(""))});v.innerHTML=e.newsContent+e.eventsContent}).catch(e=>{console.error("Error fetching data:",e)}))}}();