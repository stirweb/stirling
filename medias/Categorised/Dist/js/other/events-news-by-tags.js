!function(){const s=e=>{e=new Date(e);return e.getDate()+` ${["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"][e.getMonth()]} `+e.getFullYear()},a=(e,t)=>e?` <div class="u-aspect-ratio-16-9 ">
            ...
            </div>`),r=e=>e.toISOString().split(".")[0].replaceAll(/[-:T]/g,"").slice(0,-2),m=()=>Number(r(new Date)),o=s=>e=>{return{...e,isupcoming:(t=s,(e=>Number(r(new Date(e.metaData.d)))>t)(e))};var t},u=e=>e.isupcoming,d=e=>e.slice(0,1),p=stir.curry((e,t)=>t.slice(0,e)),e=e=>fetch(e).then(e=>e.ok?e.json():Promise.reject("Network response was not ok")).catch(e=>(console.error("There was a problem fetching the data:",e),[]));{var t="https://"+UoS_env.search;const v=stir.node("#newsEventListing");var h=v?.dataset.eventtag,g=v?.dataset.newstag;v&&(h=t+"/s/search.json?collection=stir-events&SF=[d,startDate,type,tags,page,image]&query=!null&sort=date&fmo=true&meta_tags="+h,t=t+"/s/search.json?collection=stir-main&SF=[d,type,tags,facult,thumbnail]&query=&sort=date&fmo=true&meta_type=news&meta_tags="+g,Promise.all([e(h),e(t)]).then(([e,t])=>{var s,a,r,e=e.response.resultPacket.results,t=t.response.resultPacket.results,e=(e=e,t=t,s=m(),s=stir.pipe(stir.map(o(s)),stir.filter(u),d,stir.map(l))(e),e=1===s.length?2:3,a=2==e?6:4,r=2==e?8:12,a=stir.pipe(stir.map(c(a)),p(e))(t),{newsContent:n(r,a.join("")),eventsContent:i(s.join(""))});v.innerHTML=e.newsContent+e.eventsContent}).catch(e=>{console.error("Error fetching data:",e)}))}}();