!function(){var t=document.querySelector("[data-activity]");if(!t)return;var e={showUrlToFavs:t.dataset.favsurl||"",activity:t.dataset.activity||"",view:stir.templates?.view||""},t={resultsArea:t,sharedArea:document.querySelector("[data-activity=shared]"),favBtnsNode:document.querySelector("[data-area=favActionBtns]"),latestArea:stir.node("[data-activity=latestfavs]")};const s=t=>t&&t.id?`<div class="cell large-3 text-sm u-bg-white u-p-1 u-mb-1" id="microfav-${t.custom_fields.sid}">
            ...
            <div class="u-bg-white u-heritage-line-left u-border-width-5 u-mb-3">
              <div class="grid-x grid-padding-x u-p-2 ">
                ...
                <div class="cell text-sm u-pt-2" id="favbtns${e.sid}" data-type="${e.type}">
                  ${c(r.showUrlToFavs,i,e.sid)}
                </div>
              </div>
            </div>
          </div>`):""},l=t=>{var e,a;return t.id?(e=t.custom_fields||{},a=d(e.data).register||t.url,t=e.snippet||t.meta_description,`
    ...
    <div data-type="${e.type}">${stir.favourites.isFavourite(e.sid)?'<p class="text-sm u-heritage-green">Already in your favourites</p>':stir.favourites.renderAddBtn(e.sid,"")}</div>
            ...
            <p class="text-xsm">${t}</p>`:"",r=()=>stir.templates.renderNoFavs,v=()=>stir.templates.renderNoShared,u=stir.curry((t,e)=>(stir.setHTML(t,e),!0)),a=t=>"string"!=typeof t?"":t.replace(/[^a-zA-Z0-9-_]/g,""),p={get:t=>a(QueryParams.get(t)),set:(t,e)=>QueryParams.set(t,a(e)),remove:QueryParams.remove},m=t=>{const e={and:[{or:[]}]};return t.forEach(t=>{e.and[0].or.push({"custom_fields.sid":t})}),e};const f=t=>{t="BUTTON"===t.target.nodeName?t.target:t.target.closest("button");if(t&&t.dataset&&t.dataset.action){if("clearallfavs"===t.dataset.action){if(!t.dataset.fav)return;var e=t.dataset.fav,a="accommodation"===e?"accom":e;stir.favourites.removeType(e),document.querySelector(`[data-favtype="${a}"]`).innerHTML=r()}"copysharelink"===t.dataset.action&&(e="https://www.stir.ac.uk/share/"+stir.favourites.getFavsListAll().map(t=>t.id).join("I"),navigator.clipboard&&navigator.clipboard.writeText(e),a=stir.t4Globals.dialogs.find(t=>"shareDialog"===t.getId()))&&(a.open(),a.setContent(i(e)))}},g=(o,d)=>t=>{const e="shared"===d.dataset.activity,a=t.target.closest("button");if(a&&a.dataset&&a.dataset.action){var s;if("addtofavs"===a.dataset.action){stir.favourites.addToFavs(a.dataset.id,o.cookieType);{var t=a.dataset.id;var i=stir.favourites.getFav(t,o.cookieType);const r=stir.node("#favbtns"+t);if(r&&u(r)(c(o.showUrlToFavs,i,t)),e){const r=a.parentNode;r&&u(r)(c(o.showUrlToFavs,i,t))}}}"removefav"===a.dataset.action&&(stir.favourites.removeFromFavs(a.dataset.id),i=document.querySelector("#fav-"+a.dataset.id),(t=document.querySelector("#microfav-"+a.dataset.id))&&t.remove(),i&&i.remove(),e)&&(t=a.parentNode,s=stir.favourites.getFav(a.dataset.id,o.cookieType),t)&&u(t)(c(o.showUrlToFavs,s,a.dataset.id))}};function h(d,e){const a=stir.favourites.getFavsListAll().sort((t,e)=>e.date-t.date);var t;a&&a.length?(t=m(a.map(t=>t.id)),t=`https://api.addsearch.com/v1/search/dbe6bc5995c4296d93d74b99ab0ad7de?term=*&limit=100&filter=${encodeURIComponent(JSON.stringify(t))}&`,fetch(t).then(t=>t.json()).then(r=>{const o=Array.from(document.querySelectorAll("[data-favtype]"));o.map(t=>t.dataset.favtype||"").forEach(e=>{var t,a,s=o.find(t=>t.dataset.favtype===e),i=r.hits.filter(t=>t.custom_fields&&t.custom_fields.type&&t.custom_fields.type.includes(e));s=s,i=i,t={...t=d,cookieType:s.dataset.favtype||""},a=n(t),i=i.map(a).join(""),u(s,i||""+stir.templates.renderNoFavs),s.addEventListener("click",g(t,s))});var t=a.slice(0,4).map(e=>r.hits.find(t=>Number(t.custom_fields.sid)===Number(e.id))).map(s).join("");u(e.latestArea,t||'<div class="cell">No favourites saved.</div>')})):(u(e.resultsArea,r()),u(e.latestArea,'<div class="cell">No favourites saved.</div>'))}e=e,(t=t).favBtnsNode&&(console.log("favs action btns"),stir.node("main").addEventListener("click",f)),"managefavs"!==e.activity&&"latestfavs"!==e.activity||h(e,t,e.activity),"shared"===e.activity&&(function(e,a){var t=p.get("s")||"";if(!t)return u(e,v());try{var s=t.split("I"),i=m(s),r=`https://api.addsearch.com/v1/search/dbe6bc5995c4296d93d74b99ab0ad7de?term=*&limit=100&filter=${encodeURIComponent(JSON.stringify(i))}&`;fetch(r).then(t=>t.json()).then(t=>{var t=t?.hits||[];t.length&&(t=t.map(l).join(""),u(e,t||v()),e.addEventListener("click",g(a,e)))})}catch(t){}}(t.sharedArea,e),stir.node("main").addEventListener("click",f))}();const FavouritePromos=t=>{if(t&&t.length){const i=t=>`
      ...
      </div>`;var s;s=t,stir.nodes("[data-promos]").forEach(t=>{const e=t.getAttribute("data-promos");var a=s.filter(t=>t.type===e);promoHtml=a.map(i).join(""),stir.setHTML(t,promoHtml)})}};stir.promosData=stir.promosData||[],FavouritePromos(stir.promosData);