const FavouritesArea=(t,e)=>{if(t){var a,s,r,i,o=t.querySelector("[data-activity]"),e={allowedCookieTypes:["accom","course","schol","page"],cookieType:e,urlToFavs:o.dataset.favsurl||"",activity:o.dataset.activity||"",view:stir.templates?.view||""},o={resultsArea:o,sharedArea:t.querySelector("[data-activity=shared]"),favBtnsNode:t.querySelector("[data-area=favActionBtns]"),latestArea:stir.node("[data-activity=latestfavs]")};const c=t=>t=>`<div class="cell large-3 text-sm u-bg-white u-p-1 u-mb-1">
                <p class="u-text-regular  "><strong><a href="${t.url}">${t.title}</a></strong></p>
                 <p><strong>${stir.capitaliseFirst(t.type)}</strong></p>
            </div>`,n=(t,e,a)=>e.length?stir.favourites.renderRemoveBtn(a,e[0].date,t):stir.favourites.renderAddBtn(a,t),v=r=>t=>{var e,a,s;return t?(e=stir.favourites.getFav(t.id,r.cookieType),`
