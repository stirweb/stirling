!function(t){if(t)if(stir.feeds&&stir.feeds.data){const a=stir.curry(a=>{var t=(a.portalapply?a.portalapply.split(", ").map(t=>t.trim()):[]).map((t,r)=>`<a href="https://portal.stir.ac.uk/student/course-application/ugd/application.jsp?crsCode=${t}">${a.prefix.split(" / ")[r]} ${a.title}</a>`).join(", ");return`
               <tr>
                   <td>
                    ${a.portalapply?t:""}
                   </td>
