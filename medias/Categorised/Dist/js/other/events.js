!function(){if(stir.node("#eventsrevamp")){const u=10;var e=stir.node("[data-tags]")||"",e=e?e.dataset.tags:"";console.log(e);const R=stir.node("#eventspublic"),z=stir.node("#eventsstaff"),B=stir.node("#eventsarchive");var t=stir.node("#eventspromo");const s=stir.node("#eventspublicfilters"),r=stir.node("#eventsstafffilters"),i=stir.node("#eventsarchivefilters");var C=stir.node("#eventspublictab"),F=stir.node("#eventsstafftab"),j=stir.node("#eventsarchivetab"),W=stir.nodes(".stir-tabs__tab");const a=(e,t)=>`<div class="c-search-result__image"><img src="${e}" width="275" height="275" alt="Image: ${t}"></div>`,n=e=>`<div class="c-search-result__tags">
            ...
            <div class="c-search-result  ${e.image?"c-search-result__with-thumbnail":""}" data-result-type="event" ${r=e,r.pin<1?'data-label-icon="pin"':r.isSeries?'data-label-icon="startdates"':""}  >
            ...
            <div class="c-search-result ${e.image?"c-search-result__with-thumbnail":""}" data-result-type="event"  >
                ...
                ${e.image?a(e.image,e.title):""}  
            </div>`),h=stir.curry((e,t)=>(stir.setHTML(e,t),!0)),f=stir.curry((e,t)=>(e.insertAdjacentHTML("beforeend",t),e));t=h(t);const $=()=>{var e=new Date;return Number(e.toISOString().split("T")[0].split("-").join("")+("0"+e.getHours()).slice(-2)+("0"+e.getMinutes()).slice(-2))};const b=stir.filter(e=>e.audience.includes("Public")),y=stir.filter(e=>e.audience.includes("Staff")||e.audience.includes("Student"));const S=stir.filter(e=>Number(e.endInt)<$()&&e.archive.length);const D=stir.filter(e=>Number(e.endInt)>=$()&&!e.hideFromFeed.length);var Y=stir.filter(e=>e.eventPromo);const x=stir.join("");var H=stir.filter((e,t)=>0===t);const w=(e,t)=>Number(e.startInt)-Number(t.startInt),I=(e,t)=>Number(t.startInt)-Number(e.startInt),k=(e,t)=>Number(e.pin)-Number(t.pin),G=stir.filter(e=>e.recording),P=stir.curry((e,t,s)=>{e=t*(e-1);return e<=s&&s<e+t}),J=stir.curry((e,t)=>{return!!e.filter(e=>e===t).length}),N=(e,t)=>{var s=[];for(d=new Date(e);d<=new Date(t);d.setDate(d.getDate()+1))s.push(new Date(d).toISOString().split("T")[0]);return s},T=()=>{var e=new Date,t=new Date(e.setDate(e.getDate()+(0-e.getDay())%7)),e=new Date(e.setDate(e.getDate()+6));return{start:t.toISOString().split("T")[0],end:e.toISOString().split("T")[0]}},Q=()=>{var e=new Date,t=new Date(e.setDate(e.getDate()+(7-e.getDay())%7)),e=new Date(e.setDate(e.getDate()+6));return{start:t.toISOString().split("T")[0],end:e.toISOString().split("T")[0]}},_=()=>{var e=new Date,t=new Date(e.getFullYear(),e.getMonth(),2),e=new Date(e.getFullYear(),e.getMonth()+1,1);return{start:t.toISOString().split("T")[0],end:e.toISOString().split("T")[0]}},K=()=>{var e=new Date,t=new Date(e.getFullYear(),e.getMonth()+1,2),e=new Date(e.getFullYear(),e.getMonth()+2,1);return{start:t.toISOString().split("T")[0],end:e.toISOString().split("T")[0]}},U=e=>"thisweek"===e?N(T().start,T().end):"nextweek"===e?N(Q().start,Q().end):"thismonth"===e?N(_().start,_().end):"nextmonth"===e?N(K().start,K().end):null,V=stir.curry((t,e)=>{e=N(e.start,e.end).map(e=>J(t,e));return stir.any(e=>e,e)});var A=stir.curry((e,t)=>{e=e.split(", ");if(!e)return t;const s=t.tags.split(", ");e=e.map(e=>s.includes(e));return stir.all(e=>e,e)?t:void 0});const E=stir.filter(A(e)),O=(e,t)=>{e=U(e);const s=Number(QueryParams.get("page"))||1;var r,i,a=u*(s-1),n=a+u,l=(1===s?h:f)(R),c=stir.filter((e,t)=>{if(P(s,u,t))return e});e?(e=V(e),e=stir.filter(e,t),e=stir.compose(stir.sort(k),stir.sort(w),b,E,D)(e),r=stir.compose(x,o,c)(e),i=e.length,e.length?l(g(a,n,i)+r+p(n,i)):l(m())):(e=stir.compose(stir.sort(k),stir.sort(w),b,E,D)(t),r=stir.compose(x,o,c)(e),i=e.length,e.length?l(g(a,n,i)+r+p(n,i)):l(m()))},q=(e,t)=>{e=U(e);const s=Number(QueryParams.get("page"))||1;var r,i,a=u*(s-1),n=a+u,l=(1===s?h:f)(z),c=stir.filter((e,t)=>{if(P(s,u,t))return e});e?(e=V(e),e=stir.filter(e,t),e=stir.compose(stir.sort(k),stir.sort(w),y,E,D)(e),r=stir.compose(x,o,c)(e),i=e.length,e.length?l(g(a,n,i)+r+p(n,i)):l(m())):(e=stir.compose(stir.sort(k),stir.sort(w),y,E,D)(t),r=stir.compose(x,o,c)(e),i=e.length,e.length?l(g(a,n,i)+r+p(n,i)):l(m()))},L=(e,t)=>{const s=Number(QueryParams.get("page"))||1;var r,i,a,n=u*(s-1),l=n+u,c=(1===s?h:f)(B),o=stir.filter((e,t)=>{if(P(s,u,t))return e});"all"===e&&(r=stir.compose(stir.sort(I),E,S)(t),i=stir.compose(x,v,o)(r),a=r.length,r.length?c(g(n,l,a)+i+p(l,a)):c(m())),"recordings"===e&&(r=stir.compose(stir.sort(I),G,E,S)(t),i=stir.compose(x,v,o)(r),a=r.length,r.length?c(g(n,l,a)+i+p(l,a)):c(m())),"public"===e&&(r=stir.compose(stir.sort(I),b,E,S)(t),i=stir.compose(x,v,o)(r),a=r.length,r.length?c(g(n,l,a)+i+p(l,a)):c(m())),"staffstudent"===e&&(r=stir.compose(stir.sort(I),y,E,S)(t),i=stir.compose(x,v,o)(r),a=r.length,r.length?c(g(n,l,a)+i+p(l,a)):c(m()))},M=(s.querySelector("input[type=radio]").checked=!0,r.querySelector("input[type=radio]").checked=!0,i.querySelector("input[type=radio]").checked=!0,stir.feeds.events.filter(e=>e.id));QueryParams.set("page",1),console.log(M),O("all",M),q("all",M),L("all",M),stir.compose(t,x,stir.map(e=>`
