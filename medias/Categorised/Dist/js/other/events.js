!function(){if(stir.node("#eventsrevamp")){const u=10;var e=stir.node("[data-tags]")||"",e=e?e.dataset.tags:"";const z=stir.node("#eventspublic"),B=stir.node("#eventsstaff"),G=stir.node("#eventsarchive");var t=stir.node("#eventspromo");const s=stir.node("#eventspublicfilters"),r=stir.node("#eventsstafffilters"),i=stir.node("#eventsarchivefilters");var M=stir.node("#eventspublictab"),C=stir.node("#eventsstafftab"),j=stir.node("#eventsarchivetab"),W=stir.nodes(".stir-tabs__tab");const a=(e,t)=>`<div class="c-search-result__image"><img src="${e}" width="275" height="275" alt="Image: ${t}"></div>`,n=e=>`<div class="c-search-result__tags">
        ...
        </div>`),H,Y,stir.sort(I),_,D)(L),stir.each(e=>{e.addEventListener("click",e=>{QueryParams.set("page",1)})},W),M.addEventListener("click",e=>{var t=Number(QueryParams.get("page"))||1;"radio"===e.target.type&&(QueryParams.set("page",1),O(s.querySelector("input:checked").value,L)),"submit"===e.target.type&&(f(e.target.closest(".loadmorebtn"),""),QueryParams.set("page",t+1),O(s.querySelector("input:checked").value,L))}),C.addEventListener("click",e=>{var t=Number(QueryParams.get("page"))||1;"radio"===e.target.type&&(QueryParams.set("page",1),q(r.querySelector("input:checked").value,L)),"submit"===e.target.type&&(f(e.target.closest(".loadmorebtn"),""),QueryParams.set("page",t+1),q(r.querySelector("input:checked").value,L))}),j.addEventListener("click",e=>{var t=Number(QueryParams.get("page"))||1;"radio"===e.target.type&&(QueryParams.set("page",1),F(i.querySelector("input:checked").value,L)),"submit"===e.target.type&&(f(e.target.closest(".loadmorebtn"),""),QueryParams.set("page",t+1),F(i.querySelector("input:checked").value,L))})}}();