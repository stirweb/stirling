!function(){if(stir.node("#eventsrevamp")){const u=10;var e=stir.node("[data-tags]")||"",e=e?e.dataset.tags:"";const z=stir.node("#eventspublic"),B=stir.node("#eventsstaff"),G=stir.node("#eventsarchive");var t=stir.node("#eventspromo");const s=stir.node("#eventspublicfilters"),r=stir.node("#eventsstafffilters"),i=stir.node("#eventsarchivefilters");var C=stir.node("#eventspublictab"),F=stir.node("#eventsstafftab"),j=stir.node("#eventsarchivetab"),W=stir.nodes(".stir-tabs__tab");const a=(e,t)=>`<div class="c-search-result__image"><img src="${e}" width="275" height="275" alt="Image: ${t}"></div>`,n=e=>`<div class="c-search-result__tags">
            ...
            </div>`,l=e=>`<p class="text-sm">Part of the ${e} series.</p>`,m=()=>'<div class="u-bg-white u-p-2 u-mb-2"><p class="u-m-0">No more events found</p></div>',c=e=>e?`<span class="u-bg-heritage-berry u-white c-tag u-mr-1">${e}</span>`:"",o=e=>e.isSeries?"":`<div class="flex-container u-gap-16 align-middle">
          ...
          <span><time>${e.startTime}</time> – <time>${e.endTime}</time></span>
            ...
            <div class="c-search-result ${e.image?"c-search-result__with-thumbnail":""}" data-result-type="event"  >
                ...
                ${e.image?a(e.image,e.title):""}  
            </div>`),f=stir.curry((e,t)=>(stir.setHTML(e,t),!0)),$=stir.curry((e,t)=>(e.insertAdjacentHTML("beforeend",t),e));t=f(t);const b=()=>{var e=new Date;return Number(e.toISOString().split("T")[0].split("-").join("")+("0"+e.getHours()).slice(-2)+("0"+e.getMinutes()).slice(-2))};const y=stir.filter(e=>e.audience.includes("Public")),S=stir.filter(e=>e.audience.includes("Staff")||e.audience.includes("Student"));const D=stir.filter(e=>Number(e.endInt)<b()&&e.archive.length);const w=stir.filter(e=>Number(e.endInt)>=b()&&!e.hideFromFeed.length);var Y=stir.filter(e=>e.eventPromo);const x=stir.join("");var H=stir.filter((e,t)=>0===t);const I=(e,t)=>Number(e.startInt)-Number(t.startInt),P=(e,t)=>Number(t.startInt)-Number(e.startInt),k=(e,t)=>Number(e.pin)-Number(t.pin),J=stir.filter(e=>e.recording),N=stir.curry((e,t,s)=>{e=t*(e-1);return e<=s&&s<e+t});var A=stir.curry((t,s)=>{var r={},i=[];for(let e=0;e<s.length;e++)r[s[e][t]]||(r[s[e][t]]=!0,i.push(s[e]));return i});const K=stir.curry((e,t)=>{return!!e.filter(e=>e===t).length}),Q=(e,t)=>{var s=[];for(d=new Date(e);d<=new Date(t);d.setDate(d.getDate()+1))s.push(new Date(d).toISOString().split("T")[0]);return s},T=()=>{var e=new Date,t=new Date(e.setDate(e.getDate()+(0-e.getDay())%7)),e=new Date(e.setDate(e.getDate()+6));return{start:t.toISOString().split("T")[0],end:e.toISOString().split("T")[0]}},U=()=>{var e=new Date,t=new Date(e.setDate(e.getDate()+(7-e.getDay())%7)),e=new Date(e.setDate(e.getDate()+6));return{start:t.toISOString().split("T")[0],end:e.toISOString().split("T")[0]}},V=()=>{var e=new Date,t=new Date(e.getFullYear(),e.getMonth(),2),e=new Date(e.getFullYear(),e.getMonth()+1,1);return{start:t.toISOString().split("T")[0],end:e.toISOString().split("T")[0]}},X=()=>{var e=new Date,t=new Date(e.getFullYear(),e.getMonth()+1,2),e=new Date(e.getFullYear(),e.getMonth()+2,1);return{start:t.toISOString().split("T")[0],end:e.toISOString().split("T")[0]}},Z=e=>"thisweek"===e?Q(T().start,T().end):"nextweek"===e?Q(U().start,U().end):"thismonth"===e?Q(V().start,V().end):"nextmonth"===e?Q(X().start,X().end):null,ee=stir.curry((t,e)=>{e=Q(e.start,e.end).map(e=>K(t,e));return stir.any(e=>e,e)});var R=stir.curry((e,t)=>{e=e.split(", ");if(!e&&!e.length)return t;if(1===e.length&&""===e[0])return t;const s=t.tags.split(", ");e=e.map(e=>s.includes(e));return stir.all(e=>e,e)?t:void 0});const _=stir.filter(R(e)),E=A("perfId"),O=(e,t)=>{e=Z(e);const s=Number(QueryParams.get("page"))||1;var r,i,a=u*(s-1),n=a+u,l=(1===s?f:$)(z),c=stir.filter((e,t)=>{if(N(s,u,t))return e});e?(e=ee(e),e=stir.filter(e,t),e=stir.compose(stir.sort(k),stir.sort(I),y,_,E,w)(e),r=stir.compose(x,v,c)(e),i=e.length,e.length?l(g(a,n,i)+r+p(n,i)):l(m())):(e=stir.compose(stir.sort(k),stir.sort(I),y,_,E,w)(t),r=stir.compose(x,v,c)(e),i=e.length,e.length?l(g(a,n,i)+r+p(n,i)):l(m()))},q=(e,t)=>{e=Z(e);const s=Number(QueryParams.get("page"))||1;var r,i,a=u*(s-1),n=a+u,l=(1===s?f:$)(B),c=stir.filter((e,t)=>{if(N(s,u,t))return e});e?(e=ee(e),e=stir.filter(e,t),e=stir.compose(stir.sort(k),stir.sort(I),S,_,E,w)(e),r=stir.compose(x,v,c)(e),i=e.length,e.length?l(g(a,n,i)+r+p(n,i)):l(m())):(e=stir.compose(stir.sort(k),stir.sort(I),S,_,E,w)(t),r=stir.compose(x,v,c)(e),i=e.length,e.length?l(g(a,n,i)+r+p(n,i)):l(m()))},L=(e,t)=>{const s=Number(QueryParams.get("page"))||1;var r,i,a,n=u*(s-1),l=n+u,c=(1===s?f:$)(G),o=stir.filter((e,t)=>{if(N(s,u,t))return e});"all"===e&&(r=stir.compose(stir.sort(P),_,D)(t),i=stir.compose(x,h,o)(r),a=r.length,r.length?c(g(n,l,a)+i+p(l,a)):c(m())),"recordings"===e&&(r=stir.compose(stir.sort(P),J,_,D)(t),i=stir.compose(x,h,o)(r),a=r.length,r.length?c(g(n,l,a)+i+p(l,a)):c(m())),"public"===e&&(r=stir.compose(stir.sort(P),y,_,D)(t),i=stir.compose(x,h,o)(r),a=r.length,r.length?c(g(n,l,a)+i+p(l,a)):c(m())),"staffstudent"===e&&(r=stir.compose(stir.sort(P),S,_,D)(t),i=stir.compose(x,h,o)(r),a=r.length,r.length?c(g(n,l,a)+i+p(l,a)):c(m()))},M=(s.querySelector("input[type=radio]").checked=!0,r.querySelector("input[type=radio]").checked=!0,i.querySelector("input[type=radio]").checked=!0,stir.feeds.events.filter(e=>e.id));QueryParams.set("page",1),console.log(b()),console.log(M),O("all",M),q("all",M),L("all",M),stir.compose(t,x,stir.map(e=>`
