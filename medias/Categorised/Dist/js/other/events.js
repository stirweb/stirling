!function(){if(stir.node("#eventsrevamp")){var t=stir.node("#eventspublic"),e=stir.node("#eventsstaff"),s=stir.node("#eventsarchive"),i=stir.node("#eventspromo"),r=stir.node("#eventspublicfilters"),a=stir.node("#eventsstafffilters"),n=stir.node("#eventsarchivefilters");const o=(t,e)=>`<div class="c-search-result__image"><img src="${t}" width="275" height="275" alt="Image: ${e}"></div>`,c=t=>`<div class="c-search-result__tags">
        ...
        <div class=" u-bg-grey u-p-2 flex-container flex-dir-column medium-flex-dir-row u-gap u-mt-1 u-mb-2 u-flex1 "   >
            ...
            ${t.image?`<div><img src="${t.image}" width="300" height="300" alt="Image: ${t.title}" /></div>`:""}  
        </div>`),e,stir.sort(I))(P),r.addEventListener("click",t=>{"radio"===t.target.type&&(t=t.target.value,(t=M(t))?(t=L(t),t=stir.filter(t,P),(t=stir.compose(y,m,stir.sort(T),stir.sort(I),isPublicFilte,w)(t)).length?v(t):v(p())):(t=stir.compose(y,m,stir.sort(T),stir.sort(I),S,w)(P)).length?v(t):v(p()))}),a.addEventListener("click",t=>{"radio"===t.target.type&&(t=t.target.value,(t=M(t))?(t=L(t),t=stir.filter(t,P),(t=stir.compose(y,m,stir.sort(T),stir.sort(I),D,w)(t)).length?h(t):h(p())):(t=stir.compose(y,m,stir.sort(T),stir.sort(I),D,w)(P)).length?h(t):h(p()))}),n.addEventListener("click",t=>{var e;"radio"===t.target.type&&("all"===t.target.value&&((e=stir.compose(y,g,stir.sort(b),x)(P)).length?f(e):f(p())),"recordings"===t.target.value&&((e=stir.compose(y,g,stir.sort(b),_,x)(P)).length?f(e):f(p())),"public"===t.target.value&&((e=stir.compose(y,g,stir.sort(b),S,x)(P)).length?f(e):f(p())),"staffstudent"===t.target.value)&&((e=stir.compose(y,g,stir.sort(b),D,x)(P)).length?f(e):f(p()))})}}();