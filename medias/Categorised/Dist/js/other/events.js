!function(){if(stir.node("#eventsrevamp")){var t=stir.node("#eventspublic"),e=stir.node("#eventsstaff"),s=stir.node("#eventsarchive"),i=stir.node("#eventspromo"),r=stir.node("#eventspublicfilters"),a=stir.node("#eventsstafffilters"),n=stir.node("#eventsarchivefilters");const o=(t,e)=>`<div class="c-search-result__image"><img src="${t}" width="275" height="275" alt="Image: ${e}"></div>`,c=t=>`<div class="c-search-result__tags">
        ...
        </div>`),e,stir.sort(b))(P),r.addEventListener("click",t=>{"radio"===t.target.type&&(t=t.target.value,(t=M(t))?(t=L(t),t=stir.filter(t,P),(t=stir.compose(y,m,stir.sort(T),stir.sort(b),isPublicFilte,w)(t)).length?v(t):v(p())):(t=stir.compose(y,m,stir.sort(T),stir.sort(b),S,w)(P)).length?v(t):v(p()))}),a.addEventListener("click",t=>{"radio"===t.target.type&&(t=t.target.value,(t=M(t))?(t=L(t),t=stir.filter(t,P),(t=stir.compose(y,m,stir.sort(T),stir.sort(b),D,w)(t)).length?h(t):h(p())):(t=stir.compose(y,m,stir.sort(T),stir.sort(b),D,w)(P)).length?h(t):h(p()))}),n.addEventListener("click",t=>{var e;"radio"===t.target.type&&("all"===t.target.value&&((e=stir.compose(y,g,stir.sort(I),x)(P)).length?$(e):$(p())),"recordings"===t.target.value&&((e=stir.compose(y,g,stir.sort(I),_,x)(P)).length?$(e):$(p())),"public"===t.target.value&&((e=stir.compose(y,g,stir.sort(I),S,x)(P)).length?$(e):$(p())),"staffstudent"===t.target.value)&&((e=stir.compose(y,g,stir.sort(I),D,x)(P)).length?$(e):$(p()))})}}();