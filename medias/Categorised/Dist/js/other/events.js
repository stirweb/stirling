!function(){if(stir.node("#eventsrevamp")){const u=10,H=stir.node("#eventspublic"),A=stir.node("#eventsstaff"),R=stir.node("#eventsarchive");var e=stir.node("#eventspromo");const s=stir.node("#eventspublicfilters"),r=stir.node("#eventsstafffilters"),i=stir.node("#eventsarchivefilters");var M=stir.node("#eventspublictab"),Y=stir.node("#eventsstafftab"),W=stir.node("#eventsarchivetab"),j=stir.nodes(".stir-tabs__tab");const a=(e,t)=>`<div class="c-search-result__image"><img src="${e}" width="275" height="275" alt="Image: ${t}"></div>`,n=e=>`<div class="c-search-result__tags">
            ...
            <div class="c-search-result ${e.image?"c-search-result__with-thumbnail":""}" data-result-type="event"  >
                ...
                ${e.image?a(e.image,e.title):""}  
            </div>`),h=stir.curry((e,t)=>(stir.setHTML(e,t),!0)),$=stir.curry((e,t)=>(e.insertAdjacentHTML("beforeend",t),e));e=h(e);const t=()=>{var e=new Date;return Number(e.toISOString().split("T")[0].split("-").join(""))};const f=stir.filter(e=>"Yes"===e.isPublic),y=stir.filter(e=>"Yes"!==e.isPublic);const b=stir.filter(e=>e.endInt<t());const S=stir.filter(e=>e.endInt>=t());var F=stir.filter(e=>e.promo);const D=stir.join(""),w=(e,t)=>e.startInt-t.startInt,x=(e,t)=>t.startInt-e.startInt,I=(e,t)=>e.pin-t.pin,z=stir.filter(e=>e.recording),k=stir.curry((e,t,s)=>{e=t*(e-1);return e<=s&&s<e+t}),B=stir.curry((e,t)=>{return!!e.filter(e=>e===t).length}),P=(e,t)=>{var s=[];for(d=new Date(e);d<=new Date(t);d.setDate(d.getDate()+1))s.push(new Date(d).toISOString().split("T")[0]);return s},T=()=>{var e=new Date,t=new Date(e.setDate(e.getDate()+(0-e.getDay())%7)),e=new Date(e.setDate(e.getDate()+6));return{start:t.toISOString().split("T")[0],end:e.toISOString().split("T")[0]}},Q=()=>{var e=new Date,t=new Date(e.setDate(e.getDate()+(7-e.getDay())%7)),e=new Date(e.setDate(e.getDate()+6));return{start:t.toISOString().split("T")[0],end:e.toISOString().split("T")[0]}},_=()=>{var e=new Date,t=new Date(e.getFullYear(),e.getMonth(),2),e=new Date(e.getFullYear(),e.getMonth()+1,1);return{start:t.toISOString().split("T")[0],end:e.toISOString().split("T")[0]}},E=()=>{var e=new Date,t=new Date(e.getFullYear(),e.getMonth()+1,2),e=new Date(e.getFullYear(),e.getMonth()+2,1);return{start:t.toISOString().split("T")[0],end:e.toISOString().split("T")[0]}},O=e=>"thisweek"===e?P(T().start,T().end):"nextweek"===e?P(Q().start,Q().end):"thismonth"===e?P(_().start,_().end):"nextmonth"===e?P(E().start,E().end):null,G=stir.curry((t,e)=>{e=P(e.start,e.end).map(e=>B(t,e));return stir.any(e=>e,e)}),q=(e,t)=>{e=O(e);const s=Number(QueryParams.get("page"))||1;var r,i,a=u*(s-1),n=a+u,l=(1===s?h:$)(H),c=stir.filter((e,t)=>{if(k(s,u,t))return e});e?(e=G(e),e=stir.filter(e,t),e=stir.compose(stir.sort(I),stir.sort(w),f,S)(e),r=stir.compose(D,o,c)(e),i=e.length,e.length?l(g(a,n,i)+r+m(n,i)):l(p())):(e=stir.compose(stir.sort(I),stir.sort(w),f,S)(t),r=stir.compose(D,o,c)(e),i=e.length,e.length?l(g(a,n,i)+r+m(n,i)):l(p()))},N=(e,t)=>{e=O(e);const s=Number(QueryParams.get("page"))||1;var r,i,a=u*(s-1),n=a+u,l=(1===s?h:$)(A),c=stir.filter((e,t)=>{if(k(s,u,t))return e});e?(e=G(e),e=stir.filter(e,t),e=stir.compose(stir.sort(I),stir.sort(w),y,S)(e),r=stir.compose(D,o,c)(e),i=e.length,e.length?l(g(a,n,i)+r+m(n,i)):l(p())):(e=stir.compose(stir.sort(I),stir.sort(w),y,S)(t),r=stir.compose(D,o,c)(e),i=e.length,e.length?l(g(a,n,i)+r+m(n,i)):l(p()))},L=(e,t)=>{const s=Number(QueryParams.get("page"))||1;var r,i,a,n=u*(s-1),l=n+u,c=(1===s?h:$)(R),o=stir.filter((e,t)=>{if(k(s,u,t))return e});"all"===e&&(r=stir.compose(stir.sort(x),b)(t),i=stir.compose(D,v,o)(r),a=r.length,r.length?c(g(n,l,a)+i+m(l,a)):c(p())),"recordings"===e&&(r=stir.compose(stir.sort(x),z,b)(t),i=stir.compose(D,v,o)(r),a=r.length,r.length?c(g(n,l,a)+i+m(l,a)):c(p())),"public"===e&&(r=stir.compose(stir.sort(x),f,b)(t),i=stir.compose(D,v,o)(r),a=r.length,r.length?c(g(n,l,a)+i+m(l,a)):c(p())),"staffstudent"===e&&(r=stir.compose(stir.sort(x),y,b)(t),i=stir.compose(D,v,o)(r),a=r.length,r.length?c(g(n,l,a)+i+m(l,a)):c(p()))},C=(s.querySelector("input[type=radio]").checked=!0,r.querySelector("input[type=radio]").checked=!0,i.querySelector("input[type=radio]").checked=!0,stir.feeds.events.filter(e=>e.id));QueryParams.set("page",1),q("all",C),N("all",C),L("all",C),stir.compose(e,D,stir.map(e=>`
