!function(){if(stir.node("#eventsrevamp")){var t=stir.node("#eventspublic"),e=stir.node("#eventsstaff"),s=stir.node("#eventsarchive"),i=stir.node("#eventspromo"),r=stir.node("#eventspublicfilters"),a=stir.node("#eventsstafffilters"),n=stir.node("#eventsarchivefilters");const o=(t,e)=>`<div class="c-search-result__image"><img src="${t}" width="275" height="275" alt="Image: ${e}"></div>`,c=t=>`<div class="c-search-result__tags">
        ...
        </div>`),e,stir.sort(I))(q),r.addEventListener("click",t=>{"radio"===t.target.type&&(t=t.target.value,(t=F(t))?(t=L(t),t=stir.filter(t,q),(t=stir.compose(y,m,stir.sort(T),stir.sort(I),S,w)(t)).length?v(t):v(u())):(t=stir.compose(y,m,stir.sort(T),stir.sort(I),S,w)(q)).length?v(t):v(u()))}),a.addEventListener("click",t=>{"radio"===t.target.type&&(t=t.target.value,(t=F(t))?(t=L(t),t=stir.filter(t,q),(t=stir.compose(y,m,stir.sort(T),stir.sort(I),D,w)(t)).length?h(t):h(u())):(t=stir.compose(y,m,stir.sort(T),stir.sort(I),D,w)(q)).length?h(t):h(u()))}),n.addEventListener("click",t=>{var e;"radio"===t.target.type&&("all"===t.target.value&&((e=stir.compose(y,g,stir.sort(b),x)(q)).length?$(e):$(u())),"recordings"===t.target.value&&((e=stir.compose(y,g,stir.sort(b),_,x)(q)).length?$(e):$(u())),"public"===t.target.value&&((e=stir.compose(y,g,stir.sort(b),S,x)(q)).length?$(e):$(u())),"staffstudent"===t.target.value)&&((e=stir.compose(y,g,stir.sort(b),D,x)(q)).length?$(e):$(u()))})}}();