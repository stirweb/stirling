!function(){if(stir.node("#eventsrevamp")){var t=stir.node("#eventspublic"),e=stir.node("#eventsstaff"),s=stir.node("#eventsarchive"),i=stir.node("#eventspromo"),r=stir.node("#eventspublicfilters"),a=stir.node("#eventsstafffilters"),n=stir.node("#eventsarchivefilters");const o=(t,e)=>`<div class="c-search-result__image"><img src="${t}" width="275" height="275" alt="Image: ${e}"></div>`,c=t=>`<div class="c-search-result__tags">
            ...
            </div>`,u=t=>`<p>Part of the ${t} series.</p>`,p=()=>'<div class="u-bg-white u-p-3"><p>No events found</p></div>';const m=stir.map(t=>`
            <div class="c-search-result  ${t.image?"c-search-result__with-thumbnail":""}" data-result-type="event" ${t.pin<0?'data-label-icon="pin"':""} >
                ...
                <div class="c-search-result__body flex-container flex-dir-column u-gap u-mt-1 ">
                    ...
                    ${t.isSeriesChild?u(t.isSeriesChild):""}
                </div>
        ...
        </div>`),e,stir.sort(b))(j),r.addEventListener("click",t=>{"radio"===t.target.type&&(t=t.target.value,(t=F(t))?(t=L(t),t=stir.filter(t,j),(t=stir.compose(y,m,stir.sort(T),stir.sort(b),S,w)(t)).length?v(t):v(p())):(t=stir.compose(y,m,stir.sort(T),stir.sort(b),S,w)(j)).length?v(t):v(p()))}),a.addEventListener("click",t=>{"radio"===t.target.type&&(t=t.target.value,(t=F(t))?(t=L(t),t=stir.filter(t,j),(t=stir.compose(y,m,stir.sort(T),stir.sort(b),D,w)(t)).length?h(t):h(p())):(t=stir.compose(y,m,stir.sort(T),stir.sort(b),D,w)(j)).length?h(t):h(p()))}),n.addEventListener("click",t=>{var e;"radio"===t.target.type&&("all"===t.target.value&&((e=stir.compose(y,g,stir.sort(I),x)(j)).length?$(e):$(p())),"recordings"===t.target.value&&((e=stir.compose(y,g,stir.sort(I),_,x)(j)).length?$(e):$(p())),"public"===t.target.value&&((e=stir.compose(y,g,stir.sort(I),S,x)(j)).length?$(e):$(p())),"staffstudent"===t.target.value)&&((e=stir.compose(y,g,stir.sort(I),D,x)(j)).length?$(e):$(p()))})}}();