!function(){if(!stir.node("#eventsrevamp"))return;const p=10,s="Art Collection",r="Webinar",o="Public",C="Staff",M="Student";var e=stir.node("[data-tags]")||"",e=e?e.dataset.tags:"";const g={eventsPublic:stir.node("#eventspublic"),eventsStaff:stir.node("#eventsstaff"),eventsArt:stir.node("#eventsart"),eventsWebinars:stir.node("#eventswebinars"),eventsArchive:stir.node("#eventsarchive"),eventsPromo:stir.node("#eventspromo"),eventsPublicFilters:stir.node("#eventspublicfilters"),eventsStaffFilters:stir.node("#eventsstafffilters"),eventsArtFilters:stir.node("#eventsartfilters"),eventsWebinarsFilters:stir.node("#eventswebinarsfilters"),eventsArchiveFilters:stir.node("#eventsarchivefilters"),eventsPublicTab:stir.node("#eventspublictab"),eventsStaffTab:stir.node("#eventsstafftab"),eventsArtTab:stir.node("#eventsarttab"),eventsWebinarsTab:stir.node("#eventswebinarstab"),eventsArchiveTab:stir.node("#eventsarchivetab"),stirTabs:stir.nodes(".stir-tabs__tab")},a=(e,t)=>`<div class="u-mt-1"><img src="${e}" width="275" height="275" alt="Image: ${t}"></div>`,n=e=>`<div class="u-absolute u-top--16">
          ...
          <span><time>${e.startTime}</time> – <time>${e.endTime}</time></span>
        </div>`,c=(t,e)=>{e=e.filter(e=>e.isSeries===t);return`<p class="text-sm">Part of the ${e.length?`<a href="${e[0].url}">${e[0].title}</a>`:t} series.</p>`},f=(e,t,s)=>t.length?stir.favourites.renderRemoveBtn(s,t[0].date,e):stir.favourites.renderAddBtn(s,e),L=stir.curry((e,t)=>{var s,i=stir.favourites&&stir.favourites.getFav(t.sid,"event");return`<div class="u-border-width-5 u-heritage-line-left u-p-2 u-bg-white text-sm u-relative u-mb-2" data-result-type="event" ${s=t,s.pin<1?'data-label-icon="pin"':s.type===r?'data-label-icon="computer"':s.isSeries?'data-label-icon="startdates"':""} data-perf="${t.perfId}" >
                ...
                <div class="u-grid-medium-up u-gap-24 ${t.image?"u-grid-cols-3_1":""} ">
                  <div class=" u-flex flex-dir-column u-gap u-mt-1" >
                      ...
                      ${t.isSeriesChild?c(t.isSeriesChild,e):""}
                  </div>
        ...
        </div>`}),b=(e,t)=>t<=e?"":'<div class="loadmorebtn u-flex align-center u-mb-2" ><button class="button hollow tiny">Load more results</button></div>',h=(e,t,s)=>e<2?"":`<div class="u-flex align-center u-mb-2">Showing ${e+1}-${s<t?s:t} of ${s} results</div>`;const $=stir.curry((e,t)=>(stir.setHTML(e,t),!0)),S=stir.curry((e,t)=>(e.insertAdjacentHTML("beforeend",t),e));var H=stir.curry((t,s)=>{var i={},r=[];for(let e=0;e<s.length;e++)i[s[e][t]]||(i[s[e][t]]=!0,r.push(s[e]));return r});const i=e=>"string"!=typeof e?"":e.replace(/[^a-zA-Z0-9-_]/g,""),y={get:e=>i(QueryParams.get(e)),set:(e,t)=>QueryParams.set(e,i(t)),remove:QueryParams.remove};const x=stir.filter(e=>e.audience.includes(o)&&!e.tags.includes(s)&&!e.type.includes(r)),w=stir.filter(e=>{return((t=e).audience.includes(C)||t.audience.includes(M))&&!e.audience.includes(o)&&!e.tags.includes(s);var t});const F=stir.filter(e=>e.tags&&e.tags.includes(s));const D=stir.filter(e=>e.type&&e.type.includes(r));const Q=stir.filter(e=>Number(e.endInt)<k()&&e.archive.length&&!e.hideFromFeed.length);const T=stir.filter(e=>Number(e.endInt)>=k()&&!e.hideFromFeed.length);const B=stir.filter(e=>e.eventPromo),I=stir.join(""),R=stir.filter((e,t)=>0===t),z=stir.filter(e=>e.recording),J=e=>e,A=stir.filter(e=>e.isSeries.length),P=stir.curry((e,t,s)=>{e=t*(e-1);return e<=s&&s<e+t});var t=stir.curry((e,t)=>{e=e.split(", ");if(!e&&!e.length)return t;if(1===e.length&&""===e[0])return t;const s=t.tags.split(", ");e=e.map(e=>s.includes(e));return stir.all(e=>e,e)?t:void 0});const N=stir.filter(t(e)),U=H("perfId"),Z=(e,t)=>Number(e.startInt)-Number(t.startInt),G=(e,t)=>Number(t.startInt)-Number(e.startInt),K=(e,t)=>e.pin!==t.pin?e.pin-t.pin:Number(e.startInt)-Number(t.startInt),k=()=>{var e=new Date;return Number(e.toISOString().split("T")[0].split("-").join("")+("0"+e.getHours()).slice(-2)+("0"+e.getMinutes()).slice(-2))},V=stir.curry((e,t)=>{return!!e.filter(e=>e===t).length}),W=(e,t)=>{var s=[];for(d=new Date(e);d<=new Date(t);d.setDate(d.getDate()+1))s.push(new Date(d).toISOString().split("T")[0]);return s},O=()=>{var e=new Date,t=new Date(e.setDate(e.getDate()+(0-e.getDay())%7)),e=new Date(e.setDate(e.getDate()+6));return{start:t.toISOString().split("T")[0],end:e.toISOString().split("T")[0]}},E=()=>{var e=new Date,t=new Date(e.setDate(e.getDate()+(7-e.getDay())%7)),e=new Date(e.setDate(e.getDate()+6));return{start:t.toISOString().split("T")[0],end:e.toISOString().split("T")[0]}},j=()=>{var e=new Date,t=new Date(e.getFullYear(),e.getMonth(),2),e=new Date(e.getFullYear(),e.getMonth()+1,1);return{start:t.toISOString().split("T")[0],end:e.toISOString().split("T")[0]}},X=()=>{var e=new Date,t=new Date(e.getFullYear(),e.getMonth()+1,2),e=new Date(e.getFullYear(),e.getMonth()+2,1);return{start:t.toISOString().split("T")[0],end:e.toISOString().split("T")[0]}},ee=stir.curry((t,e)=>{e=W(e.start,e.end).map(e=>V(t,e));return stir.any(e=>e,e)});function q(e,t,s,i){e="thisweek"===(e=e)?W(O().start,O().end):"nextweek"===e?W(E().start,E().end):"thismonth"===e?W(j().start,j().end):"nextmonth"===e?W(X().start,X().end):null;const r=Number(y.get("page"))||1;var a=p*(r-1),n=a+p,l=stir.compose(A)(i);const u=stir.map(L(l));l=(1===r?$:S)(t);const d=stir.sort(K),v=stir.filter((e,t)=>{if(P(r,p,t))return e});t=e=>{var e=stir.pipe(T,U,N,s,d)(e),t=stir.pipe(v,u,I)(e);return[e.length,t]};let c,o;e||([c,o]=t(i)),e&&(e=ee(e),e=stir.filter(e,i),[c,o]=t(e)),c?l(h(a,n,c)+o+b(n,c)):l(m("No events found. Try the staff and student events tab."))}function te(e,t){const s=Number(y.get("page"))||1;var i=p*(s-1),r=i+p,a=stir.compose(A)(t);const n=stir.map(_(a)),l=stir.sort(G);a=(1===s?$:S)(g.eventsArchive);const u=stir.filter((e,t)=>{if(P(s,p,t))return e});var d=(e,t)=>{e=stir.pipe(Q,N,e,l)(t),t=stir.pipe(u,n,I)(e);return[e.length,t]};let v,c;"all"===e&&([v,c]=d(J,t)),"recordings"===e&&([v,c]=d(z,t)),e===o&&([v,c]=d(x,t)),"staffstudent"===e&&([v,c]=d(w,t)),v?a(h(i,r,v)+c+b(r,v)):a(m("No events found."))}$(g.eventsPublic,""),$(g.eventsStaff,""),$(g.eventsArt,""),$(g.eventsWebinars,""),g.eventsPublicFilters.querySelector("input[type=radio]").checked=!0,g.eventsStaffFilters.querySelector("input[type=radio]").checked=!0,g.eventsArchiveFilters.querySelector("input[type=radio]").checked=!0,g.eventsArtFilters.querySelector("input[type=radio]").checked=!0,g.eventsWebinarsFilters.querySelector("input[type=radio]").checked=!0;e="dev"===(t=UoS_env.name)?"../index.json":"preview"===t||"appdev-preview"===t?'<t4 type="navigation" id="5214" />':"/data/events/revamp/json/index.json";stir.getJSON(e,e=>{if(!e.error){var t,s,i,r,e=e.filter(e=>e.id);y.set("page","1"),q("all",g.eventsStaff,w,e),q("all",g.eventsPublic,x,e),q("all",g.eventsArt,F,e),q("all",g.eventsWebinars,D,e),te("all",e),t=e,s=stir.filter(A,t),s=stir.map(Y(s)),i=stir.sort(Z),r=$(g.eventsPromo),stir.pipe(T,N,i,B,R,s,I,r)(t),stir.each(e=>{e.addEventListener("click",e=>{y.set("page","1")})},g.stirTabs),a(g.eventsPublicTab,g.eventsPublicFilters,g.eventsPublic,x,q,e),a(g.eventsArtTab,g.eventsArtFilters,g.eventsArt,F,q,e),a(g.eventsWebinarsTab,g.eventsWebinarsFilters,g.eventsWebinars,D,q,e),a(g.eventsStaffTab,g.eventsStaffFilters,g.eventsStaff,w,q,e),a(g.eventsArchiveTab,g.eventsArchiveFilters,null,null,(e,t,s,i)=>te(e,i),e);const n=e=>{var t=stir.favourites.getFav(e,"event"),s=stir.node("#favbtns"+e);s&&$(s)(f("true",t,e))};function a(e,s,i,r,a,n){e.addEventListener("click",e=>{var t=Number(y.get("page"))||1;"radio"===e.target.type&&(y.set("page","1"),a(s.querySelector("input:checked").value,i,r,n)),"submit"===e.target.type&&($(e.target.closest(".loadmorebtn"),""),y.set("page",String(t+1)),a(s.querySelector("input:checked").value,i,r,n))})}stir.node("main").addEventListener("click",e=>{e=e.target.closest("button");e&&e.dataset&&e.dataset.action&&("addtofavs"===e.dataset.action&&(stir.favourites.addToFavs(e.dataset.id,"event"),n(e.dataset.id)),"removefav"===e.dataset.action)&&(stir.favourites.removeFromFavs(e.dataset.id),n(e.dataset.id))})}})}();