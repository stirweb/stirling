!function(){if(stir.node("#eventsrevamp")){const c=stir.node("#eventspublic"),A=stir.node("#eventsstaff"),R=stir.node("#eventsarchive");var e=stir.node("#eventspromo");const s=stir.node("#eventspublicfilters"),r=stir.node("#eventsstafffilters"),i=stir.node("#eventsarchivefilters");var M=stir.node("#eventspublictab"),Y=stir.node("#eventsstafftab"),j=stir.node("#eventsarchivetab"),F=stir.nodes(".stir-tabs__tab");const t=(e,t)=>`<div class="c-search-result__image"><img src="${e}" width="275" height="275" alt="Image: ${t}"></div>`,a=e=>`<div class="c-search-result__tags">
                <span class="c-search-tag">${e}</span>
            </div>`,n=e=>`<p>Part of the ${e} series.</p>`,u=()=>'<div class="u-bg-white u-p-2 u-mb-2"><p class="u-m-0">No more events found</p></div>';const m=(e,t)=>t<e?"":'<div class="loadmorebtn flex-container align-center u-mb-2" ><button class="button hollow tiny">Load more results</button></div>',p=(e,t,s)=>e<2?"":`<div class="flex-container align-center u-mb-2">Showing ${e}-${s<t?s:t} of ${s} results</div>`,g=stir.map(e=>`
            <div class="c-search-result  ${e.image?"c-search-result__with-thumbnail":""}" data-result-type="event" ${e.pin<0?'data-label-icon="pin"':""} >
                ${e.isSeries?a("Event series"):""} 
            ...
            <div class="c-search-result ${e.image?"c-search-result__with-thumbnail":""}" data-result-type="event"  >
                ...
                ${e.image?t(e.image,e.title):""}  
            </div>`),h=stir.curry((e,t)=>(stir.setHTML(e,t),!0)),f=stir.curry((e,t)=>(e.insertAdjacentHTML("beforeend",t),e));e=h(e);const l=()=>{var e=new Date;return Number(e.toISOString().split("T")[0].split("-").join(""))};const $=stir.filter(e=>"Yes"===e.isPublic),y=stir.filter(e=>"Yes"!==e.isPublic);const b=stir.filter(e=>e.endInt<l());const S=stir.filter(e=>e.endInt>=l());var H=stir.filter(e=>e.promo);const D=stir.join(""),x=(e,t)=>e.startInt-t.startInt,w=(e,t)=>t.startInt-e.startInt,I=(e,t)=>e.pin-t.pin,z=stir.filter(e=>e.recording),k=stir.curry((e,t,s)=>{e=t*(e-1);return e<=s&&s<e+t}),B=stir.curry((e,t)=>{return!!e.filter(e=>e===t).length}),o=(e,t)=>{var s=[];for(d=new Date(e);d<=new Date(t);d.setDate(d.getDate()+1))s.push(new Date(d).toISOString().split("T")[0]);return s},P=()=>{var e=new Date,t=new Date(e.setDate(e.getDate()+(0-e.getDay())%7)),e=new Date(e.setDate(e.getDate()+6));return{start:t.toISOString().split("T")[0],end:e.toISOString().split("T")[0]}},T=()=>{var e=new Date,t=new Date(e.setDate(e.getDate()+(7-e.getDay())%7)),e=new Date(e.setDate(e.getDate()+6));return{start:t.toISOString().split("T")[0],end:e.toISOString().split("T")[0]}},Q=()=>{var e=new Date,t=new Date(e.getFullYear(),e.getMonth(),2),e=new Date(e.getFullYear(),e.getMonth()+1,1);return{start:t.toISOString().split("T")[0],end:e.toISOString().split("T")[0]}},_=()=>{var e=new Date,t=new Date(e.getFullYear(),e.getMonth()+1,2),e=new Date(e.getFullYear(),e.getMonth()+2,1);return{start:t.toISOString().split("T")[0],end:e.toISOString().split("T")[0]}},E=e=>"thisweek"===e?o(P().start,P().end):"nextweek"===e?o(T().start,T().end):"thismonth"===e?o(Q().start,Q().end):"nextmonth"===e?o(_().start,_().end):null,O=stir.curry((t,e)=>{e=o(e.start,e.end).map(e=>B(t,e));return stir.any(e=>e,e)}),q=(e,t)=>{e=E(e);const s=Number(QueryParams.get("page"))||1;var r,i,a=4*(s-1),n=4+a,l=(1===s?h:f)(c),o=stir.filter((e,t)=>{if(k(s,4,t))return e});e?(e=O(e),e=stir.filter(e,t),e=stir.compose(stir.sort(I),stir.sort(x),$,S)(e),r=stir.compose(D,g,o)(e),i=e.length,e.length?l(p(a,n,i)+r+m(n,i)):l(u())):(e=stir.compose(stir.sort(I),stir.sort(x),$,S)(t),r=stir.compose(D,g,o)(e),i=e.length,e.length?l(p(a,n,i)+r+m(n,i)):l(u()))},N=(e,t)=>{e=E(e);const s=Number(QueryParams.get("page"))||1;var r,i,a=4*(s-1),n=4+a,l=(1===s?h:f)(A),o=stir.filter((e,t)=>{if(k(s,4,t))return e});e?(e=O(e),e=stir.filter(e,t),e=stir.compose(stir.sort(I),stir.sort(x),y,S)(e),r=stir.compose(D,g,o)(e),i=e.length,e.length?l(p(a,n,i)+r+m(n,i)):l(u())):(e=stir.compose(stir.sort(I),stir.sort(x),y,S)(t),r=stir.compose(D,g,o)(e),i=e.length,e.length?l(p(a,n,i)+r+m(n,i)):l(u()))},L=(e,t)=>{const s=Number(QueryParams.get("page"))||1;var r,i,a,n=4*(s-1),l=4+n,o=(1===s?h:f)(R),c=stir.filter((e,t)=>{if(k(s,4,t))return e});"all"===e&&(r=stir.compose(stir.sort(w),b)(t),i=stir.compose(D,v,c)(r),a=r.length,r.length?o(p(n,l,a)+i+m(l,a)):o(u())),"recordings"===e&&(r=stir.compose(stir.sort(w),z,b)(t),i=stir.compose(D,v,c)(r),a=r.length,r.length?o(p(n,l,a)+i+m(l,a)):o(u())),"public"===e&&(r=stir.compose(stir.sort(w),$,b)(t),i=stir.compose(D,v,c)(r),a=r.length,r.length?o(p(n,l,a)+i+m(l,a)):o(u())),"staffstudent"===e&&(r=stir.compose(stir.sort(w),y,b)(t),i=stir.compose(D,v,c)(r),a=r.length,r.length?o(p(n,l,a)+i+m(l,a)):o(u()))},C=(s.querySelector("input[type=radio]").checked=!0,r.querySelector("input[type=radio]").checked=!0,i.querySelector("input[type=radio]").checked=!0,stir.feeds.events.filter(e=>e.id));QueryParams.set("page",1),q("all",C),N("all",C),L("all",C),stir.compose(e,D,stir.map(e=>`
