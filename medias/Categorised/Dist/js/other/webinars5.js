!function(){if(!stir.nodes("[data-webinar]"))return;var e=stir.nodes("[data-webinarSects]");const i=stir.t4Globals.webinars||[],t=stir.t4Globals.webinarSectionData||{};var r=stir.t4Globals.webinarsdisclaimer||"",s=stir.node("[data-webinardisclaimer]");const a={safeList:["countries","series","subjects","studylevels","faculties","categories"],macros:stir.filter(e=>{if(e.tag)return e},stir.t4Globals.regionmacros)||[]},n=(Object.freeze(a),stir.curry((r,s,a)=>{var e=stir.filter(e=>r.safeList.includes(e),Object.keys(s)),e=stir.map(e=>{var t,i;return a[e]?(t=a[e].split(", "),i=l(r,s[e],e),i=stir.map(i,t),stir.any(e=>!0===e,i)):""===s[e]},e);return stir.all(e=>!0===e,e)})),l=stir.curry((e,t,i,r)=>{if(t.includes(r.trim()))return!0;if(r.trim().includes(t.trim()))return!0;if(i&&"faculties"===i&&c(t,r,"All Faculties"))return!0;if(i&&"countries"===i){if(t.includes("All nationalities"))return!0;if(t.includes("All international")&&!d(e.macros,"United Kingdom").includes(r.trim()))return!0;if(r.trim().includes("All international")&&!d(e.macros,"United Kingdom").includes(t))return!0}return!1}),c=(e,t,i)=>!!e.includes(i)||!!t.trim().includes(i),d=(e,t)=>e.filter(e=>e.tag===t).map(e=>e.data).join(", "),u=e=>(console.log(e),`
          ...
          </div> `),o=stir.curry((e,t)=>{var i,r;if(t.length||e.noItems)return`
          ...
          <div class="cell u-mt-2">
            ...
            </div>`}),m=stir.curry((e,t)=>(stir.setHTML(e,t),e)),f=(e,t,i,r)=>{var s=stir.filter(e=>e.title),e=stir.filter(n(e,r.params)),a=stir.sort((e,t)=>parseInt(e.datetime)>parseInt(t.datetime)?1:parseInt(t.datetime)>parseInt(e.datetime)?-1:0),t=m(t),r=o(r);return stir.compose(t,r,a,e,s)(i)},v=stir.node("#webinarresults");v&&(f(a,v,i,{params:{series:"",countries:"",subjects:"",studylevels:"",faculties:"",categories:""}}),stir.nodes("#webinarfilters select").forEach(e=>{e.addEventListener("change",e=>{var t=stir.node("#search-student-type").value,t={params:{series:"",countries:stir.node("#search-region").value,subjects:"",studylevels:t,faculties:"",categories:stir.node("#search-category").value}};f(a,v,i,t)})})),e.forEach(e=>{f(a,e,i,t[e.dataset.webinarsects])}),s&&e.map(e=>e.innerText).join("").trim().length<1&&m(s,r)}();