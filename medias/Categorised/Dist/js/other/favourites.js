var stir=stir||{};stir.favourites=(()=>{const a="favs=",t="dev"===UoS_env.name?"/favourites/":'<t4 type="navigation" id="50" />',i=e=>e?`<a href="${t}"  class="u-heritage-green u-mb-1 u-cursor-pointer flex-container u-gap-8 align-middle u-border-none">
