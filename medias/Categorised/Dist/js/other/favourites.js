var stir=stir||{};stir.favourites=(()=>{var e,t,a;return{renderAddBtn:` 
          <button
              class="u-heritage-green u-cursor-pointer u-line-height-default flex-container u-gap-8 align-middle"
              data-action="addtofavs" aria-label="Add to your favourites" data-id="${a}" id="addfavbtn-${a}">
        ...
        C47.5,15,46.3,12.2,44.1,10.1z"/>
          ...
          <span>Favourited ${getDaysAgo(new Date(t))}</span>`}})();