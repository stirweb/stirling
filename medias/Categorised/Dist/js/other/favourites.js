var stir=stir||{};stir.favourites=(()=>{const r="favs=",a=e=>e?`<a href="${e}"  class="u-heritage-green u-mt-1 u-cursor-pointer flex-container u-gap-8 align-middle u-border-none">
        ...
        C47.5,15,46.3,12.2,44.1,10.1z"/>
                ...
                <span class="u-heritage-green u-underline u-block u-pb-tiny">Favourited ${(e=>{const t=new Date,r=24*60*60*1e3,a=(e.setHours(0,0,0,0),t.setHours(0,0,0,0),Math.floor((+t-+e)/r)),i=a>1?`days`:`day`;return a===0?`today`:`${a} ${i} ago`})(new Date(t))}</span>
            </button>${a(r)}
