var stir=stir||{};stir.coursefavs=(()=>{if(!stir.favourites)return console.error("[Course Favourites] stir.favourites library not loaded");var a={favsArea:stir.node("#coursefavsarea"),favBtns:stir.node("#coursefavbtns"),sharedArea:stir.node("#coursesharedarea"),sharedfavArea:stir.node("#coursesharedfavsarea")};const e="course";const t="https://search.stir.ac.uk/s/search.json?collection=stir-courses&query=!nullpadre&fmo=true&num_ranks=2000&SF=["+["c","award","code","delivery","faculty","image","level","modes","pathways","sid","start","subject","ucas"].join(",")+"]&",r=a=>a.metaData?`<p class="text-sm">
            <strong><a href="${a.liveUrl}" title="${a.metaData.award||""} ${a.title}">${a.metaData.award||""} ${a.title} ${a.metaData.ucas?" - "+a.metaData.ucas:""}</a></strong>
        </p>`:"",s=(a,t,e)=>t?`<div class="cell medium-4"><strong class="u-heritage-green">${a}</strong><p class="${e}">${t.split("|").join(", ")}</p></div>`:"",i=stir.curry(a=>a.metaData?`<div class="u-border-width-5 u-heritage-line-left c-search-result" data-rank="" data-sid="${a.metaData.sid}" data-result-type="course">
            ...
            <div class="flex-container flex-dir-column u-gap u-mt-1">
              ...
              <div class="c-search-result__meta grid-x u-mt-1">
                ${s("Start dates",a.metaData.start,"")}
                ${s("Study modes",a.metaData.modes,"u-sentence-case")}
                ${s("Delivery",a.metaData.delivery,"u-sentence-case")}
             </div>
            </div>
