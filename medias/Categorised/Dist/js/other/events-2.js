!function(){const d=document.querySelector("#eventsstaff"),c=document.querySelector("#eventspublic"),u=document.querySelector("#eventsart"),m=document.querySelector("#eventsarchive"),p=document.querySelector("#eventspromo"),g=document.querySelector("#eventswebinars"),o=e=>"string"==typeof e?JSON.parse(decodeURIComponent(e)):"object"==typeof e?Object.assign({},...e.map(e=>JSON.parse(decodeURIComponent(e)))):{},v=e=>e.end===e.start?`<time datetime="${e.startISO}">${e.start}</time>`:`<time datetime="${e.startISO}">${e.start}</time> - <time datetime="${e.endISO}">${e.end}</time>`,f=(t,e)=>{return t?(e=e&&e.find(e=>e.title===t))?`<p class="text-sm">Part of the <a href="${e?e.url:"#"}">${t}</a> series.</p>`:`<p class="text-sm">Part of the <strong>${t}</strong> series.</p>`:""},h=(e,t,a)=>t.length?stir.favourites.renderRemoveBtn(a,t[0].date,e):stir.favourites.renderAddBtn(a,e),b=stir.curry((e,t)=>{var a="object"==typeof t.custom_fields.data?Object.assign({},...t.custom_fields.data.map(e=>JSON.parse(decodeURIComponent(e)))):{},i=t.custom_fields,s=T(i.d,i.e);return`
      ...
      <div class="u-flex u-gap-16 align-middle">
      ...
      </div>`,y=e=>e?`<span class="u-bg-heritage-berry u-white text-xxsm u-p-tiny u-mr-1">${e}</span>`:"",$=e=>e?"data-label-icon="+e:"",n=stir.curry((e,t)=>{var a,i,s,r,n,o,l,d,c,u;return t.hide?"":(a="object"==typeof t.custom_fields.data?Object.assign({},...t.custom_fields.data.map(e=>JSON.parse(decodeURIComponent(e)))):{},i=t.custom_fields,r=(s=T(t.start,t.end)).start===s.end,n=stir.favourites&&stir.favourites.getFav(i.sid,"event"),o=t.repeater?i.sid+"|"+new Date(t.start).getTime():i.sid,c=a.isSeries?"startdates":"",u="Yes"===a.pin?"pin":"",l=new Date(i.d).toLocaleTimeString("en-GB",{hour:"2-digit",minute:"2-digit"}),d=new Date(i.e).toLocaleTimeString("en-GB",{hour:"2-digit",minute:"2-digit",timeZoneName:"short"}),`
        <div class="u-border-width-5 u-heritage-line-left u-p-2 u-bg-white text-sm u-relative u-mb-2" data-result-type="event"
        ...
        </div>`)}),w=stir.curry((e,t)=>{var a=t.custom_fields,i=T(a.d,a.e),s="object"==typeof t.custom_fields.data?Object.assign({},...t.custom_fields.data.map(e=>JSON.parse(decodeURIComponent(e)))):{},r=stir.favourites&&stir.favourites.getFav(a.sid,"event"),n=t.repeater?a.sid+"|"+new Date(t.start).getTime():a.sid,o=i.start===i.end,l=new Date(a.d).toLocaleTimeString("en-GB",{hour:"2-digit",minute:"2-digit"}),d=new Date(a.e).toLocaleTimeString("en-GB",{hour:"2-digit",minute:"2-digit",timeZoneName:"short"});return`<div class="grid-x u-bg-grey u-mb-2 ">
        ...
        </div>`}),s=e=>{var e=e.custom_fields,t=o(e.data),a=stir.favourites&&stir.favourites.getFav(e.sid,"webinar"),i=e.sid,s=T(e.d,e.e),r=new Date(e.d).toLocaleTimeString("en-GB",{hour:"2-digit",minute:"2-digit"}),n=new Date(e.e).toLocaleTimeString("en-GB",{hour:"2-digit",minute:"2-digit",timeZoneName:"short"});return`<div class="u-border-width-5 u-heritage-line-left u-p-2 u-bg-white text-sm u-relative u-mb-2" 
