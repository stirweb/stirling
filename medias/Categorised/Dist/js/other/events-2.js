      ...
      <div class="u-flex u-gap-16 align-middle">
        ...
        <div class="u-absolute u-top--16">
            ...
            <div class="u-grid-medium-up u-gap-24 ${i.image?"u-grid-cols-3_1":""}">
                <div class=" u-flex flex-dir-column u-gap u-mt-1">
                    <p class="u-text-regular u-m-0">
                        ${$(a.cancelled)} ${$(a.rescheduled)} <strong><a href="${t.url}">${i.h1_custom}</a></strong>
                    </p>
                    <div class="u-flex flex-dir-column u-gap-8">
                    <div class="u-flex u-gap-16 align-middle">
                        <span class="u-icon h5 uos-calendar"></span>
            ...
            <div class="cell small-12 ${a.image?"medium-8":""} ">
                ...
                <div class="u-flex1">
                  ...
                  ${$(s.cancelled)} ${$(s.rescheduled)} <strong><a href="${t.url}">${a.h1_custom}</a></strong>
                  </p>
        ...
        </div>`}),x=e=>{var e=e.custom_fields,t=o(e.data),a=stir.favourites&&stir.favourites.getFav(e.sid,"webinar"),i=e.sid,s=D(e.d,e.e),r=new Date(e.d).toLocaleTimeString("en-GB",{hour:"2-digit",minute:"2-digit"}),n=new Date(e.e).toLocaleTimeString("en-GB",{hour:"2-digit",minute:"2-digit",timeZoneName:"short"});return`<div class="u-border-width-5 u-heritage-line-left u-p-2 u-bg-white text-sm u-relative u-mb-2" 
              data-result-type="event" data-label-icon="computer" data-perf="${e.sid}">
                <div class="u-absolute u-top--16">
