!function(){var i;if((i=document.querySelector("[data-videoId]"))&&i.addEventListener("ended",function(e){var a,t;i.parentNode&&!(fallback=i.getAttribute("data-fallback-html"))&&(fallback=i.getAttribute("data-fallback-image"))&&(a=new Image,t=i,a.addEventListener("load",function(e){t.insertAdjacentElement("beforebegin",a),t.parentNode.removeChild(t)}),a.src=fallback)}),AOS){function e(e,a){this.setAttribute&&(this.setAttribute("data-aos",e),this.setAttribute("data-aos-duration",a))}for(var a=1e3,t="fade-right",r="fade-left",n="fade-up",s=[{element:".c-promo-area--homepage .c-promo-area__content",action:t,duration:a},{element:".c-promo-area--homepage .c-promo-area__image",action:r,duration:a},{element:".c-research-promo__wrapper",action:n,duration:2e3},{element:".c-international-section .c-bleed-feature__text-container",action:r,duration:a},{element:".c-international-section .c-bleed-feature__image",action:t,duration:a},{element:".c-homepage-news-events",action:n,duration:2e3}],l=0;l<s.length;l++){var o=document.querySelector(s[l].element),d=s[l].action||r,c=s[l].duration||a;o&&e.call(o,d,c)}AOS.init({once:!0,disable:"phone"})}}();var stir=stir||{};!function(l){if(!l)return;const o=stir.filter(e=>{if(e.id&&0!==e.id)return e}),i=(e,a,t)=>{if(t.id!==e&&t.id!==a)return t},d=(e,a,t)=>{if(t<e)return a},c=(e,a,t)=>stir.filter(e=>i(a,t,e),e),u=stir.curry(e=>`
      ...
      <${a} class="small-12 cell ${e}">
        <a href="${t.url}"><img class="show-for-medium" src="${t.image}" alt="${t.imagealt}" loading="lazy"></a>
