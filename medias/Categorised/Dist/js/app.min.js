                    ...
                    <div class="u-my-1 cell  ">
                        <div class="grid-x flex-dir-column medium-flex-dir-row u-p-2 u-m-0 c-wrapper-2025 purples ">
                            <p class="cell small-12 large-8 u-m-0 ">
                                ...
                                <span class="text-lg u-text-coloured "><b>Applications for January close in ${t} days</b></span><br>
                                <span class="text-md u-mt-tiny"><b>${n.message}</b> in scholarships available if you are from ${n.region}</span><br>
