		...
		<div class="c-search-result u-border-width-5 u-heritage-line-left" data-result-type=scholarship data-rank=${e.score}>
			...
			<div class="c-search-result__body u-mt-1 flex-container flex-dir-column u-gap">
				...
				<div class="c-search-result u-border-width-5 u-heritage-line-left" data-result-type=studentstory>
					...
					${e.custom_fields.image?u("https://www.stir.ac.uk"+e.custom_fields.image,e.title.split(" | ")[0].trim(),400,400):""}
				...
				</div>`;var t},event:e=>{var t,s="object"==typeof e.custom_fields.data?Object.assign({},...e.custom_fields.data.map(e=>JSON.parse(decodeURIComponent(e)))):JSON.parse(decodeURIComponent(e.custom_fields.data)),r=s.tags&&-1<s.tags.indexOf("Webinar")||"webinar"===e.custom_fields.type,a=r||e.custom_fields.online,i=e.custom_fields?.image||r,l=e.custom_fields.e?new Date(e.custom_fields.e)<new Date:void 0,c=e.custom_fields.name||e.title.split("|")[0].trim(),o=e.url;return`
			<div class="u-border-width-5 u-heritage-line-left c-search-result${i?" c-search-result__with-thumbnail":""}" data-rank=${e.score} data-result-type=event>
				<div class=c-search-result__tags>
					${s.isSeriesChild?stir.templates.search.stag(s.isSeriesChild):""}
				</div>
				<div class="c-search-result__body flex-container flex-dir-column u-gap u-mt-1">
					<p class="u-text-regular u-m-0">
						<strong>${d({text:c,href:o})}</strong>
					</p>
					<div class="flex-container flex-dir-column u-gap-8">
						<div class="flex-container u-gap-16 align-middle">
							<span class="u-icon h5 uos-calendar"></span>
							<span>${i=e.custom_fields.d,c=e.custom_fields.e,i?(i=new Date(i),o=stir.Date.newsDate(i),i=stir.Date.timeElementDatetime(i),!c||(t=(c=c&&new Date(c))&&stir.Date.newsDate(c),c=c&&stir.Date.timeElementDatetime(c),o==t)?`<time datetime="${i}">${o}</time>`:`<time datetime="${i}">${o}</time>–<time datetime="${c}">${t}</time>`):'<abbr title="To be confirmed">TBC</abbr>'}</span>
						</div>
						<div class="flex-container u-gap-16 align-middle">
							<span class="uos-clock u-icon h5"></span>
							<span>
							${l?"This event has ended.":(i=e.custom_fields.d,o=e.custom_fields.e,(i?`<time>${stir.Date.time24(new Date(i))}</time>`:"")+(o?`–<time>${stir.Date.time24(new Date(o))}</time>`:""))}
							</span>
						</div>
						<div class="flex-container u-gap-16 align-middle">
							<span class="u-icon h5 uos-${a?"web":"location"}"></span>
							<span>${a?"Online":s.location||""}</span>
						</div>
					</div>
					<p class=text-sm>${e.custom_fields.snippet||e.meta_description}</p>
					${s.register?`<p class="u-m-0 text-sm"><a href="${s.register}" class="u-m-0 button hollow tiny">Register now</a></p>`:""}
				</div>
				${u(e.custom_fields.image&&e.custom_fields.image.split("|")[0],e.title.split(" | ")[0])}
				${r?'<div class=c-search-result__image><div class="c-icon-image"><span class="uos-web"></span></div></div>':""}
