var stir=stir||{};if(stir.templates=stir.templates||{},stir.const=stir.const||{},stir.templates.search=(()=>{"dev"!==UoS_env.name&&UoS_env.name;const s=e=>`<p class="u-heritage-berry u-border-solid u-p-1"><span class="uos-lightbulb"></span> ${e}</p>`,r={staff:"University of Stirling staff",student:"current students and staff"},t={staff:["staff","student"],student:["student"]};var e=window[["s","e","i","k","o","o","C"].reverse().join("")];const a=!!e.get("psessv0")?e.get("psessv0").split("|")[0]:"EXTERNAL",i=e=>-1<t[a.toLowerCase()]?.indexOf(e.toLowerCase()),l=(e,t)=>{return i(t)?`<p class=c-search-result__summary>${e}</p>`:(e=t,s(`This page is only available to ${r[e]||e}. You will be asked to log in before you can view it, but once you are logged in results will be shown automatically.`))},c=e=>{e=e.toUpperCase().split("/").slice(-1).toString().split(".");return 1<e.length&&e[1].match(/PDF|DOCX?/)},o=e=>{const s={text:e.custom_fields.breadcrumb?e.custom_fields.breadcrumb.split(" > ").slice(1,-1):e.categories.slice?e.categories.slice(1,-1).map(e=>e.split("x")[1]):[""],href:new URL(e.url).pathname.split("/").slice(1,-1)};var t=s.text.map((e,t)=>({text:e,href:"/"+s.href.slice(0,t+1).join("/")+"/"}));return t&&0<t.length?stir.templates.search.breadcrumb(stir.templates.search.trailstring(t)):c(e.url)?`Document: ${c(e.url)} <small>${stir.Math.fileSize(fileSize||0,0)}</small>`:""};const n=(e,t)=>{e=`form[data-filters] input[name="${e}"][value="${t}"]`;try{return document.querySelector(e)}catch(e){}};const u=(e,t)=>{var s=n(e,t);if(s)return d(Array.prototype.slice.call(s.parentElement.childNodes).map(e=>3===e.nodeType?e.textContent:"").join(""),e,t)},d=(e,t,s)=>`<span class=c-tag data-name="${t}" data-value="${s}">✖️ ${e}</span>`,m=e=>{switch(e){case"staff":return"Staff";case"student":return"Student";case"module":return"CPD and short courses";case"Postgraduate (taught)":case"Postgraduate (research)":return"Postgraduate";case"undergraduate":return"Undergraduate";default:return{contract:"Research project",publication:"Research output",centre:"Research centre/group",area:"Research programme",scholarship:"Scholarship"}[e]||e}},p=(e,t,s,r)=>{return e?(e={url:(-1<e.indexOf("|")?e.split("|")[1]||e.split("|")[0]:e).trim(),alt:t||"",width:s||550,height:r||550},`<div class=c-search-result__image>${x(e)}</div>`):" \x3c!-- no image --\x3e "},h=e=>`<a href="${e.href}">${e.text}</a>`,f=e=>stir.courses&&stir.courses.clearing&&Object.values&&e.clearing&&0<=Object.values(e.clearing).join().indexOf("Yes"),v=e=>"object"==typeof e?Object.assign({},...e.map(e=>JSON.parse(decodeURIComponent(e)))):JSON.parse(decodeURIComponent(e)),g={SINGLE_DRILL_DOWN:void 0,CHECKBOX:"checkbox",RADIO_BUTTON:"radio",TAB:void 0,UNKNOWN:void 0},y=function(){if(!stir.t4Globals||!stir.t4Globals.search||!stir.t4Globals.search.facets)return(e,t)=>t;const s=stir.t4Globals.search.facets;return(e,t)=>{return s[e]?(e=s[e]).findIndex?e[e.findIndex(e=>t===e.toLowerCase())]||t:e[t]||t:t}}(),b=(e,t)=>y(e,t),_=e=>y("Start date",e),$=e=>e.title.split("|")[0].trim().replace(/\xA0/g," "),w=e=>`<a href="${e.url}" data-docid="${e.id}" data-position="${e.position||""}">${$(e)}</a>`,S=e=>`<a href="${e.url}" data-docid="${e.id}" data-position="${e.position||""}">${e.custom_fields.name||$(e)}</a>`,E=e=>`<img src="${e.src}" alt="${e.alt}" height="${e.height}" width="${e.width}" loading=lazy data-original=${e.original}>`,x=e=>e.url?E({src:e.url,alt:e.alt,width:Math.floor(e.width/2),height:Math.floor(e.height/2),original:e.url}):"\x3c!-- no image --\x3e",A=e=>{e=Object.values(e||{}).map(e=>e.map(e=>e.desc?stir.templates.search.stag(e.desc):"").join(" ")).join(" ").trim();return e?`<p class=c-search-taggroup>${e}</p>`:""};return{strings:{buttons:{more:"Load more results"}},classes:{buttons:{more:"button hollow tiny",wrapper:"c-search-results__loadmore flex-container align-center u-mb-2"}},selector:{form:"form.x-search-redevelopment",query:'form.x-search-redevelopment input[name="term"]',results:".c-search-results-area",summary:".c-search-results-summary"},tag:d,stag:e=>e?`<span class=c-search-tag>${e}</span>`:"",breadcrumb:e=>`<p class=c-search-result__trail>${e}</p>`,trailstring:e=>e.length?e.map(h).join("<small> &gt; </small> "):"",message:(e,t)=>{var s=document.createElement("p"),r=0<e,a=r&&1<e,e=e.toLocaleString("en");return s.classList.add(r?"text-sm":"search_summary_noresults"),s.innerHTML=r?a?`There are <strong>${e} results</strong>`:`There is <strong>${e} result</strong>`:"<strong>There are no results</strong>",t&&s.insertAdjacentText("beforeend"," for "),s},summary:e=>{e.page,e.hits,e.hits;var t=e.total_hits,s=document.createElement("div"),r=e.question&&stir.String.htmlEntities(e.question.get("term")).replace(/^!padrenullquery$/,"").replace(/^\*$/,"").trim()||"",a=document.createElement("em"),t=stir.templates.search.message(t,1<r.length),e=(e=e.question,Array.from(e.entries()).map(e=>!(e[1]&&0<=e[1].indexOf('"'))&&u(e[0],e[1])||"").join(" "));return s.classList.add("u-py-2"),1<(a.textContent=r).length&&t.append(a),s.append(t),s.insertAdjacentHTML("beforeend",e+" "),s},pagination:e=>{var{currEnd:e,totalMatching:t,progress:s}=e;return 0===t?"\x3c!-- no results to show --\x3e":`
			...
			</div>`},suppressed:e=>`<!-- Suppressed search result: ${e} -->`,auto:(e,t,s)=>{if(e.type&&"PROMOTED"===e.type)return stir.templates.search.cura(e);if(e.custom_fields.access)return stir.templates.search.internal(e);if(e.custom_fields.type)switch(e.custom_fields.type){case"course":return stir.templates.search.course(e);case"news":return stir.templates.search.news(e);case"event":case"webinar":return stir.templates.search.event(e);case"contract":case"area":case"centre":return stir.templates.search.research(e);case"profile":return stir.templates.search.person(e);case"studentstory":return stir.templates.search.studentstory(e)}return`<div class="u-border-width-5 u-heritage-line-left c-search-result" data-rank=${e.score||""}${e.type?` data-as-type="${e.type}"`:""}>
	  ...
	  <div class="u-border-width-5 u-heritage-line-left c-search-result${t=e.custom_fields.access,i(t)?" c-internal-search-result":" c-internal-locked-search-result"}" data-rank=${e.score}${e.custom_fields.type?' data-result-type="'+e.custom_fields.type.toLowerCase()+'"':""} data-access="${e.custom_fields.access}">
		...
		<div class="c-search-result u-border-width-5 u-heritage-line-left" data-result-type=scholarship data-rank=${e.score}>
			...
			<div class="c-search-result__body u-mt-1 flex-container flex-dir-column u-gap">
				...
				</div>`;var t},event:e=>{var t,s,r,a,i,l,c,o;return e.type&&"PROMOTED"===e.type?stir.templates.search.cura(e):(r=(s=(t=e.custom_fields.data?v(e.custom_fields.data):{}).tags&&-1<t.tags.indexOf("Webinar")||"webinar"===e.custom_fields.type)||e.custom_fields.online,i=e.custom_fields?.image||s,a=e.custom_fields.e?new Date(e.custom_fields.e)<new Date:void 0,e.custom_fields.name||e.title.split("|")[0].trim(),e.url,`
