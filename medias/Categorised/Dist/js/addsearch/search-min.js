var stir=stir||{};if(stir.templates=stir.templates||{},stir.const=stir.const||{},stir.templates.search=(()=>{"dev"!==UoS_env.name&&UoS_env.name;const a=()=>"https://"+stir.funnelback.getHostname(),r=e=>`<p class="u-heritage-berry u-border-solid u-p-1"><span class="uos-lightbulb"></span> ${e}</p>`,s={staff:"University of Stirling staff",students:"current students and staff"},t={staff:["staff","students"],student:["students"]};var e=window[["s","e","i","k","o","o","C"].reverse().join("")];const l=!!e.get("psessv0")?e.get("psessv0").split("|")[0]:"EXTERNAL",i=e=>-1<t[l.toLowerCase()]?.indexOf(e.toLowerCase()),c=(e,t)=>{return i(t)?`<p class=c-search-result__summary>${e}</p>`:(e=t,r(`This page is only available to ${s[e]}. You will be asked to log in before you can view it, but once you are logged in results will be shown automatically.`))};const n=(e,t,a)=>`<span class=c-tag data-name="${t}" data-value="${a}">✖️ ${e}</span>`,o=(e,t,a,r)=>{return e?(e=-1<e.indexOf("|")?e.split("|")[1]||e.split("|")[0]:e,`<div class=c-search-result__image>
			...
			</div>`,internal:e=>{const a={text:e.metaData?.breadcrumbs?.split(" > ")||[],href:new URL(e.liveUrl).pathname.split("/").filter(e=>e)};var t,r=i(e.metaData.group)?stir.templates.search.trailstring(a.text.map((e,t)=>({text:e,href:"/"+a.href.slice(0,t+1).join("/")+"/"})).slice(0,-1)):`<a href="https://www.stir.ac.uk/${a.href[0]}/">${a.text[0]}</a>`;return`
	  <div class="u-border-width-5 u-heritage-line-left c-search-result${t=e.metaData.group,i(t)?" c-internal-search-result":" c-internal-locked-search-result"}" data-rank=${e.rank}${e.metaData.type?' data-result-type="'+e.metaData.type.toLowerCase()+'"':""} data-access="${e.metaData.access}">
			...
			<div>
				<p><strong><a href="${a()+e.clickTrackingUrl}" title="${e.liveUrl}" class="u-border-none">
			...
			<div class="c-search-result u-border-width-5 u-heritage-line-left" data-result-type=person>
				...
				<div class="flex-container flex-dir-column u-gap u-mt-1">
					<p class="u-text-regular u-m-0"><strong>
						<a href="${a()+e.clickTrackingUrl}">${e.title.split(" | ")[0].trim()}</a>
					</strong></p>
		...
		<div class="c-search-result u-border-width-5 u-heritage-line-left" data-result-type=scholarship data-rank=${e.rank}>
			...
			<div class="c-search-result__body u-mt-1 flex-container flex-dir-column u-gap">
				...
				<div class="u-border-width-5 u-heritage-line-left c-search-result${e.metaData.thumbnail?" c-search-result__with-thumbnail":""}" data-rank=${e.rank} data-result-type=news>
					<div class="c-search-result__body flex-container flex-dir-column u-gap u-mt-1">
						<p class="u-text-regular u-m-0">
							<strong>
								<a href="${a()+e.clickTrackingUrl}">${e.metaData.h1||e.title.split(" | ")[0].trim()}</a>
							</strong>
						</p>
				...
				</div>`;var t},event:e=>{return stir.templates.search.auto(e)},research:e=>`
			<div class="u-border-width-5 u-heritage-line-left c-search-result" data-rank=${e.rank}${e.metaData.type?' data-result-type="'+e.metaData.type.toLowerCase()+'"':""}>
				<div>
					...
					<div class=c-search-result__body>
						<p class="u-text-regular u-m-0"><strong>
							<a href="${a()+e.linkUrl}" title="${e.displayUrl}">${e.titleHtml}</a><br>
	...
	</li>`)}})(),"undefined"!=typeof window&&!("onscrollend"in window)){const V0=new Event("scrollend"),W0=new Set;document.addEventListener("touchstart",e=>{for(var t of e.changedTouches)W0.add(t.identifier)},{passive:!0}),document.addEventListener("touchend",e=>{for(var t of e.changedTouches)W0.delete(t.identifier)},{passive:!0}),document.addEventListener("touchcancel",e=>{for(var t of e.changedTouches)W0.delete(t.identifier)},{passive:!0});let s=new WeakMap;function e(e,t,a){let r=e[t];e[t]=function(){var e=Array.prototype.slice.apply(arguments,[0]);r.apply(this,e),e.unshift(r),a.apply(this,e)}}function t(e,t,a,r){if("scroll"==t||"scrollend"==t){let a=this,r=s.get(a);if(void 0===r){let t=0;r={scrollListener:e=>{clearTimeout(t),t=setTimeout(()=>{W0.size?setTimeout(r.scrollListener,100):(a&&a.dispatchEvent(V0),t=0)},100)},listeners:0},e.apply(a,["scroll",r.scrollListener]),s.set(a,r)}r.listeners++}}function n(e,t,a){"scroll"!=t&&"scrollend"!=t||void 0===(t=s.get(this))||0<--t.listeners||(e.apply(this,["scroll",t.scrollListener]),s.delete(this))}e(Element.prototype,"addEventListener",t),e(window,"addEventListener",t),e(document,"addEventListener",t),e(Element.prototype,"removeEventListener",n),e(window,"removeEventListener",n),e(document,"removeEventListener",n)}var scrollend={__proto__:null};!function(){const r=(t,a)=>{let r;return(...e)=>{clearTimeout(r),r=setTimeout(()=>t.apply(this,e),a)}},t=e=>{const s=e.querySelector(".carousel-slides"),l=e.querySelector(".carousel-slides h2:first-of-type button"),i=e.querySelector(".carousel-slides h2:last-of-type button"),c=e.querySelector(".slide-arrow-prev"),n=e.querySelector(".slide-arrow-next"),o=e=>{e.setAttribute("disabled","disabled"),e.querySelector("span")?.classList.add("u-opacity-0")},u=e=>{e.removeAttribute("disabled"),e.querySelector("span")?.classList.remove("u-opacity-0")},d=e=>{e?s.classList.add("align-center"):s.classList.remove("align-center"),e?c.classList.remove("u-border-right-solid"):c.classList.add("u-border-right-solid"),e?n.classList.remove("u-border-left-solid"):n.classList.add("u-border-left-solid")};e=()=>{let e=!1,t=!1;u(c),u(n);var a=l.getBoundingClientRect(),r=s.getBoundingClientRect(),a=(a.left>=r.left&&(o(c),e=!0),i.getBoundingClientRect());a.right<=r.right&&(o(n),t=!0),e&&t?d(!0):d(!1)};const a=r(e,250),t=e=>{var t=s.clientWidth+10;s.scrollLeft+="prev"===e?-t:t,s.addEventListener("scrollend",a)};e();["wheel","touchend"].forEach(e=>{s.addEventListener(e,a)}),c.addEventListener("click",()=>t("prev")),n.addEventListener("click",()=>t("next")),window.addEventListener("resize",a)},a=i=>{if(i){i.classList.remove("hide");var e=i.querySelector("nav#nav-slider");const c=e&&e.querySelectorAll("button"),n=i.querySelectorAll("#mySlider1 > div");c&&c.forEach(e=>{e.addEventListener("click",e=>{var t,a,r,s,l=e.target.closest("button[data-open]");l&&(l=l.getAttribute("data-open")||"all",t=l,a=n,r=c,s=i,a.forEach(e=>{e.setAttribute("aria-hidden","true"),e.classList.add("hide")}),r&&r.forEach(e=>{e&&e.classList.remove("u-white","u-bg-heritage-green")}),(a=s.querySelector(`[data-panel="${t}"]`))&&(a.classList.remove("hide"),a.removeAttribute("aria-hidden")),(r=s.querySelector(`[data-open="${t}"]`))&&r.classList.add("u-white","u-bg-heritage-green"),e.isTrusted)&&QueryParams.set("tab",l)})}),n&&1<n.length&&(n.forEach(e=>{var t=e.getAttribute("data-panel");e.setAttribute("role","tabpanel"),e.setAttribute("tabindex","0"),e.setAttribute("id","search_results_panel_"+t),e.setAttribute("aria-labelledby","searchtab_"+t)}),e=QueryParams.get("tab")||"all",e=i.querySelector(`[data-open="${e}"]`))&&(e.click(),e.scrollIntoView({block:"end"}))}};void 0!==window.URLSearchParams&&(stir.nodes(".c-search-results-area").forEach(e=>a(e)),stir.nodes(".carousel").forEach(e=>t(e)))}(),stir.courses=(()=>{const t="dev"===UoS_env.name||"qa"===UoS_env.name;return{clearing:!0,getCombos:()=>{var e;if(!stir.courses.combos)return e={dev:"combo.json",qa:"combo.json",preview:stir?.t4Globals?.search?.combos||"",prod:"https://www.stir.ac.uk/media/stirling/feeds/combo.json"},t&&console.info(`[Search] Getting combo data for ${UoS_env.name} environment (${e[UoS_env.name]})`),stir.getJSON(e[UoS_env.name],e=>stir.courses.combos=e&&!e.error?e.slice(0,-1):[])},showCombosFor:e=>{if(!e||!stir.courses.combos)return[];for(var t=isNaN(e)&&new URL(e).pathname,a=[],r=0;r<stir.courses.combos.length;r++)for(var s=0;s<stir.courses.combos[r].courses.length;s++)if(t&&t===stir.courses.combos[r].courses[s].url||stir.courses.combos[r].courses[s].url.split("/").slice(-1)==e){var l=stir.clone(stir.courses.combos[r]);l.courses.splice(s,1),l.courses=l.courses.filter(e=>e.text),a.push(l);break}return a},favsUrl:function(){switch(UoS_env.name){case"dev":return"/pages/search/course-favs/index.html";case"qa":return"/stirling/pages/search/course-favs/";default:return'<t4 type="navigation" name="Helper: Path to Courses Favourites" id="5195" />'}}()}})(),stir.courses.startdates=function(){var e=Array.prototype.slice.call(document.querySelectorAll('[name="f.Start date|startval"]'));if(e&&0!==e.length){const s=[,"January","February","March","April","May","June","July","August","September","October","November","December"],l={other:"Other","1st-every-month":"First day of any month"},i=new RegExp(/\d{4}-\d{2}ay\d{4}\D\d{2}/i),c=new RegExp(/\d{4}/),n=new RegExp(/ay\d{4}\D\d{2}/i),o=new RegExp(/ay/i),u=e.filter(e=>e.value.match(i)).map(e=>({data:e.value,date:e.value.replace(n,""),month:-1<e.value.indexOf("-")&&s[parseInt(e.value.split("-")[1])]||"",year:e.value.match(c)?e.value.match(c).shift():"",acyear:e.value.match(n)?e.value.match(n).shift().replace(o,""):"",checked:e.checked}));var t=e.filter(e=>!e.value.match(i)).map(e=>(console.info("OTHER!",e,l[e.value]||e.value),{label:l[e.value]||e.value,value:e.value,checked:e.checked})),a=u.map(e=>e.acyear.replace(o,"")).filter((e,t,a)=>a.indexOf(e)===t&&e),r=e[0].parentElement.parentElement.parentElement;if(0!==a.length+t.length){e.forEach(e=>{e.parentElement.parentElement.remove()});const d=(e,t,a)=>{s="radio",l="f.Start date|startval",t=""+t,a=a,(r=document.createElement("input")).type=s,r.name=l,r.value=t,r.checked=a;var r,s=r,l=document.createElement("label");return l.appendChild(s),l.appendChild(document.createTextNode(e)),l},m=(e,t=[])=>{var a=document.createElement("fieldset"),r=document.createElement("legend");return r.classList.add("u-mb-tiny","text-xsm"),a.appendChild(r),a.classList.add("u-mb-1","c-search-filters-subgroup"),r.innerText=e,a.append(...t),a},p=document.createElement("li");a.forEach(t=>{var e=u.filter(e=>e.acyear===t).filter(e=>e.acyear===t).map(e=>d(e.month+" "+e.year,e.data,e.checked));p.append(m("Academic year "+t,e))}),t.length&&p.append(m("Other",t.map(e=>d(e.label,e.value,e.checked)))),r.appendChild(p)}}},(stir=stir||{}).funnelback=(()=>{"dev"!==UoS_env.name&&UoS_env.name;const e=UoS_env.search,t=`https://${e}/s/`;const r=()=>new URL("scale",t);return{getHostname:()=>e,getJsonEndpoint:()=>new URL("search.json",t),getScaleEndpoint:r,getCroppedImageElement:e=>{var t,a;return e.url?(t=r(),a=stir.Object.extend({},e,{type:"crop_center",format:"jpeg"}),t.search=new URLSearchParams(a),`<img src="${(a={src:t,alt:e.alt,width:Math.floor(e.width/2),height:Math.floor(e.height/2),original:e.url}).src}" alt="${a.alt}" height="${a.height}" width="${a.width}" loading=lazy data-original=${a.original}>`):"\x3c!-- no image --\x3e"},getTags:e=>{e=e&&e.split(";");return e&&e.map(stir.templates.search.tagGroup).join("")},imgError:e=>{e.target.getAttribute("data-original")&&e.target.getAttribute("src")!=e.target.getAttribute("data-original")?e.target.src=e.target.getAttribute("data-original"):(e.target.parentElement.parentElement?.classList?.remove("c-search-result__with-thumbnail"),e.target.parentElement.parentElement.removeChild(e.target.parentElement))}}})(),stir.addSearch={getJsonEndpoint:()=>new URL("/v1/search/dbe6bc5995c4296d93d74b99ab0ad7de","https://api.addsearch.com")},stir.search=()=>{if(void 0===window.URLSearchParams)return void((e=document.querySelector(".c-search-results-area"))&&e.parentElement.removeChild(e));const u="dev"===UoS_env.name||"qa"===UoS_env.name;u||UoS_env.name;var e="small"===stir.MediaQuery.current?5:10;const s=256;var t=stir.courses.clearing,a=(u&&console.info("[Search] initialising…"),stir.curry((e,t)=>(e.search=new URLSearchParams(t),e)));const r=stir.curry((e,t)=>stir.Object.extend({},e,t)),l=(e,t)=>{var a,r,s=new URLSearchParams(t);for([a,r]of new URLSearchParams(e.search))s.set(a,r);return e.search=s,e};t={main:["c","d","access","award","biogrgaphy","breadcrumbs","category","custom","delivery","faculty","group","h1","image","imagealt","level","modes","online","page","pathways","role","register","sid","start","startDate","subject","tag","tags","thumbnail","type","ucas","venue","profileCountry","profileCourse1","profileImage","profileSnippet"],courses:["c","award","code","delivery","faculty","image","level","modes","pathways","sid","start","subject","ucas"],clearing:t?["clearing"]:[],scholarships:["value","status","number"],news:["abstract","c","d","h1","image","imagealt","tags","tag","thumbnail"]};const i={url:stir.addSearch.getJsonEndpoint(),form:document.querySelector("form.x-search-redevelopment"),input:document.querySelector('form.x-search-redevelopment input[name="term"]'),parameters:{any:{term:"University+of+Stirling"},news:{collection:"stir-www",term:"!padrenullquery",meta_type:"News",meta_v_not:"faculty-news",sort:"date",fmo:"true",SF:`[${t.news.join(",")}]`,num_ranks:e,SBL:450},event:{term:"event",type:"event",facet:"event"},gallery:{collection:"stir-www",meta_type:"Gallery",sort:"date",fmo:"true",SF:"[c,d,image]",num_ranks:e},course:{collection:"stir-courses",SF:`[${t.courses.concat(t.clearing).join(",")}]`,fmo:"true",num_ranks:e,explain:!0,term:"!padrenullquery",timestamp:+new Date},coursemini:{collection:"stir-courses",SF:"[c,award,code,delivery,faculty,image,level,modes,sid,start,subject,teaser,ucas]",num_ranks:3,curator:"off",term:"!padrenullquery"},person:{collection:"stir-research",meta_type:"profile",fmo:"true",SF:"[c,d,biogrgaphy,category,faculty,groups,image,imagealt,programme,role,themes]",SM:"meta",MBL:350,num_ranks:e},research:{collection:"stir-research",SM:"meta",SF:"[c,d,category,groups,output,programme,themes,type]",MBL:450,num_ranks:e},internal:{collection:"stir-internal",SF:"[c,access,breadcrumbs,group]",term:"!padrenullquery"},clearing:{collection:"stir-courses-combos",term:"!padrenullquery",sort:"title",meta_clearing:"[scotland simd rukroi international eu]",SF:`[${t.courses.concat(t.clearing).join(",")}]`,fmo:"true",num_ranks:e}},noquery:{course:{sort:"title"}}};if(!i.form||!i.form.term)return;u&&console.info("[Search] initialised with host:",i.url.hostname);const c=e=>i.form.term.value||QueryParams.get("term")||i.parameters[e].term||"University of Stirling",n=()=>i.form.term.value?QueryParams.set("term",i.form.term.value):QueryParams.remove("term"),d=e=>e.getAttribute("data-type")||e.parentElement.getAttribute("data-type"),m=e=>QueryParams.set(e,parseInt(QueryParams.get(e)||1)+1);const o=e=>{return(parseInt(QueryParams.get(e)||1)-1)*(i.parameters[e].num_ranks||20)+1},p=()=>Object.keys(i.parameters).forEach(e=>QueryParams.remove(e)),h=e=>{var t,e=document.querySelector(".c-search-results-area form[data-filters="+e+"]"),a=e?new FormData(e):new FormData;for(t of a.keys())0!==t.indexOf("f.")&&1<a.getAll(t).length&&a.set(t,"["+a.getAll(t).join(" ").replace(/\[|\]/g,"")+"]");return a},g=stir.curry((e,t)=>e.insertAdjacentHTML("beforeend",t)),v=stir.curry((e,t)=>e.innerHTML=t),f=stir.curry((e,t)=>(e&&t&&0<t.total_hits&&e.removeAttribute("disabled"),t)),y=e=>new stir.accord(e,!1),b=stir.curry((e,t)=>{var a;e.closest&&(a=(e=e.closest("[data-panel]")).querySelectorAll('[data-behaviour="accordion"]:not(.stir-accordion)'),e.querySelectorAll("img"),Array.prototype.forEach.call(a,y))}),$=stir.curry((e,t)=>{e=e.parentElement.parentElement.querySelector(".c-search-results-summary");return e&&(e.innerHTML="",e.append(stir.templates.search.summary(t))),t}),w={string:{urlDecode:e=>decodeURIComponent(e.replace(/\+/g," "))}},_=stir.curry((e,t)=>{return t}),S=stir.curry((e,t)=>t?A[e](t.hits):"NO DATA"),k=e=>{var t;return!(!e||!e.hasAttribute("data-fallback")||(t=(t=document.getElementById(e.getAttribute("data-fallback")))&&(t.innerHTML||""),e.innerHTML=t,0))},E=a(i.url);t=stir.curry((e,t)=>{u&&console.info();var a=r(i.parameters[e])(stir.Object.extend({},{start_rank:o(e),term:c(e),curator:!(1<o(e))},(a=e,i.form.term.value?{}:i.noquery[a]),(()=>{let a=QueryParams.getAll();return Object.keys(a).filter(e=>0===e.indexOf("f.")).reduce((e,t)=>({...e,[t]:w.string.urlDecode(a[t]).toLowerCase()}),{})})())),a=l(E(a),h(e));console.info("[Search] Type",e),console.info("[Search] Query",c(e)),console.info("[Search] URL",a),stir.getJSON(a,t)}),e=stir.curry((e,t)=>{var a=c(e).trim(),a=r(i.parameters[e])({start_rank:o(e),term:`[t:${a} c:${a} subject:${a}]`}),a=l(E(a),h(e));stir.getJSON(a,t)});const x=e=>{if(e.innerHTML="",e.hasAttribute("data-infinite")){const n=document.createElement("div");var t=document.createElement("div");(a=document.createElement("button")).innerText="Load more results",a.setAttribute("class","button hollow tiny");const o=a;o.setAttribute("disabled",!0),o.addEventListener("click",e=>{{var t=n,a=o,r=d(t);if(D[r]){var s=$(t),l=g(t),i=S(r),t=b(t);const c=stir.compose(t,l,i,f(a),s);m(r),D[r](e=>e&&!e.error?c(e):new Function)}}}),e.appendChild(n),e.appendChild(t),t.appendChild(o),t.setAttribute("class","c-search-results__loadmore flex-container align-center u-mb-2"),U(n,o)}else U(e);var a},L=Array.prototype.slice.call(document.querySelectorAll(".c-search-results[data-type],[data-type=coursemini]")),D={any:t("any"),news:t("news"),event:t("event"),gallery:t("gallery"),course:t("course"),coursemini:e("coursemini"),person:t("person"),research:t("research"),internal:t("internal"),clearing:t("clearing")},A={any:e=>e.map(stir.templates.search.auto).join(""),news:e=>e.map(stir.templates.search.news).join(""),event:e=>e.map(stir.templates.search.event).join(""),gallery:e=>e.map(stir.templates.search.gallery).join(""),course:e=>e.map(stir.templates.search.course).join(""),coursemini:e=>e.map(stir.templates.search.coursemini).join(""),person:e=>e.map(stir.templates.search.person).join(""),research:e=>e.map(stir.templates.search.research).join(""),cura:e=>e.map(stir.templates.search.cura).join(""),internal:e=>e.map(stir.templates.search.auto).join(""),clearing:e=>e.map(stir.templates.search.auto).join("")};const C={course:e=>{stir.coursefavs&&stir.coursefavs.attachEventHandlers();var t=stir.courses.getCombos();t?t.addEventListener("loadend",e):e.call()}},U=(t,e)=>{u&&console.info("[Search] Getting initial results…");const a=d(t);if(D[a]){var r=_(a),s=$(t),e=f(e),l=v(t),i=S(a),c=b(t);const n=stir.compose(c,l,i,e,s,r),o=e=>(u&&console.info("[Search] Request callback",e),t&&t.parentElement?!e||e.error||0===e.total_hits&&k(t)?void 0:n(e):u&&console.error("[Search] late callback, element no longer on DOM"));if(p(),C[a])return C[a](e=>D[a](o));D[a](o)}},j=()=>L.forEach(x),T=(Array.prototype.forEach.call(document.querySelectorAll(".c-search-results-area form[data-filters]"),t=>{var e=t.getAttribute("data-filters");const a=document.querySelector(`.c-search-results[data-type="${e}"]`);t.addEventListener("reset",e=>{Array.prototype.forEach.call(t.querySelectorAll("input"),e=>e.checked=!1),x(a)}),t.addEventListener("change",e=>{d(a),x(a)}),t.addEventListener("submit",e=>{x(a),e.preventDefault()})}),e=>{var t;e&&e.target&&(t=`input[name="${e.target.getAttribute("data-name")}"][value="${e.target.getAttribute("data-value")}"]`,(t=(e.target.closest("[data-panel]")||document).querySelector(t))?(t.checked=!t.checked,e.target.parentElement.removeChild(e.target),j()):(t=`select[name="${e.target.getAttribute("data-name")}"]`,(t=document.querySelector(t))&&(t.selectedIndex=0,e.target.parentElement.removeChild(e.target),j())))}),q=(Array.prototype.forEach.call(document.querySelectorAll(".c-search-results-summary"),e=>{e.addEventListener("click",e=>{e.target.hasAttribute("data-suggest")?(e.preventDefault(),i.input.value=e.target.innerText,n(),j()):e.target.hasAttribute("data-value")&&T(e)})}),Array.prototype.forEach.call(document.querySelectorAll(".c-search-results"),e=>{e.addEventListener("click",e=>{e.target.hasAttribute("data-value")&&T(e)})}),e=>{n(),j(),e.preventDefault()});a=e=>{void 0!==QueryParams.get("term")&&(i.form.term.value=QueryParams.get("term").substring(0,s));var t=QueryParams.getAll();for(const r in t){var a=document.querySelector(`input[name="${encodeURIComponent(r)}"][value="${encodeURIComponent(t[r])}"]`);a&&(a.checked=!0)}i.form.addEventListener("submit",q),j()};a(),window.addEventListener("popstate",a)},stir.search();