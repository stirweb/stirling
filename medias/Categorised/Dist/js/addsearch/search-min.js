var stir=stir||{};if(stir.templates=stir.templates||{},stir.const=stir.const||{},stir.templates.search=(()=>{"dev"!==UoS_env.name&&UoS_env.name;const s=e=>`<p class="u-heritage-berry u-border-solid u-p-1"><span class="uos-lightbulb"></span> ${e}</p>`,r={staff:"University of Stirling staff",student:"current students and staff"},t={staff:["staff","students"],student:["students"]};var e=window[["s","e","i","k","o","o","C"].reverse().join("")];const a=!!e.get("psessv0")?e.get("psessv0").split("|")[0]:"EXTERNAL",i=e=>-1<t[a.toLowerCase()]?.indexOf(e.toLowerCase()),c=(e,t)=>{return i(t)?`<p class=c-search-result__summary>${e}</p>`:(e=t,s(`This page is only available to ${r[e]||e}. You will be asked to log in before you can view it, but once you are logged in results will be shown automatically.`))},l=e=>{e=e.toUpperCase().split("/").slice(-1).toString().split(".");return 1<e.length&&e[1].match(/PDF|DOCX?/)};const o=(e,t,s)=>`<span class=c-tag data-name="${t}" data-value="${s}">✖️ ${e}</span>`,n=e=>{switch(e){case"staff":return"Staff";case"student":return"Student";case"module":return"CPD and short courses";case"Postgraduate (taught)":case"Postgraduate (research)":return"Postgraduate";case"undergraduate":return"Undergraduate";default:return e}},d=(e,t,s,r)=>{return e?(e=-1<e.indexOf("|")?e.split("|")[1]||e.split("|")[0]:e,`<div class=c-search-result__image>
			...
			</div>`},suppressed:e=>`<!-- Suppressed search result: ${e} -->`,auto:(e,t,s)=>"course"==e.custom_fields.type?stir.templates.search.course(e):"news"===e.custom_fields.type?stir.templates.search.news(e):"event"==e.custom_fields.type||"webinar"==e.custom_fields.type?stir.templates.search.event(e):e.custom_fields.access?stir.templates.search.internal(e):e.custom_fields.type&&-1<e.custom_fields.type.indexOf("contract")?stir.templates.search.research(e):e.custom_fields.type&&-1<e.custom_fields.type.indexOf("profile")?stir.templates.search.person(e):e.custom_fields.type&&-1<e.custom_fields.type.indexOf("studentstory")?stir.templates.search.studentstory(e):`<div class="u-border-width-5 u-heritage-line-left c-search-result" data-rank=${e.score||""}>
				<div class="c-search-result__body u-mt-1 flex-container flex-dir-column u-gap">
				<div class=c-search-result__tags>
					${stir.templates.search.stag([e.custom_fields.type||"Page"])}
				</div>
					${(e=>{const s={text:e.categories.slice(1),href:new URL(e.url).pathname.split("/").slice(1,-1)};var t=s.text.map((e,t)=>({text:e.split("x")[1],href:"/"+s.href.slice(0,t+1).join("/")+"/"}));return t&&0<t.length?stir.templates.search.breadcrumb(stir.templates.search.trailstring(t)):l(e.url)?`Document: ${l(e.url)} <small>${stir.Math.fileSize(fileSize||0,0)}</small>`:""})(e)}
	  ...
	  <div class="u-border-width-5 u-heritage-line-left c-search-result${t=e.custom_fields.access,i(t)?" c-internal-search-result":" c-internal-locked-search-result"}" data-rank=${e.score}${e.custom_fields.type?' data-result-type="'+e.custom_fields.type.toLowerCase()+'"':""} data-access="${e.custom_fields.access}">
		...
		<div class="flex-container flex-dir-column u-gap u-mt-1 ">
		  ...
		  ${stir.templates.search.pathways(e)}
			...
			</p>`,person:e=>{var t=e.url.split("/").slice(-1),s="object"==typeof e.custom_fields.data?Object.assign({},...e.custom_fields.data.map(e=>JSON.parse(decodeURIComponent(e)))):JSON.parse(decodeURIComponent(e.custom_fields.data));return`
		...
		<div class="c-search-result u-border-width-5 u-heritage-line-left" data-result-type=scholarship data-rank=${e.score}>
			...
			<div class="c-search-result__body u-mt-1 flex-container flex-dir-column u-gap">
				...
				</div>`},news:e=>{var t=e.custom_fields.data?p(e.custom_fields.data):{},s=!!t.thumbnail,t=t.thumbnail?`data-original="${t.thumbnail}"`:"";return`
				<div class="u-border-width-5 u-heritage-line-left c-search-result${s?" c-search-result__with-thumbnail":""}" data-rank=${e.score} data-result-type=news>
					...
					<div class=c-search-result__image>
						<img src="${e.images.main}" alt="${e.title.split(" | ")[0].trim()}" ${t} height=275 width=275 loading=lazy>
					</div>
				...
				</div>`;var t},event:e=>{var t,s,r,a="object"==typeof e.custom_fields.data?Object.assign({},...e.custom_fields.data.map(e=>JSON.parse(decodeURIComponent(e)))):JSON.parse(decodeURIComponent(e.custom_fields.data)),i=a.tags&&-1<a.tags.indexOf("Webinar")||"webinar"===e.custom_fields.type,c=i||e.custom_fields.online,l=e.custom_fields?.image||i,o=e.custom_fields.e?new Date(e.custom_fields.e)<new Date:void 0;e.custom_fields.name||e.title.split("|")[0].trim(),e.url;return`
			<div class="u-border-width-5 u-heritage-line-left c-search-result${l?" c-search-result__with-thumbnail":""}" data-rank=${e.score} data-result-type=event>
				<div class=c-search-result__tags>
					${a.isSeriesChild?stir.templates.search.stag(a.isSeriesChild):""}
				</div>
				<div class="c-search-result__body flex-container flex-dir-column u-gap u-mt-1">
					<p class="u-text-regular u-m-0">
						<strong>${y(e)}</strong>
					...
					<div class="flex-container flex-dir-column u-gap-8">
						<div class="flex-container u-gap-16 align-middle">
							...
							<span>${l=e.custom_fields.d,t=e.custom_fields.e,l?(l=new Date(l),s=stir.Date.newsDate(l),l=stir.Date.timeElementDatetime(l),!t||(r=(t=t&&new Date(t))&&stir.Date.newsDate(t),t=t&&stir.Date.timeElementDatetime(t),s==r)?`<time datetime="${l}">${s}</time>`:`<time datetime="${l}">${s}</time>–<time datetime="${t}">${r}</time>`):'<abbr title="To be confirmed">TBC</abbr>'}</span>
						</div>
						<div class="flex-container u-gap-16 align-middle">
							<span class="uos-clock u-icon h5"></span>
							<span>
							${o?"This event has ended.":(l=e.custom_fields.d,s=e.custom_fields.e,(l?`<time>${stir.Date.time24(new Date(l))}</time>`:"")+(s?`–<time>${stir.Date.time24(new Date(s))}</time>`:""))}
							</span>
						</div>
						<div class="flex-container u-gap-16 align-middle">
							<span class="u-icon h5 uos-${c?"web":"location"}"></span>
							<span>${c?"Online":a.location||""}</span>
						</div>
					</div>
					<p class=text-sm>${e.custom_fields.snippet||e.meta_description}</p>
					${a.register?`<p class="u-m-0 text-sm"><a href="${a.register}" class="u-m-0 button hollow tiny">Register now</a></p>`:""}
				</div>
				${d(e.custom_fields.image&&e.custom_fields.image.split("|")[0],e.title.split(" | ")[0])}
				${i?'<div class=c-search-result__image><div class="c-icon-image"><span class="uos-web"></span></div></div>':""}
			</div>`},research:e=>`<div class="u-border-width-5 u-heritage-line-left c-search-result" data-rank=${e.score}${e.custom_fields.type?' data-result-type="'+e.custom_fields.type.toLowerCase()+'"':""}>
				<div>
				...
				</li>`)}})(),"undefined"!=typeof window&&!("onscrollend"in window)){const pb=new Event("scrollend"),qb=new Set;document.addEventListener("touchstart",e=>{for(var t of e.changedTouches)qb.add(t.identifier)},{passive:!0}),document.addEventListener("touchend",e=>{for(var t of e.changedTouches)qb.delete(t.identifier)},{passive:!0}),document.addEventListener("touchcancel",e=>{for(var t of e.changedTouches)qb.delete(t.identifier)},{passive:!0});let a=new WeakMap;function e(e,t,s){let r=e[t];e[t]=function(){var e=Array.prototype.slice.apply(arguments,[0]);r.apply(this,e),e.unshift(r),s.apply(this,e)}}function t(e,t,s,r){if("scroll"==t||"scrollend"==t){let s=this,r=a.get(s);if(void 0===r){let t=0;r={scrollListener:e=>{clearTimeout(t),t=setTimeout(()=>{qb.size?setTimeout(r.scrollListener,100):(s&&s.dispatchEvent(pb),t=0)},100)},listeners:0},e.apply(s,["scroll",r.scrollListener]),a.set(s,r)}r.listeners++}}function n(e,t,s){"scroll"!=t&&"scrollend"!=t||void 0===(t=a.get(this))||0<--t.listeners||(e.apply(this,["scroll",t.scrollListener]),a.delete(this))}e(Element.prototype,"addEventListener",t),e(window,"addEventListener",t),e(document,"addEventListener",t),e(Element.prototype,"removeEventListener",n),e(window,"removeEventListener",n),e(document,"removeEventListener",n)}var scrollend={__proto__:null};!function(){const r=(t,s)=>{let r;return(...e)=>{clearTimeout(r),r=setTimeout(()=>t.apply(this,e),s)}},t=e=>{const a=e.querySelector(".carousel-slides"),i=e.querySelector(".carousel-slides h2:first-of-type button"),c=e.querySelector(".carousel-slides h2:last-of-type button"),l=e.querySelector(".slide-arrow-prev"),o=e.querySelector(".slide-arrow-next"),n=e=>{e.setAttribute("disabled","disabled"),e.querySelector("span")?.classList.add("u-opacity-0")},d=e=>{e.removeAttribute("disabled"),e.querySelector("span")?.classList.remove("u-opacity-0")},u=e=>{e?a.classList.add("align-center"):a.classList.remove("align-center"),e?l.classList.remove("u-border-right-solid"):l.classList.add("u-border-right-solid"),e?o.classList.remove("u-border-left-solid"):o.classList.add("u-border-left-solid")};e=()=>{let e=!1,t=!1;d(l),d(o);var s=i.getBoundingClientRect(),r=a.getBoundingClientRect(),s=(s.left>=r.left&&(n(l),e=!0),c.getBoundingClientRect());s.right<=r.right&&(n(o),t=!0),e&&t?u(!0):u(!1)};const s=r(e,250),t=e=>{var t=a.clientWidth+10;a.scrollLeft+="prev"===e?-t:t,a.addEventListener("scrollend",s)};e();["wheel","touchend"].forEach(e=>{a.addEventListener(e,s)}),l.addEventListener("click",()=>t("prev")),o.addEventListener("click",()=>t("next")),window.addEventListener("resize",s)},s=c=>{if(c){c.classList.remove("hide");var e=c.querySelector("nav#nav-slider");const l=e&&e.querySelectorAll("button"),o=c.querySelectorAll("#mySlider1 > div");l&&l.forEach(e=>{e.addEventListener("click",e=>{var t,s,r,a,i=e.target.closest("button[data-open]");i&&(i=i.getAttribute("data-open")||"all",t=i,s=o,r=l,a=c,s.forEach(e=>{e.setAttribute("aria-hidden","true"),e.classList.add("hide")}),r&&r.forEach(e=>{e&&e.classList.remove("u-white","u-bg-heritage-green")}),(s=a.querySelector(`[data-panel="${t}"]`))&&(s.classList.remove("hide"),s.removeAttribute("aria-hidden")),(r=a.querySelector(`[data-open="${t}"]`))&&r.classList.add("u-white","u-bg-heritage-green"),e.isTrusted)&&QueryParams.set("tab",i)})}),o&&1<o.length&&(o.forEach(e=>{var t=e.getAttribute("data-panel");e.setAttribute("role","tabpanel"),e.setAttribute("tabindex","0"),e.setAttribute("id","search_results_panel_"+t),e.setAttribute("aria-labelledby","searchtab_"+t)}),e=QueryParams.get("tab")||"all",e=c.querySelector(`[data-open="${e}"]`))&&(e.click(),e.scrollIntoView({block:"end"}))}};void 0!==window.URLSearchParams&&(stir.nodes(".c-search-results-area").forEach(e=>s(e)),stir.nodes(".carousel").forEach(e=>t(e)))}(),stir.courses=(()=>{const t="dev"===UoS_env.name||"qa"===UoS_env.name;return t&&console.info("[Search] Clearing is closed"),{clearing:!1,getCombos:()=>{var e;if(!stir.courses.combos)return e={dev:"combo.json",qa:"combo.json",preview:stir?.t4Globals?.search?.combos||"",prod:"https://www.stir.ac.uk/media/stirling/feeds/combo.json"},t&&console.info(`[Search] Getting combo data for ${UoS_env.name} environment (${e[UoS_env.name]})`),stir.getJSON(e[UoS_env.name],e=>stir.courses.combos=e&&!e.error?e.slice(0,-1):[])},showCombosFor:e=>{if(!e||!stir.courses.combos)return[];for(var t=isNaN(e)&&new URL(e).pathname,s=[],r=0;r<stir.courses.combos.length;r++)for(var a=0;a<stir.courses.combos[r].courses.length;a++)if(t&&t===stir.courses.combos[r].courses[a].url||stir.courses.combos[r].courses[a].url.split("/").slice(-1)==e){var i=stir.clone(stir.courses.combos[r]);i.courses.splice(a,1),i.courses=i.courses.filter(e=>e.text),s.push(i);break}return s},favsUrl:function(){switch(UoS_env.name){case"dev":return"/pages/search/course-favs/index.html";case"qa":return"/stirling/pages/search/course-favs/";default:return'<t4 type="navigation" name="Helper: Path to Courses Favourites" id="5195" />'}}()}})(),stir.courses.startdates=function(){var e=Array.prototype.slice.call(document.querySelectorAll('[name="f.Start date|startval"]'));if(e&&0!==e.length){const a=[,"January","February","March","April","May","June","July","August","September","October","November","December"],i={other:"Other","1st-every-month":"First day of any month"},c=new RegExp(/\d{4}-\d{2}ay\d{4}\D\d{2}/i),l=new RegExp(/\d{4}/),o=new RegExp(/ay\d{4}\D\d{2}/i),n=new RegExp(/ay/i),d=e.filter(e=>e.value.match(c)).map(e=>({data:e.value,date:e.value.replace(o,""),month:-1<e.value.indexOf("-")&&a[parseInt(e.value.split("-")[1])]||"",year:e.value.match(l)?e.value.match(l).shift():"",acyear:e.value.match(o)?e.value.match(o).shift().replace(n,""):"",checked:e.checked}));var t=e.filter(e=>!e.value.match(c)).map(e=>({label:i[e.value]||e.value,value:e.value,checked:e.checked})),s=d.map(e=>e.acyear.replace(n,"")).filter((e,t,s)=>s.indexOf(e)===t&&e),r=e[0].parentElement.parentElement.parentElement;if(0!==s.length+t.length){e.forEach(e=>{e.parentElement.parentElement.remove()});const u=(e,t,s)=>{a="radio",i="f.Start date|startval",t=""+t,s=s,(r=document.createElement("input")).type=a,r.name=i,r.value=t,r.checked=s;var r,a=r,i=document.createElement("label");return i.appendChild(a),i.appendChild(document.createTextNode(e)),i},m=(e,t=[])=>{var s=document.createElement("fieldset"),r=document.createElement("legend");return r.classList.add("u-mb-tiny","text-xsm"),s.appendChild(r),s.classList.add("u-mb-1","c-search-filters-subgroup"),r.innerText=e,s.append(...t),s},p=document.createElement("li");s.forEach(t=>{var e=d.filter(e=>e.acyear===t).filter(e=>e.acyear===t).map(e=>u(e.month+" "+e.year,e.data,e.checked));p.append(m("Academic year "+t,e))}),t.length&&p.append(m("Other",t.map(e=>u(e.label,e.value,e.checked)))),r.appendChild(p)}}},(stir=stir||{}).session=(()=>{var e="dev"===UoS_env.name||"qa"===UoS_env.name,t={};return window.sessionStorage&&sessionStorage.getItem("session")?(t.id=sessionStorage.getItem("session"),e&&console.info("[Session] ongoing session:",t.id)):(t.id=Date.now()+"_"+Math.floor(1000000001*Math.random()),window.sessionStorage&&sessionStorage.setItem("session",t.id),e&&console.info("[Session] new session:",t.id)),t})(),stir.funnelback=(()=>{"dev"!==UoS_env.name&&UoS_env.name;const e=UoS_env.search,t=`https://${e}/s/`;return{getHostname:()=>e,getJsonEndpoint:()=>new URL("search.json",t),getScaleEndpoint:()=>new URL("scale",t),getCroppedImageElement:e=>{return e.url?`<img src="${(e={src:e.url,alt:e.alt,width:Math.floor(e.width/2),height:Math.floor(e.height/2),original:e.url}).src}" alt="${e.alt}" height="${e.height}" width="${e.width}" loading=lazy data-original=${e.original}>`:"\x3c!-- no image --\x3e"},getTags:e=>{e=e&&e.split(";");return e&&e.map(stir.templates.search.tagGroup).join("")}}})(),stir.addSearch=(()=>{const e="dev"===UoS_env.name||"qa"===UoS_env.name,r="dbe6bc5995c4296d93d74b99ab0ad7de";const a="https://api.addsearch.com";return{getJsonEndpoint:()=>new URL("/v1/search/"+r,a),getCompletions:(e,t)=>{"function"==typeof t&&(t=new URL("/v1/autocomplete/document-field/"+r,a),e=new URLSearchParams(e),t.search=e,stir.getJSON(t,e=>console.info("getCompletions",e)))},getSuggestions:(e,t)=>{var s;"function"==typeof t&&((s=new URL("/v1/suggest/"+r,a)).search="term="+e,stir.getJSON(s,t))},getRecommendations:(e,t)=>{"function"==typeof t&&stir.getJSON((e=e,new URL(`/v1/recommendations/index/${r}/block/`+e,a)),t)},putReport:s=>{return e&&console.info("[AddSearch] reporting is disabled",s),new Promise((e,t)=>{e(s)})}}})(),stir.search=(()=>{if(void 0===window.URLSearchParams)return void((e=document.querySelector(stir.templates.search.selector.results))&&e.parentElement.removeChild(e));const d="dev"===UoS_env.name||"qa"===UoS_env.name;d&&console.info("[Search] initialising…");var e="small"===stir.MediaQuery.current?5:10;const a=256;stir.courses.clearing;let c=!0;const i=stir.curry((e,t)=>(e.search=new URLSearchParams(t),e)),l={url:stir.addSearch.getJsonEndpoint(),form:document.querySelector(stir.templates.search.selector.form),input:document.querySelector(stir.templates.search.selector.query),parameters:{any:{term:"University of Stirling",limit:e,collectAnalytics:!1},news:{customField:"type=news",sort:"custom_fields.d",collectAnalytics:!1},event:{collectAnalytics:!1,filter:JSON.stringify({and:[{or:[{"custom_fields.type":"event"},{"custom_fields.type":"webinar"}]},{range:{"custom_fields.e":{gt:stir.Date.timeElementDatetime((s=new Date,new Date(s.setDate(s.getDate()-1))))}}}]})},gallery:{customField:"type=gallery",collectAnalytics:!1},course:{customField:"type=course",collectAnalytics:!1},coursemini:{customField:"type=course",limit:5,collectAnalytics:!1},person:{customField:"type=profile",collectAnalytics:!1},research:{categories:"2xhub",collectAnalytics:!1},internal:{collectAnalytics:!1,filter:JSON.stringify({or:[{"custom_fields.access":"staff"},{"custom_fields.access":"student"}]})},clearing:{collectAnalytics:!1,limit:e}},noquery:{course:{sort:"custom_fields.name",order:"asc"},person:{sort:"custom_fields.sort",order:"desc"},event:{sort:"custom_fields.e",order:"asc"}}};if(!l.form||!l.form.term)return;d&&console.info("[Search] initialised with host:",l.url.hostname);const o=e=>{return l.form.term.value||QueryParams.get("term")||((e=e)&&l.parameters[e]?l.parameters[e].term:void 0)||"*"},t=()=>l.form.term.value?QueryParams.set("term",l.form.term.value):QueryParams.remove("term"),n=e=>parseInt(QueryParams.get(e)||1),u=e=>e.getAttribute("data-type")||e.parentElement.getAttribute("data-type"),m=e=>QueryParams.set(e,parseInt(QueryParams.get(e)||1)+1),p=()=>Object.keys(l.parameters).forEach(e=>QueryParams.remove(e)),h=stir.curry((e,t)=>e.insertAdjacentHTML("beforeend",t)),f=stir.curry((e,t)=>e.innerHTML=t),g=stir.curry((e,t)=>{var s,r;return e&&(t&&0<t.total_hits&&e.removeAttribute("disabled"),console.info("[AddSearch] data",t),s=t.question&&t.question.limit?t.question.limit:10,r=Math.ceil(t.total_hits/s),console.info(`[AddSearch] page ${t.page} of ${r}. [${s}]`),t.page>=r)&&e.setAttribute("disabled",!0),t}),r=e=>new stir.accord(e,!1),v=e=>e.addEventListener("error",M),y=stir.curry((e,t)=>{var s;e.closest&&(s=(e=e.closest("[data-panel]")).querySelectorAll('[data-behaviour="accordion"]:not(.stir-accordion)'),e=e.querySelectorAll("img"),console.info("PICS +++ ",e),Array.prototype.forEach.call(s,r),Array.prototype.forEach.call(e,v))}),b=stir.curry((e,t)=>{var s=1+t.page*t.hits.length-t.hits.length,r=t.total_hits,a=e.parentElement.parentElement.querySelector(stir.templates.search.selector.summary);return a&&(a.innerHTML="",a.append(stir.templates.search.summary(t))),e.setAttribute("data-page",Math.floor(s/r+1)),t});const _={string:{urlDecode:e=>decodeURIComponent(e.replace(/\+/g," "))}},$=stir.curry((e,t)=>t),w=stir.curry((e,t,s,r)=>{var a=n(e)-1,e=l.parameters[e].limit||10;return t.position=t.position||1+s+a*e,t}),S=stir.curry((e,t)=>{return(t?O[e](t.hits.map(w(e))).join(""):"NO DATA")+stir.templates.search.pagination({currEnd:(s=t.page,r=t.hits.length,(s-1)*r+1+r-1),totalMatching:t.total_hits,progress:10/t.total_hits*100})+(q[e]?q[e]():"");var s,r}),E=e=>{var t;return!(!e||!e.hasAttribute("data-fallback")||(t=(t=document.getElementById(e.getAttribute("data-fallback")))&&(t.innerHTML||""),e.innerHTML=t,0))};{let r=document.getElementById("courseSubjectFilters");if(r&&stir.t4Globals.search.facets.Subject&&stir.t4Globals.search.facets.Subject.forEach(e=>{var t=document.createElement("li");t.innerHTML=`<label><input name=customField type=checkbox value="subject=${e}">${e}</label>`,r.appendChild(t)}),(r=document.querySelector('[data-facet="Faculty"] ul'))&&stir.t4Globals.search.facets.Faculty){r.innerHTML="";let s=stir.t4Globals.search.facets.Faculty;Object.keys(s).forEach(e=>{var t=document.createElement("li");t.innerHTML=`<label><input name=customField type=checkbox value="faculty=${s[e]}">${s[e]}</label>`,r.appendChild(t)})}if((r=document.querySelector('[data-facet="Start date"] ul'))&&stir.t4Globals.search.facets["Start date"]){r.innerHTML="";let s=stir.t4Globals.search.facets["Start date"];Object.keys(s).forEach(e=>{var t=document.createElement("li");t.innerHTML=`<label><input name=customField type=checkbox value="start=${e}">${s[e]}</label>`,r.appendChild(t)})}if((r=document.querySelector('[data-facet="Topic"] ul'))&&stir.t4Globals.search.facets.Topic){r.innerHTML="";let s=stir.t4Globals.search.facets.Topic;Object.keys(s).forEach(e=>{var t=document.createElement("li");t.innerHTML=`<label><input name=customField type=checkbox value="tag=${e}">${s[e]}</label>`,r.appendChild(t)})}if((r=document.querySelector('[data-facet="SDGs"] ul'))&&stir.t4Globals.search.facets.SDGs){r.innerHTML="";let s=stir.t4Globals.search.facets.SDGs;Object.keys(s).forEach(e=>{var t=document.createElement("li");t.innerHTML=`<label><input name=customField type=checkbox value="sdg=${s[e]}">${s[e]}</label>`,r.appendChild(t)})}}var s=stir.curry((e,t)=>{const s=stir.Object.extend({},l.parameters[e],{page:n(e),term:o(e)},(r=e,l.form.term.value?{}:l.noquery[r]),(()=>{let s=QueryParams.getAll();return Object.keys(s).filter(e=>0===e.indexOf("f.")).reduce((e,t)=>({...e,[t]:_.string.urlDecode(s[t]).toLowerCase()}),{})})());var r=((e,t)=>{var s,r,a=new URLSearchParams(e.search);for([s,r]of new URLSearchParams(t))"sort"===s?a.set(s,r):a.append(s,r);return e.search=a,e})(i(l.url,s),(e=>{e=document.querySelector(stir.templates.search.selector.results+` form[data-filters="${e}"]`);return e?new FormData(e):new FormData})(e));stir.getJSON(r,e=>{T(e.total_hits),t(s,e)})});const x=(s,e)=>{const t=u(s);if(C[t]){var r=$(t),a=b(s),e=g(e),i=f(s),c=S(t),l=y(s);const o=stir.compose(l,i,c,e,a,r),n=stir.curry((e,t)=>(d&&console.info("[Search] API callback with parameters",e),s&&s.parentElement?!t||t.error||0===t.total_hits&&E(s)?void 0:o(stir.Object.extend({},t,{question:e})):d&&console.error("[Search] late callback, element no longer on DOM")));if(p(),U[t])return U[t](e=>C[t](n));C[t](n)}},L=()=>k.forEach(A),A=e=>{if(e.innerHTML="",e.hasAttribute("data-infinite")){const o=document.createElement("div");var t=document.createElement("div");(s=document.createElement("button")).innerText=stir.templates.search.strings.buttons.more,s.setAttribute("class",stir.templates.search.classes.buttons.more);const n=s;n.setAttribute("disabled",!0),n.addEventListener("click",e=>{var t=o,s=n,r=u(t);if(C[r]){var a=b(t),i=h(t),c=S(r),t=y(t);const l=stir.compose(t,i,c,g(s),a);t=stir.curry((e,t)=>t&&!t.error?l(stir.Object.extend({},t,{question:e})):new Function);m(r),C[r](t)}}),e.appendChild(o),e.appendChild(t),t.appendChild(n),t.setAttribute("class",stir.templates.search.classes.buttons.wrapper),x(o,n)}else x(e);var s},k=Array.prototype.slice.call(document.querySelectorAll(".c-search-results[data-type],[data-type=coursemini]")),C={any:s("any"),news:s("news"),event:s("event"),gallery:s("gallery"),course:s("course"),coursemini:s("coursemini"),person:s("person"),research:s("research"),internal:s("internal"),clearing:s("clearing")},O={any:e=>e.map(stir.templates.search.auto),news:e=>e.map(stir.templates.search.news),event:e=>e.map(stir.templates.search.event),gallery:e=>e.map(stir.templates.search.gallery),course:e=>e.map(stir.templates.search.course),coursemini:e=>e.map(stir.templates.search.coursemini),person:e=>e.map(stir.templates.search.person),research:e=>e.map(stir.templates.search.research),cura:e=>e.map(stir.templates.search.cura),internal:e=>e.map(stir.templates.search.auto),clearing:e=>e.map(stir.templates.search.auto)},q={coursemini:()=>stir.templates.search.courseminiFooter(o("any"))},U={course:e=>{stir.coursefavs&&stir.coursefavs.attachEventHandlers();var t=stir.courses.getCombos();t?t.addEventListener("loadend",e):e.call()}};const D=async e=>{if(!c)return!0;var t,s,r,a,i;e&&e.target&&e.target.hasAttribute("href")&&(t=e.target.getAttribute("href"),s=e.target.getAttribute("data-docid"),r=e.target.getAttribute("data-position"),a=o(),i={action:"click",session:stir.session.id,keyword:a,docid:s,position:r},t&&a&&r&&s?(e.preventDefault(),fetch("/manifest.json").then(e=>console.info(e)).then(()=>{c=!1,e.target.dispatchEvent(new MouseEvent("click",{bubbles:!0,shiftKey:e.shiftKey,altKey:e.altKey,ctrlKey:e.ctrlKey,metaKey:e.metaKey})),console.info(e),c=!0}).catch(e=>console.error("[AddSearch] fetch error",e))):d&&console.error("Error tracking click:",e,i))},T=async(e,t)=>{var s=o(),s={action:"search",session:stir.session.id,keyword:s,numberOfResults:e},e=await stir.addSearch.putReport(s);console.info("SEARCH report sent",e)};function M(e){e.target.getAttribute("data-original")&&e.target.getAttribute("src")!=e.target.getAttribute("data-original")?e.target.src=e.target.getAttribute("data-original"):(e.target.parentElement.parentElement?.classList?.remove("c-search-result__with-thumbnail"),e.target.parentElement.parentElement.removeChild(e.target.parentElement))}document.querySelectorAll("[data-panel]").forEach(e=>e.addEventListener("click",D)),Array.prototype.forEach.call(document.querySelectorAll(".c-search-results-area form[data-filters]"),t=>{var e=t.getAttribute("data-filters");const s=document.querySelector(`.c-search-results[data-type="${e}"]`);t.addEventListener("reset",e=>{Array.prototype.forEach.call(t.querySelectorAll("input"),e=>e.checked=!1),A(s)}),t.addEventListener("change",e=>{u(s),A(s)}),t.addEventListener("submit",e=>{A(s),e.preventDefault()})});const j=e=>{var t;e&&e.target&&(t=`input[name="${e.target.getAttribute("data-name")}"][value="${e.target.getAttribute("data-value")}"]`,(t=(e.target.closest("[data-panel]")||document).querySelector(t))?(t.checked=!t.checked,e.target.parentElement.removeChild(e.target),L()):(t=`select[name="${e.target.getAttribute("data-name")}"]`,(t=document.querySelector(t))&&(t.selectedIndex=0,e.target.parentElement.removeChild(e.target),L())))},R=(Array.prototype.forEach.call(document.querySelectorAll(stir.templates.search.selector.summary),e=>{e.addEventListener("click",e=>{e.target.hasAttribute("data-suggest")?(e.preventDefault(),l.input.value=e.target.innerText,t(),L()):e.target.hasAttribute("data-value")&&j(e)})}),Array.prototype.forEach.call(document.querySelectorAll(".c-search-results"),e=>{e.addEventListener("click",e=>{e.target.hasAttribute("data-value")&&j(e)})}),e=>{t(),L(),e.preventDefault()});e=e=>{void 0!==QueryParams.get("term")&&(l.form.term.value=QueryParams.get("term").substring(0,a));var t=QueryParams.getAll();for(const r in t){var s=document.querySelector(`input[name="${encodeURIComponent(r)}"][value="${encodeURIComponent(t[r])}"]`);s&&(s.checked=!0)}l.form.addEventListener("submit",R),L()};return window.addEventListener("popstate",e),{init:e,constants:l,getPage:n}})(),stir.search.init();