var stir=stir||{};if(stir.templates=stir.templates||{},stir.const=stir.const||{},stir.templates.search=(()=>{"dev"!==UoS_env.name&&UoS_env.name;const s=()=>"https://"+stir.funnelback.getHostname(),r=e=>`<p class="u-heritage-berry u-border-solid u-p-1"><span class="uos-lightbulb"></span> ${e}</p>`,a={staff:"University of Stirling staff",students:"current students and staff"},t={staff:["staff","students"],student:["students"]};var e=window[["s","e","i","k","o","o","C"].reverse().join("")];const i=!!e.get("psessv0")?e.get("psessv0").split("|")[0]:"EXTERNAL",l=e=>-1<t[i.toLowerCase()]?.indexOf(e.toLowerCase()),c=(e,t)=>{return l(t)?`<p class=c-search-result__summary>${e}</p>`:(e=t,r(`This page is only available to ${a[e]}. You will be asked to log in before you can view it, but once you are logged in results will be shown automatically.`))},n=e=>{e=e.toUpperCase().split("/").slice(-1).toString().split(".");return 1<e.length&&e[1].match(/PDF|DOCX?/)};const o=(e,t,s)=>`<span class=c-tag data-name="${t}" data-value="${s}">✖️ ${e}</span>`,u=(e,t,s,r)=>{return e?(e=-1<e.indexOf("|")?e.split("|")[1]||e.split("|")[0]:e,`<div class=c-search-result__image>
			...
			<div class="cell text-center u-my-2">
				...
				<div class="c-search-result__body u-mt-1 flex-container flex-dir-column u-gap">
					${a=a,t=e.url,r=0,a&&0<a.length?stir.templates.search.breadcrumb(stir.templates.search.trailstring(a)):n(t)?`Document: ${n(t)} <small>${stir.Math.fileSize(r||0,0)}</small>`:""}
	  ...
	  <div class="u-border-width-5 u-heritage-line-left c-search-result${t=e.custom_fields.group,l(t)?" c-internal-search-result":" c-internal-locked-search-result"}" data-rank=${e.rank}${e.custom_fields.type?' data-result-type="'+e.custom_fields.type.toLowerCase()+'"':""} data-access="${e.custom_fields.access}">
		...
		<div class="flex-container flex-dir-column u-gap u-mt-1 ">
		  ...
		  <div class="c-search-result__meta grid-x">
			${stir.templates.search.courseFact("Start dates",e.custom_fields.start.map?e.custom_fields.start.map(g).join(", "):g(e.custom_fields.start),!1)}
	...
	</li>`)}})(),"undefined"!=typeof window&&!("onscrollend"in window)){const ab=new Event("scrollend"),bb=new Set;document.addEventListener("touchstart",e=>{for(var t of e.changedTouches)bb.add(t.identifier)},{passive:!0}),document.addEventListener("touchend",e=>{for(var t of e.changedTouches)bb.delete(t.identifier)},{passive:!0}),document.addEventListener("touchcancel",e=>{for(var t of e.changedTouches)bb.delete(t.identifier)},{passive:!0});let a=new WeakMap;function e(e,t,s){let r=e[t];e[t]=function(){var e=Array.prototype.slice.apply(arguments,[0]);r.apply(this,e),e.unshift(r),s.apply(this,e)}}function t(e,t,s,r){if("scroll"==t||"scrollend"==t){let s=this,r=a.get(s);if(void 0===r){let t=0;r={scrollListener:e=>{clearTimeout(t),t=setTimeout(()=>{bb.size?setTimeout(r.scrollListener,100):(s&&s.dispatchEvent(ab),t=0)},100)},listeners:0},e.apply(s,["scroll",r.scrollListener]),a.set(s,r)}r.listeners++}}function n(e,t,s){"scroll"!=t&&"scrollend"!=t||void 0===(t=a.get(this))||0<--t.listeners||(e.apply(this,["scroll",t.scrollListener]),a.delete(this))}e(Element.prototype,"addEventListener",t),e(window,"addEventListener",t),e(document,"addEventListener",t),e(Element.prototype,"removeEventListener",n),e(window,"removeEventListener",n),e(document,"removeEventListener",n)}var scrollend={__proto__:null};!function(){const r=(t,s)=>{let r;return(...e)=>{clearTimeout(r),r=setTimeout(()=>t.apply(this,e),s)}},t=e=>{const a=e.querySelector(".carousel-slides"),i=e.querySelector(".carousel-slides h2:first-of-type button"),l=e.querySelector(".carousel-slides h2:last-of-type button"),c=e.querySelector(".slide-arrow-prev"),n=e.querySelector(".slide-arrow-next"),o=e=>{e.setAttribute("disabled","disabled"),e.querySelector("span")?.classList.add("u-opacity-0")},u=e=>{e.removeAttribute("disabled"),e.querySelector("span")?.classList.remove("u-opacity-0")},d=e=>{e?a.classList.add("align-center"):a.classList.remove("align-center"),e?c.classList.remove("u-border-right-solid"):c.classList.add("u-border-right-solid"),e?n.classList.remove("u-border-left-solid"):n.classList.add("u-border-left-solid")};e=()=>{let e=!1,t=!1;u(c),u(n);var s=i.getBoundingClientRect(),r=a.getBoundingClientRect(),s=(s.left>=r.left&&(o(c),e=!0),l.getBoundingClientRect());s.right<=r.right&&(o(n),t=!0),e&&t?d(!0):d(!1)};const s=r(e,250),t=e=>{var t=a.clientWidth+10;a.scrollLeft+="prev"===e?-t:t,a.addEventListener("scrollend",s)};e();["wheel","touchend"].forEach(e=>{a.addEventListener(e,s)}),c.addEventListener("click",()=>t("prev")),n.addEventListener("click",()=>t("next")),window.addEventListener("resize",s)},s=l=>{if(l){l.classList.remove("hide");var e=l.querySelector("nav#nav-slider");const c=e&&e.querySelectorAll("button"),n=l.querySelectorAll("#mySlider1 > div");c&&c.forEach(e=>{e.addEventListener("click",e=>{var t,s,r,a,i=e.target.closest("button[data-open]");i&&(i=i.getAttribute("data-open")||"all",t=i,s=n,r=c,a=l,s.forEach(e=>{e.setAttribute("aria-hidden","true"),e.classList.add("hide")}),r&&r.forEach(e=>{e&&e.classList.remove("u-white","u-bg-heritage-green")}),(s=a.querySelector(`[data-panel="${t}"]`))&&(s.classList.remove("hide"),s.removeAttribute("aria-hidden")),(r=a.querySelector(`[data-open="${t}"]`))&&r.classList.add("u-white","u-bg-heritage-green"),e.isTrusted)&&QueryParams.set("tab",i)})}),n&&1<n.length&&(n.forEach(e=>{var t=e.getAttribute("data-panel");e.setAttribute("role","tabpanel"),e.setAttribute("tabindex","0"),e.setAttribute("id","search_results_panel_"+t),e.setAttribute("aria-labelledby","searchtab_"+t)}),e=QueryParams.get("tab")||"all",e=l.querySelector(`[data-open="${e}"]`))&&(e.click(),e.scrollIntoView({block:"end"}))}};void 0!==window.URLSearchParams&&(stir.nodes(".c-search-results-area").forEach(e=>s(e)),stir.nodes(".carousel").forEach(e=>t(e)))}(),stir.courses=(()=>{const t="dev"===UoS_env.name||"qa"===UoS_env.name;return{clearing:!1,getCombos:()=>{var e;if(!stir.courses.combos)return e={dev:"combo.json",qa:"combo.json",preview:stir?.t4Globals?.search?.combos||"",prod:"https://www.stir.ac.uk/media/stirling/feeds/combo.json"},t&&console.info(`[Search] Getting combo data for ${UoS_env.name} environment (${e[UoS_env.name]})`),stir.getJSON(e[UoS_env.name],e=>stir.courses.combos=e&&!e.error?e.slice(0,-1):[])},showCombosFor:e=>{if(!e||!stir.courses.combos)return[];for(var t=isNaN(e)&&new URL(e).pathname,s=[],r=0;r<stir.courses.combos.length;r++)for(var a=0;a<stir.courses.combos[r].courses.length;a++)if(t&&t===stir.courses.combos[r].courses[a].url||stir.courses.combos[r].courses[a].url.split("/").slice(-1)==e){var i=stir.clone(stir.courses.combos[r]);i.courses.splice(a,1),i.courses=i.courses.filter(e=>e.text),s.push(i);break}return s},favsUrl:function(){switch(UoS_env.name){case"dev":return"/pages/search/course-favs/index.html";case"qa":return"/stirling/pages/search/course-favs/";default:return'<t4 type="navigation" name="Helper: Path to Courses Favourites" id="5195" />'}}()}})(),stir.courses.startdates=function(){var e=Array.prototype.slice.call(document.querySelectorAll('[name="f.Start date|startval"]'));if(e&&0!==e.length){const a=[,"January","February","March","April","May","June","July","August","September","October","November","December"],i={other:"Other","1st-every-month":"First day of any month"},l=new RegExp(/\d{4}-\d{2}ay\d{4}\D\d{2}/i),c=new RegExp(/\d{4}/),n=new RegExp(/ay\d{4}\D\d{2}/i),o=new RegExp(/ay/i),u=e.filter(e=>e.value.match(l)).map(e=>({data:e.value,date:e.value.replace(n,""),month:-1<e.value.indexOf("-")&&a[parseInt(e.value.split("-")[1])]||"",year:e.value.match(c)?e.value.match(c).shift():"",acyear:e.value.match(n)?e.value.match(n).shift().replace(o,""):"",checked:e.checked}));var t=e.filter(e=>!e.value.match(l)).map(e=>(console.info("OTHER!",e,i[e.value]||e.value),{label:i[e.value]||e.value,value:e.value,checked:e.checked})),s=u.map(e=>e.acyear.replace(o,"")).filter((e,t,s)=>s.indexOf(e)===t&&e),r=e[0].parentElement.parentElement.parentElement;if(0!==s.length+t.length){e.forEach(e=>{e.parentElement.parentElement.remove()});const d=(e,t,s)=>{a="radio",i="f.Start date|startval",t=""+t,s=s,(r=document.createElement("input")).type=a,r.name=i,r.value=t,r.checked=s;var r,a=r,i=document.createElement("label");return i.appendChild(a),i.appendChild(document.createTextNode(e)),i},m=(e,t=[])=>{var s=document.createElement("fieldset"),r=document.createElement("legend");return r.classList.add("u-mb-tiny","text-xsm"),s.appendChild(r),s.classList.add("u-mb-1","c-search-filters-subgroup"),r.innerText=e,s.append(...t),s},p=document.createElement("li");s.forEach(t=>{var e=u.filter(e=>e.acyear===t).filter(e=>e.acyear===t).map(e=>d(e.month+" "+e.year,e.data,e.checked));p.append(m("Academic year "+t,e))}),t.length&&p.append(m("Other",t.map(e=>d(e.label,e.value,e.checked)))),r.appendChild(p)}}},(stir=stir||{}).funnelback=(()=>{"dev"!==UoS_env.name&&UoS_env.name;const e=UoS_env.search,t=`https://${e}/s/`;return{getHostname:()=>e,getJsonEndpoint:()=>new URL("search.json",t),getScaleEndpoint:()=>new URL("scale",t),getCroppedImageElement:e=>{return e.url?`<img src="${(e={src:e.url,alt:e.alt,width:Math.floor(e.width/2),height:Math.floor(e.height/2),original:e.url}).src}" alt="${e.alt}" height="${e.height}" width="${e.width}" loading=lazy data-original=${e.original}>`:"\x3c!-- no image --\x3e"},getTags:e=>{e=e&&e.split(";");return e&&e.map(stir.templates.search.tagGroup).join("")},imgError:e=>{e.target.getAttribute("data-original")&&e.target.getAttribute("src")!=e.target.getAttribute("data-original")?e.target.src=e.target.getAttribute("data-original"):(e.target.parentElement.parentElement?.classList?.remove("c-search-result__with-thumbnail"),e.target.parentElement.parentElement.removeChild(e.target.parentElement))}}})(),stir.addSearch={getJsonEndpoint:()=>new URL("/v1/search/dbe6bc5995c4296d93d74b99ab0ad7de","https://api.addsearch.com")},stir.search=()=>{if(void 0===window.URLSearchParams)return void((e=document.querySelector(".c-search-results-area"))&&e.parentElement.removeChild(e));const u="dev"===UoS_env.name||"qa"===UoS_env.name;u||UoS_env.name;var e="small"===stir.MediaQuery.current?5:10;const a=256;stir.courses.clearing;u&&console.info("[Search] initialising…");var t=stir.curry((e,t)=>(e.search=new URLSearchParams(t),e));const r=stir.curry((e,t)=>stir.Object.extend({},e,t)),i=(e,t)=>{var s,r,a=new URLSearchParams(t);for([s,r]of new URLSearchParams(e.search))a.append(s,r);return e.search=a,e};const l={url:stir.addSearch.getJsonEndpoint(),form:document.querySelector("form.x-search-redevelopment"),input:document.querySelector('form.x-search-redevelopment input[name="term"]'),parameters:{any:{term:"*"},news:{customField:"type=news"},event:{filter:JSON.stringify({and:[{"custom_fields.type":"event"},{or:[{range:{"custom_fields.e":{gt:"2025-10-19",lt:"2025-10-27"}}},{range:{"custom_fields.d":{gt:"2025-10-19",lt:"2025-10-27"}}},{and:[{range:{"custom_fields.d":{lt:"2025-10-19"}}},{range:{"custom_fields.e":{gt:"2025-10-27"}}}]}]}]})},gallery:{customField:"type=gallery"},course:{sort:"custom_fields.h1_custom",order:"asc",customField:"type=course"},coursemini:{customField:"type=course"},person:{customField:"type=profile"},research:{categories:"2xhub"},internal:{categories:"1xinternal-staff"},clearing:{num_ranks:e}},noquery:{course:{}}};if(!l.form||!l.form.term)return;u&&console.info("[Search] initialised with host:",l.url.hostname);const c=e=>l.form.term.value||QueryParams.get("term")||l.parameters[e].term||"University of Stirling",s=()=>l.form.term.value?QueryParams.set("term",l.form.term.value):QueryParams.remove("term"),d=e=>e.getAttribute("data-type")||e.parentElement.getAttribute("data-type"),m=e=>QueryParams.set(e,parseInt(QueryParams.get(e)||1)+1);const p=()=>Object.keys(l.parameters).forEach(e=>QueryParams.remove(e)),n=e=>{var t,e=document.querySelector(".c-search-results-area form[data-filters="+e+"]"),s=e?new FormData(e):new FormData;for(t of s.keys())0!==t.indexOf("f.")&&s.getAll(t).length;return s},h=stir.curry((e,t)=>e.insertAdjacentHTML("beforeend",t)),f=stir.curry((e,t)=>e.innerHTML=t),g=stir.curry((e,t)=>(e&&t&&0<t.total_hits&&e.removeAttribute("disabled"),t)),o=e=>new stir.accord(e,!1),v=stir.curry((e,t)=>{var s;e.closest&&(s=(e=e.closest("[data-panel]")).querySelectorAll('[data-behaviour="accordion"]:not(.stir-accordion)'),e.querySelectorAll("img"),Array.prototype.forEach.call(s,o))}),b=stir.curry((e,t)=>{e=e.parentElement.parentElement.querySelector(".c-search-results-summary");return e&&(e.innerHTML="",e.append(stir.templates.search.summary(t))),t}),y={string:{urlDecode:e=>decodeURIComponent(e.replace(/\+/g," "))}},_=stir.curry((e,t)=>{return t}),$=stir.curry((e,t)=>t?k[e](t.hits):"NO DATA"),w=e=>{var t;return!(!e||!e.hasAttribute("data-fallback")||(t=(t=document.getElementById(e.getAttribute("data-fallback")))&&(t.innerHTML||""),e.innerHTML=t,0))},x=t(l.url);{let r=document.getElementById("courseSubjectFilters");if(r&&stir.t4Globals.search.facets.Subject&&stir.t4Globals.search.facets.Subject.forEach(e=>{var t=document.createElement("li");t.innerHTML=`<label><input name=customField type=checkbox value="subject=${e}">${e}</label>`,r.appendChild(t)}),(r=document.querySelector('[data-facet="Faculty"] ul'))&&stir.t4Globals.search.facets.Faculty){r.innerHTML="";let s=stir.t4Globals.search.facets.Faculty;Object.keys(s).forEach(e=>{var t=document.createElement("li");t.innerHTML=`<label><input name=customField type=checkbox value="faculty=${s[e]}">${s[e]}</label>`,r.appendChild(t)})}if((r=document.querySelector('[data-facet="Start date"] ul'))&&stir.t4Globals.search.facets["Start date"]){r.innerHTML="";let s=stir.t4Globals.search.facets["Start date"];Object.keys(s).forEach(e=>{var t=document.createElement("li");t.innerHTML=`<label><input name=customField type=checkbox value="start=${e}">${s[e]}</label>`,r.appendChild(t)})}}e=stir.curry((e,t)=>{u&&console.info();var s=r(l.parameters[e])(stir.Object.extend({},{term:c(e)},(s=e,l.form.term.value?{}:l.noquery[s]),(()=>{let s=QueryParams.getAll();return Object.keys(s).filter(e=>0===e.indexOf("f.")).reduce((e,t)=>({...e,[t]:y.string.urlDecode(s[t]).toLowerCase()}),{})})())),s=i(x(s),n(e));console.info("[Search] Type",e),console.info("[Search] Query",c(e)),console.info("[Search] URL",s.href),stir.getJSON(s,t)}),t=stir.curry((e,t)=>{var s=c(e).trim(),s=r(l.parameters[e])({term:`[t:${s} c:${s} subject:${s}]`}),s=i(x(s),n(e));stir.getJSON(s,t)});const S=e=>{if(e.innerHTML="",e.hasAttribute("data-infinite")){const n=document.createElement("div");var t=document.createElement("div");(s=document.createElement("button")).innerText="Load more results",s.setAttribute("class","button hollow tiny");const o=s;o.setAttribute("disabled",!0),o.addEventListener("click",e=>{{var t=n,s=o,r=d(t);if(L[r]){var a=b(t),i=h(t),l=$(r),t=v(t);const c=stir.compose(t,i,l,g(s),a);m(r),L[r](e=>e&&!e.error?c(e):new Function)}}}),e.appendChild(n),e.appendChild(t),t.appendChild(o),t.setAttribute("class","c-search-results__loadmore flex-container align-center u-mb-2"),C(n,o)}else C(e);var s},E=Array.prototype.slice.call(document.querySelectorAll(".c-search-results[data-type],[data-type=coursemini]")),L={any:e("any"),news:e("news"),event:e("event"),gallery:e("gallery"),course:e("course"),coursemini:t("coursemini"),person:e("person"),research:e("research"),internal:e("internal"),clearing:e("clearing")},k={any:e=>e.map(stir.templates.search.auto).join(""),news:e=>e.map(stir.templates.search.news).join(""),event:e=>e.map(stir.templates.search.event).join(""),gallery:e=>e.map(stir.templates.search.gallery).join(""),course:e=>e.map(stir.templates.search.course).join(""),coursemini:e=>e.map(stir.templates.search.coursemini).join(""),person:e=>e.map(stir.templates.search.person).join(""),research:e=>e.map(stir.templates.search.research).join(""),cura:e=>e.map(stir.templates.search.cura).join(""),internal:e=>e.map(stir.templates.search.auto).join(""),clearing:e=>e.map(stir.templates.search.auto).join("")};const A={course:e=>{stir.coursefavs&&stir.coursefavs.attachEventHandlers();var t=stir.courses.getCombos();t?t.addEventListener("loadend",e):e.call()}},C=(t,e)=>{u&&console.info("[Search] Getting initial results…");const s=d(t);if(L[s]){var r=_(s),a=b(t),e=g(e),i=f(t),l=$(s),c=v(t);const n=stir.compose(c,i,l,e,a,r),o=e=>(u&&console.info("[Search] Request callback",e),t&&t.parentElement?!e||e.error||0===e.total_hits&&w(t)?void 0:n(e):u&&console.error("[Search] late callback, element no longer on DOM"));if(p(),A[s])return A[s](e=>L[s](o));L[s](o)}},j=()=>E.forEach(S),T=(Array.prototype.forEach.call(document.querySelectorAll(".c-search-results-area form[data-filters]"),t=>{var e=t.getAttribute("data-filters");const s=document.querySelector(`.c-search-results[data-type="${e}"]`);t.addEventListener("reset",e=>{Array.prototype.forEach.call(t.querySelectorAll("input"),e=>e.checked=!1),S(s)}),t.addEventListener("change",e=>{d(s),S(s)}),t.addEventListener("submit",e=>{S(s),e.preventDefault()})}),e=>{var t;e&&e.target&&(t=`input[name="${e.target.getAttribute("data-name")}"][value="${e.target.getAttribute("data-value")}"]`,(t=(e.target.closest("[data-panel]")||document).querySelector(t))?(t.checked=!t.checked,e.target.parentElement.removeChild(e.target),j()):(t=`select[name="${e.target.getAttribute("data-name")}"]`,(t=document.querySelector(t))&&(t.selectedIndex=0,e.target.parentElement.removeChild(e.target),j())))}),U=(Array.prototype.forEach.call(document.querySelectorAll(".c-search-results-summary"),e=>{e.addEventListener("click",e=>{e.target.hasAttribute("data-suggest")?(e.preventDefault(),l.input.value=e.target.innerText,s(),j()):e.target.hasAttribute("data-value")&&T(e)})}),Array.prototype.forEach.call(document.querySelectorAll(".c-search-results"),e=>{e.addEventListener("click",e=>{e.target.hasAttribute("data-value")&&T(e)})}),e=>{s(),j(),e.preventDefault()});t=e=>{void 0!==QueryParams.get("term")&&(l.form.term.value=QueryParams.get("term").substring(0,a));var t=QueryParams.getAll();for(const r in t){var s=document.querySelector(`input[name="${encodeURIComponent(r)}"][value="${encodeURIComponent(t[r])}"]`);s&&(s.checked=!0)}l.form.addEventListener("submit",U),j()};t(),window.addEventListener("popstate",t)},stir.search();