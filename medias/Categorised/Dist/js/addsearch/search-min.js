var stir=stir||{};if(stir.templates=stir.templates||{},stir.const=stir.const||{},stir.templates.search=(()=>{"dev"!==UoS_env.name&&UoS_env.name;const s=e=>`<p class="u-heritage-berry u-border-solid u-p-1"><span class="uos-lightbulb"></span> ${e}</p>`,r={staff:"University of Stirling staff",students:"current students and staff"},t={staff:["staff","students"],student:["students"]};var e=window[["s","e","i","k","o","o","C"].reverse().join("")];const a=!!e.get("psessv0")?e.get("psessv0").split("|")[0]:"EXTERNAL",i=e=>-1<t[a.toLowerCase()]?.indexOf(e.toLowerCase()),l=(e,t)=>{return i(t)?`<p class=c-search-result__summary>${e}</p>`:(e=t,s(`This page is only available to ${r[e]}. You will be asked to log in before you can view it, but once you are logged in results will be shown automatically.`))},c=e=>{e=e.toUpperCase().split("/").slice(-1).toString().split(".");return 1<e.length&&e[1].match(/PDF|DOCX?/)};const o=(e,t,s)=>`<span class=c-tag data-name="${t}" data-value="${s}">✖️ ${e}</span>`,n=(e,t,s,r)=>{return e?(e=-1<e.indexOf("|")?e.split("|")[1]||e.split("|")[0]:e,`<div class=c-search-result__image>
			...
			<div class="cell text-center u-my-2">
				...
				<div class=c-search-result__tags>
					...
					${a=a,t=e.url,r=0,a&&0<a.length?stir.templates.search.breadcrumb(stir.templates.search.trailstring(a)):c(t)?`Document: ${c(t)} <small>${stir.Math.fileSize(r||0,0)}</small>`:""}
					<p class="u-text-regular u-m-0"><strong><a href="${e.url}">${e.title.split("|")[0].trim().replace(/\xA0/g," ")}</a></strong></p>
					<p>${e.meta_description}</p>
				</div>
			</div>`},internal:e=>{const s={text:e.custom_fields?.breadcrumbs?.split(" > ")||[],href:new URL(e.url).pathname.split("/").filter(e=>e)};var t,r=i(e.custom_fields.group)?stir.templates.search.trailstring(s.text.map((e,t)=>({text:e,href:"/"+s.href.slice(0,t+1).join("/")+"/"})).slice(0,-1)):`<a href="https://www.stir.ac.uk/${s.href[0]}/">${s.text[0]}</a>`;return`
	  <div class="u-border-width-5 u-heritage-line-left c-search-result${t=e.custom_fields.group,i(t)?" c-internal-search-result":" c-internal-locked-search-result"}" data-rank=${e.score}${e.custom_fields.type?' data-result-type="'+e.custom_fields.type.toLowerCase()+'"':""} data-access="${e.custom_fields.access}">
			  <div class="c-search-result__body u-mt-1 flex-container flex-dir-column u-gap">
				...
				${l(e.meta_description,e.custom_fields.group)}
			  </div>
			</div>`},combo:e=>`<li title="${e.prefix} ${e.title}">${e.courses.map(stir.templates.search.comboCourse).join(" and ")}${e?.codes?.ucas?" <small>&hyphen; "+e.codes.ucas+"</small>":""}${d(e)?' <sup class="c-search-result__seasonal">*</sup>':""}</li>`,comboCourse:e=>`<a href="${e.url}">${e.text.replace(/(BAcc \(Hons\))|(BA \(Hons\))|(BSc \(Hons\))|(\/\s)/gi,"")}</a>`,clearing:e=>{if(Object.keys&&e.custom_fields&&0<=Object.keys(e.custom_fields).join().indexOf("clearing"))return'<p class="u-m-0"><strong class="u-energy-purple">Clearing 2025: places may be available on this course.</strong></p>'},combos:e=>0===e.combos.length?"":`
		...
		<div class="flex-container flex-dir-column u-gap u-mt-1 ">
		  ...
		  ${stir.templates.search.pathways(e)}
				...
				<p><strong><a href="${e.url}" title="${e.url}" class="u-border-none">
			...
			<div class="c-search-result u-border-width-5 u-heritage-line-left" data-result-type=person>
				...
				${n(e.custom_fields.image||"https://www.stir.ac.uk/research/hub/image/"+t,e.title.split(" | ")[0].trim(),400,400)}
		...
		<div class="c-search-result u-border-width-5 u-heritage-line-left" data-result-type=scholarship data-rank=${e.score}>
			...
			<div class="c-search-result__body u-mt-1 flex-container flex-dir-column u-gap">
		...
		</div>`,studentstory:(e,t)=>{var s=e.custom_fields.data?m(e.custom_fields.data):{};return`
				<div class="c-search-result u-border-width-5 u-heritage-line-left" data-result-type=studentstory>
					<div class="c-search-result__body flex-container flex-dir-column u-gap">
						...
						<p class="u-m-0">
						${s.degree?s.degree+"<br />":""}
						${e.custom_fields.country||""}
						</p>
						<p>${e.custom_fields.snippet?"<q>"+e.custom_fields.snippet+"</q>":"\x3c!-- 28d3702e2064f72d5dfcba865e3cc5d5 --\x3e"}</p>
					</div>
					${e.custom_fields.image?n("https://www.stir.ac.uk"+e.custom_fields.image,e.title.split(" | ")[0].trim(),400,400):""}
				</div>`},news:e=>{var t=e.custom_fields.data?m(e.custom_fields.data):{},s=!!t.thumbnail,t=t.thumbnail?`data-original="${t.thumbnail}"`:"";return`
				...
				<div class="u-border-width-5 u-heritage-line-left c-search-result c-search-result__with-thumbnail" data-rank=${e.score} data-result-type=news>
					<div class=c-search-result__body>
						<p class="u-text-regular u-m-0"><strong>
							<a href="${e.url}">${e.custom_fields.h1||e.title.split(" | ")[0].trim()}</a>
						</strong></p>
			...
			<div class="u-border-width-5 u-heritage-line-left c-search-result${s?" c-search-result__with-thumbnail":""}" data-rank=${e.score} data-result-type=event>
				<div class=c-search-result__tags>
					${i.isSeriesChild?stir.templates.search.stag(i.isSeriesChild):""}
				</div>
				<div class="c-search-result__body flex-container flex-dir-column u-gap u-mt-1">
					<p class="u-text-regular u-m-0">
						<strong>${u({text:r,href:a})}</strong>
					</p>
				...
				${n(e.custom_fields.image&&e.custom_fields.image.split("|")[0],e.title.split(" | ")[0])}
				...
				<div>
					...
					<div class="flex-container flex-dir-column u-gap u-mt-1">
						<p class="u-text-regular u-m-0"><strong>
							<a href="${e.url}">${-1<e.title.indexOf("|")?e.title.split(" | ")[1]:e.title}</a>
						</strong></p>
					...
					<div class=c-search-result__body>
						<p class="u-text-regular u-m-0"><strong>
							<a href="${e.url}">${e.title.split(" | ")[1]}</a><br>
