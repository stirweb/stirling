		...
		<div class="c-search-result u-border-width-5 u-heritage-line-left" data-result-type=scholarship data-rank=${e.rank}>
			...
			<strong>
			  ${e.metaData.register?p({text:r,href:e.metaData.register}):p({text:r,href:s})}
				...
				${m(e.metaData.image&&e.metaData.image.split("|")[0],e.title.split(" | ")[0])}
