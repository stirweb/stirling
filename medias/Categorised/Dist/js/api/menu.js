													...
													<div class=u-px-1>
														<table>
															...
															<tr>
																...
																<td><a href="${r}?session=${t}&route=${e.routeCode}&semester=AUT" target=_blank>${e.routeName}</a></td>
																<td>
																<!-- <a href="${r}?session=${t}&route=${e.routeCode}&semester=AUT" target=_blank>Autumn</a> | 
																<a href="${r}?session=${t}&route=${e.routeCode}&semester=SPR" target=_blank>Spring</a> | 
																<a href="${r}?session=${t}&route=${e.routeCode}&semester=SUM" target=_blank>Summer</a> -->
