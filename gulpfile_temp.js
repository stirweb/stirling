...
function jsCourses() {
	...
	const source = [
		'src/js-course/course.js',
		'src/js-course/dpt.js',
		'src/js-course/dpt-modules.js',
		'src/js-course/fees.js',
		'src/js-course/related-courses.js',
		'src/js-course/slide-to-content.js',
		'src/js-course/sticky.js',
		'src/js-course/testimonials.js'
  //	'src/js-course/country-specific.js',
  //	'src/js-course/modules.js',
	];
	return (
	  src(source)
		.pipe(expect(source))
