...
var UoS_GettingAround = (function () {
  ...
  var _markerData = [
    ...
    {
      name: "Parking", // court behind
      type: types.PARKING,
      coords: "56.142424, -3.921624",
    },

    {
      name: "Parking", // cottrell over road
      type: types.PARKING,
      coords: "56.143172, -3.919779",
    },
    {
      name: "Parking", // cottrell over road 2
      type: types.PARKING,
      coords: "56.142968, -3.918878",
    },
    {
      name: "Parking", // colin bell
      type: types.PARKING,
      coords: "56.143435, -3.918148",
    },
    {
      name: "Parking", // property management office
      type: types.PARKING,
  ...
  */
  ...
  var _options = {
    zoom: 16,
    center: { lat: 56.14643094488868, lng: -3.918399958166454 },
    travelMode: "WALKING",
