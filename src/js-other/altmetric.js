...
stir.altmetric = {
	...
	callback: function(json) {
		...
		var html=[
			'<table>',
			'<caption>University of Stirling research papers ranked by Altmetric</caption>',
			'<thead><tr>',
			'<th scope=col>Position</th><th scope=col>Research paper</th><th class=donut scope=col>Altmetric score</th>',
			'</thead></tr>',
			'<tbody>'
		];
...
/* Get the feed */
(function() {
	var query, el = document.createElement('script');
